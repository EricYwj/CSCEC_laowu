 ...
 * output class name
 */
public class BlackListListUI extends AbstractBlackListListUI
{
    private static final Logger logger = CoreUIObject.getLogger(BlackListListUI.class);
    
    /**
     * output class constructor
     */
    public BlackListListUI() throws Exception
    {
        super();
    }
    ...
    public void actionCancel_actionPerformed(ActionEvent e) throws Exception
    {
    	...
    	for (Iterator iter = pkList.iterator(); iter.hasNext();) {
			...
			BlackListFactory.getRemoteInstance().cancel(new ObjectUuidPK(id), null);
    	}
    	refreshList();
    }
    ...
    public void actionCancelCancel_actionPerformed(ActionEvent e) throws Exception
    {
    	...
    	for (Iterator iter = pkList.iterator(); iter.hasNext();) {
			String id = (String) iter.next();
			BlackListFactory.getRemoteInstance().cancelCancel(new ObjectUuidPK(id), null);
    	}
    	refreshList();
    }
