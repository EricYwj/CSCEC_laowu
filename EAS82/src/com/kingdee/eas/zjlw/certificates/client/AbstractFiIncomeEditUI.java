 ...
 * output class name
 */
public abstract class AbstractFiIncomeEditUI extends com.kingdee.eas.framework.client.CoreBillEditUI
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractFiIncomeEditUI.class);
    ...
    protected com.kingdee.eas.zjlw.certificates.FiIncomeInfo editData = null;
    protected ActionAudit actionAudit = null;
    protected ActionUnAudit actionUnAudit = null;
    /**
     * output class constructor
     */
    public AbstractFiIncomeEditUI() throws Exception
    {
        super();
    ...
    {
        this.resHelper = new ResourceBundleHelper(AbstractFiIncomeEditUI.class.getName());
        ...
        KDFormattedTextField kdtEntrys_wkExperice_TextField = new KDFormattedTextField();
        kdtEntrys_wkExperice_TextField.setName("kdtEntrys_wkExperice_TextField");
        kdtEntrys_wkExperice_TextField.setVisible(true);
        kdtEntrys_wkExperice_TextField.setEditable(true);
        kdtEntrys_wkExperice_TextField.setHorizontalAlignment(2);
        kdtEntrys_wkExperice_TextField.setDataType(1);
        	kdtEntrys_wkExperice_TextField.setMinimumValue(new java.math.BigDecimal("-1.0E18"));
        	kdtEntrys_wkExperice_TextField.setMaximumValue(new java.math.BigDecimal("1.0E18"));
        kdtEntrys_wkExperice_TextField.setPrecision(10);
        KDTDefaultCellEditor kdtEntrys_wkExperice_CellEditor = new KDTDefaultCellEditor(kdtEntrys_wkExperice_TextField);
        this.kdtEntrys.getColumn("wkExperice").setEditor(kdtEntrys_wkExperice_CellEditor);
        // contbNum		
    ...
    public void initUIContentLayout()
    {
        ...
        contDescription.setBounds(new Rectangle(520, 64, 231, 19));
        this.add(contDescription, new KDLayout.Constraints(520, 64, 231, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT_SCALE | KDLayout.Constraints.ANCHOR_RIGHT));
        ...
        kdtEntrys_detailPanel = (com.kingdee.eas.framework.client.multiDetail.DetailPanel)com.kingdee.eas.framework.client.multiDetail.HMDUtils.buildDetail(this,dataBinder,kdtEntrys,new com.kingdee.eas.zjlw.certificates.FiIncomeEntryInfo(),null,false);
...
vo.put("personState","10");
        ...
        contbNum.setBounds(new Rectangle(780, 14, 231, 19));
        this.add(contbNum, new KDLayout.Constraints(780, 14, 231, 19, 0));
        ...
        contpCauditime.setBounds(new Rectangle(520, 38, 231, 19));
        this.add(contpCauditime, new KDLayout.Constraints(520, 38, 231, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT_SCALE | KDLayout.Constraints.ANCHOR_RIGHT));
        ...
        contpCauditor.setBounds(new Rectangle(520, 12, 231, 19));
        this.add(contpCauditor, new KDLayout.Constraints(520, 12, 231, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT_SCALE | KDLayout.Constraints.ANCHOR_RIGHT));
        //contCreator
	...
	private void registerBindings(){
		...
		dataBinder.registerBinding("entrys", com.kingdee.eas.zjlw.certificates.FiIncomeEntryInfo.class, this.kdtEntrys, "userObject");
		...
		dataBinder.registerBinding("entrys.wkExperice", java.math.BigDecimal.class, this.kdtEntrys, "wkExperice.text");
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.zjlw.certificates.app.FiIncomeEditUIHandler";
	}
    ...
    public void setDataObject(IObjectValue dataObject)
    {
        ...
        this.editData = (com.kingdee.eas.zjlw.certificates.FiIncomeInfo)ov;
    }
	...
	protected void registerValidator() {
		...
		getValidateHelper().registerBindProperty("entrys.wkExperice", ValidateHelper.ON_SAVE);    
...
kdtEntrys.getCell(rowIndex,"pmtProfFr").setValue(com.kingdee.bos.ui.face.UIRuleUtil.getString(com.kingdee.bos.ui.face.UIRuleUtil.getProperty((com.kingdee.bos.dao.IObjectValue)kdtEntrys.getCell(rowIndex,"pmtProfC").getValue(),"nameFR")));
    ...
    protected class ActionAudit extends ItemAction {     
        ...
        public void actionPerformed(ActionEvent e)
        {
            ...
            innerActionPerformed("eas", AbstractFiIncomeEditUI.this, "ActionAudit", "actionAudit_actionPerformed", e);
        }
    }
    ...
    protected class ActionUnAudit extends ItemAction {     
        ...
        {
        	getUIContext().put("ORG.PK", getOrgPK(this));
            innerActionPerformed("eas", AbstractFiIncomeEditUI.this, "ActionUnAudit", "actionUnAudit_actionPerformed", e);
        }
    }
    ...
    {
        return new MetaDataPK("com.kingdee.eas.zjlw.certificates.client", "FiIncomeEditUI");
    }
    /**
