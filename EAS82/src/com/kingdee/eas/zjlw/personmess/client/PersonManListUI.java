 ...
 * output class name
 */
public class PersonManListUI extends AbstractPersonManListUI
{
    private static final Logger logger = CoreUIObject.getLogger(PersonManListUI.class);
    
    /**
     * output class constructor
     */
    public PersonManListUI() throws Exception
    {
        super();
    }
