 ...
 * output class name
 */
public class BusinesscheckEditUI extends AbstractBusinesscheckEditUI
{
    private static final Logger logger = CoreUIObject.getLogger(BusinesscheckEditUI.class);
    
    /**
     * output class constructor
     */
    public BusinesscheckEditUI() throws Exception
    {
        super();
    }
    /**
...
//onlaod
    ...
    protected void setButtonStatus() {
    	BusinesscheckInfo bill;
    		if ("VIEW".equals(getOprtState())) {
//    			this.actionAudit.setVisible(true);
//    			this.actionUnAudit.setVisible(true);
//    			this.actionAudit.setEnabled(true);
//    			this.actionUnAudit.setEnabled(true);
    			bill = (BusinesscheckInfo) this.editData;
