...
public class NoCCEntryControllerBean extends AbstractNoCCEntryControllerBean
{
    private static Logger logger =
        Logger.getLogger("com.kingdee.eas.zjlw.personmess.app.NoCCEntryControllerBean");
}