 ...
 * output class name
 */
public abstract class AbstractForiPayrollListUI extends com.kingdee.eas.framework.client.CoreBillListUI
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractForiPayrollListUI.class);
    ...
    protected ActionUpdateErrData actionUpdateErrData = null;
    public final static String STATUS_VIEW = "VIEW";
    /**
     * output class constructor
     */
    public AbstractForiPayrollListUI() throws Exception
    {
        super();
    ...
    {
        this.resHelper = new ResourceBundleHelper(AbstractForiPayrollListUI.class.getName());
        this.setUITitle(resHelper.getString("this.title"));
        mainQueryPK = new MetaDataPK("com.kingdee.eas.zjlw.social.app", "ForiPayrollQuery");
        //actionRemove
        ...
        //actionUpdateErrData
        this.actionUpdateErrData = new ActionUpdateErrData(this);
        getActionManager().registerAction("actionUpdateErrData", actionUpdateErrData);
         this.actionUpdateErrData.addService(new com.kingdee.eas.framework.client.service.PermissionService());
        ...
        // btnUpdateErrData
        this.btnUpdateErrData.setAction((IItemAction)ActionProxyFactory.getProxy(actionUpdateErrData, new Class[] { IItemAction.class }, getServiceContext()));		
        this.btnUpdateErrData.setText(resHelper.getString("btnUpdateErrData.text"));		
        this.btnUpdateErrData.setIcon(com.kingdee.eas.util.client.EASResource.getIcon("imgIcon_update"));
...
kDContainer2.getContentPane().setLayout(new BorderLayout(0, 0));        kDContainer2.getContentPane().add(tblMain, BorderLayout.CENTER);
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.zjlw.social.app.ForiPayrollListUIHandler";
	}
    ...
    /**
     * output actionUpdateErrData_actionPerformed method
     */
    public void actionUpdateErrData_actionPerformed(ActionEvent e) throws Exception
    {
    }
	...
	public RequestContext prepareActionUpdateErrData(IItemAction itemAction) throws Exception {
			RequestContext request = new RequestContext();		
		if (request != null) {
    		request.setClassName(getUIHandlerClassName());
		}
	...
	public boolean isPrepareActionUpdateErrData() {
    	return false;
    }
    ...
    protected class ActionTDPrint extends ItemAction {     
        ...
        public void actionPerformed(ActionEvent e)
        {
            ...
            innerActionPerformed("eas", AbstractForiPayrollListUI.this, "ActionTDPrint", "actionTDPrint_actionPerformed", e);
        }
    }
    ...
    protected class ActionTDPrintPreview extends ItemAction {     
        ...
        {
        	getUIContext().put("ORG.PK", getOrgPK(this));
            innerActionPerformed("eas", AbstractForiPayrollListUI.this, "ActionTDPrintPreview", "actionTDPrintPreview_actionPerformed", e);
        }
    }
    ...
    protected class ActionAudit extends ItemAction {     
        ...
        {
        	getUIContext().put("ORG.PK", getOrgPK(this));
            innerActionPerformed("eas", AbstractForiPayrollListUI.this, "ActionAudit", "actionAudit_actionPerformed", e);
        }
    }
    ...
    protected class ActionUnAudit extends ItemAction {     
        ...
        {
        	getUIContext().put("ORG.PK", getOrgPK(this));
            innerActionPerformed("eas", AbstractForiPayrollListUI.this, "ActionUnAudit", "actionUnAudit_actionPerformed", e);
        }
    }

    /**
     * output ActionUpdateErrData class
     */     
    protected class ActionUpdateErrData extends ItemAction {     
    
        public ActionUpdateErrData()
        {
            this(null);
        }

        public ActionUpdateErrData(IUIObject uiObject)
        {     
		super(uiObject);     
        
            String _tempStr = null;
            this.setEnabled(false);
            _tempStr = resHelper.getString("ActionUpdateErrData.SHORT_DESCRIPTION");
            this.putValue(ItemAction.SHORT_DESCRIPTION, _tempStr);
            _tempStr = resHelper.getString("ActionUpdateErrData.LONG_DESCRIPTION");
            this.putValue(ItemAction.LONG_DESCRIPTION, _tempStr);
            _tempStr = resHelper.getString("ActionUpdateErrData.NAME");
            this.putValue(ItemAction.NAME, _tempStr);
        }
        ...
        {
        	getUIContext().put("ORG.PK", getOrgPK(this));
            innerActionPerformed("eas", AbstractForiPayrollListUI.this, "ActionUpdateErrData", "actionUpdateErrData_actionPerformed", e);
        }
    }
    ...
    {
        return new MetaDataPK("com.kingdee.eas.zjlw.social.client", "ForiPayrollListUI");
    }
    /**
    ...
    {
        return new String[] {"number","billSate","bizDate","creator.name","projName.name","projSCNum","monthYearr.number","auditor.name","AuditDate","description","id","createTime","lastUpdateTime","auditor.number","creator.number","lastUpdateUser.number","lastUpdateUser.name","handler.number","handler.name","isOK","acountRow","projAddress"};
    }
