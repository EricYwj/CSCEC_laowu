...
public class AbstractForiPayrollEntryInfo extends com.kingdee.eas.framework.CoreBillEntryBaseInfo implements Serializable 
{
    public AbstractForiPayrollEntryInfo()
    {
        this("id");
    }
    protected AbstractForiPayrollEntryInfo(String pkField)
    {
        super(pkField);
    }
    /**
     ...
     */
    public com.kingdee.eas.zjlw.social.ForiPayrollInfo getParent()
    {
        return (com.kingdee.eas.zjlw.social.ForiPayrollInfo)get("parent");
    }
    public void setParent(com.kingdee.eas.zjlw.social.ForiPayrollInfo item)
    {
        put("parent", item);
    }
    /**
    ...
    /**
     * Object:分录's 原始人员编码property 
     */
    public String getOriPersonId()
    {
        return getString("oriPersonId");
    }
    public void setOriPersonId(String item)
    {
        setString("oriPersonId", item);
    }
