 ...
 * output class name
 */
public abstract class AbstractDistrGovernmentEditUI extends com.kingdee.eas.framework.client.EditUI
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractDistrGovernmentEditUI.class);
    ...
    protected com.kingdee.eas.zjlw.baseinfo.DistrGovernmentInfo editData = null;
    /**
     * output class constructor
     */
    public AbstractDistrGovernmentEditUI() throws Exception
    {
        super();
    ...
    {
        this.resHelper = new ResourceBundleHelper(AbstractDistrGovernmentEditUI.class.getName());
    ...
    {
        this.setBounds(new Rectangle(0, 0, 1250, 629));
        this.setLayout(new KDLayout());
        this.putClientProperty("OriginalBounds", new Rectangle(0, 0, 1250, 629));
        ...
        kDLabelContainer2.setBounds(new Rectangle(547, 15, 193, 19));
        this.add(kDLabelContainer2, new KDLayout.Constraints(547, 15, 193, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT_SCALE | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        ...
        kdtEntrys.setBounds(new Rectangle(15, 51, 1217, 473));
        kdtEntrys_detailPanel = (com.kingdee.eas.framework.client.multiDetail.DetailPanel)com.kingdee.eas.framework.client.multiDetail.HMDUtils.buildDetail(this,dataBinder,kdtEntrys,new com.kingdee.eas.zjlw.baseinfo.DistrGovernmentEntryInfo(),null,false);
        this.add(kdtEntrys_detailPanel, new KDLayout.Constraints(15, 51, 1217, 473, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_BOTTOM | KDLayout.Constraints.ANCHOR_LEFT | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
...
vo.put("maritalStatus","0");
        ...
        contorganizational.setBounds(new Rectangle(1075, 59, 193, 19));
        this.add(contorganizational, new KDLayout.Constraints(1075, 59, 193, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT_SCALE | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        //kDLabelContainer1
	...
	private void registerBindings(){
		...
		dataBinder.registerBinding("Entrys", com.kingdee.eas.zjlw.baseinfo.DistrGovernmentEntryInfo.class, this.kdtEntrys, "userObject");
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.zjlw.baseinfo.app.DistrGovernmentEditUIHandler";
	}
    ...
    public void setDataObject(IObjectValue dataObject)
    {
        ...
        this.editData = (com.kingdee.eas.zjlw.baseinfo.DistrGovernmentInfo)ov;
    }
    ...
    {
        return new MetaDataPK("com.kingdee.eas.zjlw.baseinfo.client", "DistrGovernmentEditUI");
    }
