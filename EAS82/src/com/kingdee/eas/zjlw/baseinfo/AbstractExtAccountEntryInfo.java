...
public class AbstractExtAccountEntryInfo extends com.kingdee.eas.framework.CoreBillEntryBaseInfo implements Serializable 
{
    public AbstractExtAccountEntryInfo()
    {
        this("id");
    }
    protected AbstractExtAccountEntryInfo(String pkField)
    {
        super(pkField);
    }
    /**
     ...
     */
    public com.kingdee.eas.zjlw.baseinfo.ExtAccountInfo getParent()
    {
        return (com.kingdee.eas.zjlw.baseinfo.ExtAccountInfo)get("parent");
    }
    public void setParent(com.kingdee.eas.zjlw.baseinfo.ExtAccountInfo item)
    {
        put("parent", item);
    }
    /**
