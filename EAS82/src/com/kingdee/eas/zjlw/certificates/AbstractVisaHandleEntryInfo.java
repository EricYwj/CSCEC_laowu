...
public class AbstractVisaHandleEntryInfo extends com.kingdee.eas.framework.CoreBillEntryBaseInfo implements Serializable 
{
    public AbstractVisaHandleEntryInfo()
    {
        this("id");
    }
    protected AbstractVisaHandleEntryInfo(String pkField)
    {
        super(pkField);
    }
    /**
     ...
     */
    public com.kingdee.eas.zjlw.certificates.VisaHandleInfo getParent()
    {
        return (com.kingdee.eas.zjlw.certificates.VisaHandleInfo)get("parent");
    }
    public void setParent(com.kingdee.eas.zjlw.certificates.VisaHandleInfo item)
    {
        put("parent", item);
    }
    /**
