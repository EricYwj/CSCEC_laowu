...
public class AbstractLivepermitECEntryInfo extends com.kingdee.eas.framework.CoreBillEntryBaseInfo implements Serializable 
{
    public AbstractLivepermitECEntryInfo()
    {
        this("id");
    }
    protected AbstractLivepermitECEntryInfo(String pkField)
    {
        super(pkField);
    }
    /**
     ...
     */
    public com.kingdee.eas.zjlw.certificates.LivepermitECInfo getParent()
    {
        return (com.kingdee.eas.zjlw.certificates.LivepermitECInfo)get("parent");
    }
    public void setParent(com.kingdee.eas.zjlw.certificates.LivepermitECInfo item)
    {
        put("parent", item);
    }
    /**
    ...
    {
        return getDate("liveTime");
    }
    public void setLiveTime(java.util.Date item)
    {
        setDate("liveTime", item);
    }
