 ...
 * output class name
 */
public abstract class AbstractProjFEREntryEditUI extends com.kingdee.eas.framework.client.CoreBillEditUI
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractProjFEREntryEditUI.class);
    ...
    protected com.kingdee.eas.zjlw.social.ProjFEREntryInfo editData = null;
    /**
     * output class constructor
     */
    public AbstractProjFEREntryEditUI() throws Exception
    {
        super();
    ...
    {
        this.resHelper = new ResourceBundleHelper(AbstractProjFEREntryEditUI.class.getName());
        ...
        this.kdtEntrys.addKDTEditListener(new com.kingdee.bos.ctrl.kdf.table.event.KDTEditAdapter() {
            public void editStopped(com.kingdee.bos.ctrl.kdf.table.event.KDTEditEvent e) {
                ...
                this.kdtEntrys.putBindContents("editData",new String[] {"id","personSoclNum","lastName","firstName","personCredits","cooperCode","cooperation","remark"});
        ...
        this.prmtyears.setVisible(true);		
        ...
        this.setFocusTraversalPolicy(new com.kingdee.bos.ui.UIFocusTraversalPolicy(new java.awt.Component[] {txtNumber,pkBizDate,prmtAuditor,prmtCreator,kDDateCreateTime,prmtprojName,billSate,pkAuditDate,txtDescription,prmtLastUpdateUser,kDDateLastUpdateTime,kdtEntrys,txtprojSoclNum,prmtyears}));
    ...
    {
        this.setBounds(new Rectangle(0, 0, 1000, 521));
        this.setLayout(new KDLayout());
        this.putClientProperty("OriginalBounds", new Rectangle(0, 0, 1000, 521));
        contCreator.setBounds(new Rectangle(14, 488, 218, 19));
        this.add(contCreator, new KDLayout.Constraints(14, 488, 218, 19, KDLayout.Constraints.ANCHOR_BOTTOM | KDLayout.Constraints.ANCHOR_LEFT | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        contCreateTime.setBounds(new Rectangle(253, 488, 226, 19));
        this.add(contCreateTime, new KDLayout.Constraints(253, 488, 226, 19, KDLayout.Constraints.ANCHOR_BOTTOM | KDLayout.Constraints.ANCHOR_LEFT_SCALE | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        ...
        contNumber.setBounds(new Rectangle(13, 11, 189, 19));
        this.add(contNumber, new KDLayout.Constraints(13, 11, 189, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        contBizDate.setBounds(new Rectangle(13, 39, 189, 19));
        this.add(contBizDate, new KDLayout.Constraints(13, 39, 189, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        contDescription.setBounds(new Rectangle(850, 27, 270, 19));
        this.add(contDescription, new KDLayout.Constraints(850, 27, 270, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT_SCALE | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        contAuditor.setBounds(new Rectangle(494, 488, 216, 19));
        this.add(contAuditor, new KDLayout.Constraints(494, 488, 216, 19, KDLayout.Constraints.ANCHOR_BOTTOM | KDLayout.Constraints.ANCHOR_LEFT_SCALE | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        kdtEntrys.setBounds(new Rectangle(12, 96, 915, 385));
        kdtEntrys_detailPanel = (com.kingdee.eas.framework.client.multiDetail.DetailPanel)com.kingdee.eas.framework.client.multiDetail.HMDUtils.buildDetail(this,dataBinder,kdtEntrys,new com.kingdee.eas.zjlw.social.ProjFEREntryEntryInfo(),null,false);
        this.add(kdtEntrys_detailPanel, new KDLayout.Constraints(12, 96, 915, 385, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_BOTTOM | KDLayout.Constraints.ANCHOR_LEFT | KDLayout.Constraints.ANCHOR_RIGHT));
        contprojName.setBounds(new Rectangle(267, 11, 295, 19));
        this.add(contprojName, new KDLayout.Constraints(267, 11, 295, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT_SCALE | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        contbillSate.setBounds(new Rectangle(267, 39, 295, 19));
        this.add(contbillSate, new KDLayout.Constraints(267, 39, 295, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT_SCALE | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        contAuditDate.setBounds(new Rectangle(724, 489, 204, 19));
        this.add(contAuditDate, new KDLayout.Constraints(724, 489, 204, 19, KDLayout.Constraints.ANCHOR_BOTTOM | KDLayout.Constraints.ANCHOR_LEFT_SCALE | KDLayout.Constraints.ANCHOR_RIGHT));
        contprojSoclNum.setBounds(new Rectangle(627, 11, 223, 19));
        this.add(contprojSoclNum, new KDLayout.Constraints(627, 11, 223, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT_SCALE | KDLayout.Constraints.ANCHOR_RIGHT));
        contyears.setBounds(new Rectangle(625, 39, 223, 19));
        this.add(contyears, new KDLayout.Constraints(625, 39, 223, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT_SCALE | KDLayout.Constraints.ANCHOR_RIGHT));
        kDLabelContainer1.setBounds(new Rectangle(13, 69, 308, 19));
        this.add(kDLabelContainer1, new KDLayout.Constraints(13, 69, 308, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        //contCreator
	...
	private void registerBindings(){
		...
		dataBinder.registerBinding("entrys", com.kingdee.eas.zjlw.social.ProjFEREntryEntryInfo.class, this.kdtEntrys, "userObject");
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.zjlw.social.app.ProjFEREntryEditUIHandler";
	}
    ...
    public void setDataObject(IObjectValue dataObject)
    {
        ...
        this.editData = (com.kingdee.eas.zjlw.social.ProjFEREntryInfo)ov;
    }
...
kdtEntrys.getCell(rowIndex,"cooperation").setValue(com.kingdee.bos.ui.face.UIRuleUtil.getString(com.kingdee.bos.ui.face.UIRuleUtil.getProperty((com.kingdee.bos.dao.IObjectValue)kdtEntrys.getCell(rowIndex,"cooperCode").getValue(),"name")));
    ...
    {
        return new MetaDataPK("com.kingdee.eas.zjlw.social.client", "ProjFEREntryEditUI");
    }
    /**
