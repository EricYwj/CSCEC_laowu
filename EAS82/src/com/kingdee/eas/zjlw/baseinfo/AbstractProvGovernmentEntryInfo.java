...
public class AbstractProvGovernmentEntryInfo extends com.kingdee.eas.framework.CoreBillEntryBaseInfo implements Serializable 
{
    public AbstractProvGovernmentEntryInfo()
    {
        this("id");
    }
    protected AbstractProvGovernmentEntryInfo(String pkField)
    {
        super(pkField);
    }
    /**
     ...
     */
    public com.kingdee.eas.zjlw.baseinfo.ProvGovernmentInfo getParent()
    {
        return (com.kingdee.eas.zjlw.baseinfo.ProvGovernmentInfo)get("parent");
    }
    public void setParent(com.kingdee.eas.zjlw.baseinfo.ProvGovernmentInfo item)
    {
        put("parent", item);
    }
    /**
