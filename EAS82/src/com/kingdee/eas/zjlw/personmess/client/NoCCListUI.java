 ...
 * output class name
 */
public class NoCCListUI extends AbstractNoCCListUI
{
    private static final Logger logger = CoreUIObject.getLogger(NoCCListUI.class);
    
    /**
     * output class constructor
     */
    public NoCCListUI() throws Exception
    {
        super();
    }
   ...
   //审核
    public void actionAudit_actionPerformed(ActionEvent e) throws Exception {
    	...
    	for (Iterator iter = pkList.iterator(); iter.hasNext();) {
			...
			NoCCFactory.getRemoteInstance().passAudit(new ObjectUuidPK(id), null);
		}
    	showOKMsgAndRefresh();
    }
    //反审核
    ...
    public void actionUnAudit_actionPerformed(ActionEvent e) throws Exception {
    	...
    	for (Iterator iter = pkList.iterator(); iter.hasNext();) {
			String id = (String) iter.next();
			NoCCFactory.getRemoteInstance().unpassAudit(new ObjectUuidPK(id), null);
		}
    	showOKMsgAndRefresh();
    }
    ...
    public void onLoad() throws Exception {
		...
		if ("L2".equals(strLanguage) || "l2".equals(strLanguage)) {
			...
			setUITitle("Information des autres");
		}
