...
public class AttenceResult extends DataBase implements IAttenceResult
{
    public AttenceResult()
    {
        super();
        registerInterface(IAttenceResult.class, this);
    }
    public AttenceResult(Context ctx)
    {
        super(ctx);
        registerInterface(IAttenceResult.class, this);
    }
    ...
    private AttenceResultController getController() throws BOSException
    {
        return (AttenceResultController)getBizController();
    }
    /**
    ...
    {
        try {
            return getController().getAttenceResultInfo(getContext(), pk);
        }
    ...
    {
        try {
            return getController().getAttenceResultInfo(getContext(), pk, selector);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getAttenceResultInfo(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getAttenceResultCollection(getContext());
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getAttenceResultCollection(getContext(), view);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getAttenceResultCollection(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
