 ...
 * output class name
 */
public abstract class AbstractAlgAttDataEditUI extends com.kingdee.eas.framework.client.CoreBillEditUI
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractAlgAttDataEditUI.class);
    ...
    protected com.kingdee.eas.zjlw.attendance.AlgAttDataInfo editData = null;
    /**
     * output class constructor
     */
    public AbstractAlgAttDataEditUI() throws Exception
    {
        super();
    ...
    {
        this.resHelper = new ResourceBundleHelper(AbstractAlgAttDataEditUI.class.getName());
        ...
        this.setFocusTraversalPolicy(new com.kingdee.bos.ui.UIFocusTraversalPolicy(new java.awt.Component[] {txtCheckSysDepNo,prmtproCom,kDDateLastUpdateTime,prmtLastUpdateUser,kDDateCreateTime,prmtCreator,prmtAuditor,txtDescription,pkBizDate,txtNumber,pkattDate,kdtEntrys}));
    ...
    {
        this.setBounds(new Rectangle(0, 0, 723, 522));
        this.setLayout(new KDLayout());
        this.putClientProperty("OriginalBounds", new Rectangle(0, 0, 723, 522));
        contCreator.setBounds(new Rectangle(12, 493, 270, 19));
        this.add(contCreator, new KDLayout.Constraints(12, 493, 270, 19, KDLayout.Constraints.ANCHOR_BOTTOM | KDLayout.Constraints.ANCHOR_LEFT | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        contCreateTime.setBounds(new Rectangle(332, 493, 270, 19));
        this.add(contCreateTime, new KDLayout.Constraints(332, 493, 270, 19, KDLayout.Constraints.ANCHOR_BOTTOM | KDLayout.Constraints.ANCHOR_LEFT_SCALE | KDLayout.Constraints.ANCHOR_RIGHT));
        contLastUpdateUser.setBounds(new Rectangle(39, 525, 270, 19));
        this.add(contLastUpdateUser, new KDLayout.Constraints(39, 525, 270, 19, 0));
        contLastUpdateTime.setBounds(new Rectangle(318, 523, 270, 19));
        this.add(contLastUpdateTime, new KDLayout.Constraints(318, 523, 270, 19, 0));
        contNumber.setBounds(new Rectangle(13, 9, 222, 19));
        this.add(contNumber, new KDLayout.Constraints(13, 9, 222, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        contBizDate.setBounds(new Rectangle(13, 38, 222, 19));
        this.add(contBizDate, new KDLayout.Constraints(13, 38, 222, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        contDescription.setBounds(new Rectangle(490, 38, 222, 19));
        this.add(contDescription, new KDLayout.Constraints(490, 38, 222, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT_SCALE | KDLayout.Constraints.ANCHOR_RIGHT));
        contAuditor.setBounds(new Rectangle(17, 547, 270, 19));
        this.add(contAuditor, new KDLayout.Constraints(17, 547, 270, 19, 0));
        kdtEntrys.setBounds(new Rectangle(11, 68, 703, 413));
        kdtEntrys_detailPanel = (com.kingdee.eas.framework.client.multiDetail.DetailPanel)com.kingdee.eas.framework.client.multiDetail.HMDUtils.buildDetail(this,dataBinder,kdtEntrys,new com.kingdee.eas.zjlw.attendance.AlgAttDataEntryInfo(),null,false);
        this.add(kdtEntrys_detailPanel, new KDLayout.Constraints(11, 68, 703, 413, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_BOTTOM | KDLayout.Constraints.ANCHOR_LEFT | KDLayout.Constraints.ANCHOR_RIGHT));
        contCheckSysDepNo.setBounds(new Rectangle(490, 9, 222, 19));
        this.add(contCheckSysDepNo, new KDLayout.Constraints(490, 9, 222, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT_SCALE | KDLayout.Constraints.ANCHOR_RIGHT));
        contproCom.setBounds(new Rectangle(253, 9, 222, 19));
        this.add(contproCom, new KDLayout.Constraints(253, 9, 222, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT_SCALE | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        contattDate.setBounds(new Rectangle(253, 38, 222, 19));
        this.add(contattDate, new KDLayout.Constraints(253, 38, 222, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT_SCALE | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        //contCreator
	...
	private void registerBindings(){
		...
		dataBinder.registerBinding("entrys", com.kingdee.eas.zjlw.attendance.AlgAttDataEntryInfo.class, this.kdtEntrys, "userObject");
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.zjlw.attendance.app.AlgAttDataEditUIHandler";
	}
    ...
    public void setDataObject(IObjectValue dataObject)
    {
        ...
        this.editData = (com.kingdee.eas.zjlw.attendance.AlgAttDataInfo)ov;
    }
    ...
    {
        return new MetaDataPK("com.kingdee.eas.zjlw.attendance.client", "AlgAttDataEditUI");
    }
    /**
    ...
    {
        return com.kingdee.eas.zjlw.attendance.client.AlgAttDataEditUI.class.getName();
    }
    ...
    {
        return com.kingdee.eas.zjlw.attendance.AlgAttDataFactory.getRemoteInstance();
    }
    ...
    {
        com.kingdee.eas.zjlw.attendance.AlgAttDataInfo objectValue = new com.kingdee.eas.zjlw.attendance.AlgAttDataInfo();
    	...
    	return "/bim/zjlw/attendance/AlgAttData";
	}
    protected IMetaDataPK getTDQueryPK() {
    	return new MetaDataPK("com.kingdee.eas.zjlw.attendance.app.AlgAttDataQuery");
	}
