 ...
 * output class name
 */
public abstract class AbstractWkPmtUpdtECEditUI extends com.kingdee.eas.framework.client.CoreBillEditUI
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractWkPmtUpdtECEditUI.class);
    ...
    protected com.kingdee.eas.zjlw.certificates.WkPmtUpdtECInfo editData = null;
    protected ActionAudit actionAudit = null;
    protected ActionUnAudit actionUnAudit = null;
    /**
     * output class constructor
     */
    public AbstractWkPmtUpdtECEditUI() throws Exception
    {
        super();
    ...
    {
        this.resHelper = new ResourceBundleHelper(AbstractWkPmtUpdtECEditUI.class.getName());
        ...
        this.kdtEntrys.addKDTEditListener(new com.kingdee.bos.ctrl.kdf.table.event.KDTEditAdapter() {
            public void editStopped(com.kingdee.bos.ctrl.kdf.table.event.KDTEditEvent e) {
                ...
                this.kdtEntrys.putBindContents("editData",new String[] {"id","name","lastName","firstName","sex","birthday","birthPlace","birthPlaceFr","nation","passpNum","passportIssueDate","passpExDate","passportAgence","passportCityC","passportCityF","actProf","quProf","quproff","workEXP","authType","fatherName","fatherNameAlphabet","motherName","motherNameAlphabet","MaritalStatus","immiTime","HwPmtNum","hWPmtSTime","papSTime","pType","wPmtNum","wPmtGTime","laboreffDate","wPmtSTime","sPAfPerson","pmtProj","workOrg","cooperation","oldPassport","IdNum","remark","HpapSTime","HwPmtGTime","dlyChkFrc","personID","sourceEntryID","oldEtyId"});
    ...
    public void initUIContentLayout()
    {
        ...
        contNumber.setBounds(new Rectangle(18, 10, 209, 19));
        this.add(contNumber, new KDLayout.Constraints(18, 10, 209, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        contBizDate.setBounds(new Rectangle(250, 10, 211, 19));
        this.add(contBizDate, new KDLayout.Constraints(250, 10, 211, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT_SCALE | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        contDescription.setBounds(new Rectangle(710, 10, 276, 19));
        this.add(contDescription, new KDLayout.Constraints(710, 10, 276, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT_SCALE | KDLayout.Constraints.ANCHOR_RIGHT));
        ...
        kdtEntrys_detailPanel = (com.kingdee.eas.framework.client.multiDetail.DetailPanel)com.kingdee.eas.framework.client.multiDetail.HMDUtils.buildDetail(this,dataBinder,kdtEntrys,new com.kingdee.eas.zjlw.certificates.WkPmtUpdtECEntryInfo(),null,false);
...
vo.put("pType","0");
        ...
        contbNum.setBounds(new Rectangle(326, 118, 215, 19));
        this.add(contbNum, new KDLayout.Constraints(326, 118, 215, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT_SCALE | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        ...
        contbillSate.setBounds(new Rectangle(486, 10, 211, 19));
        this.add(contbillSate, new KDLayout.Constraints(486, 10, 211, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT_SCALE | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        kDLabelContainer1.setBounds(new Rectangle(17, 36, 436, 19));
        this.add(kDLabelContainer1, new KDLayout.Constraints(17, 36, 436, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        //contCreator
	...
	private void registerBindings(){
		...
		dataBinder.registerBinding("entrys", com.kingdee.eas.zjlw.certificates.WkPmtUpdtECEntryInfo.class, this.kdtEntrys, "userObject");
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.zjlw.certificates.app.WkPmtUpdtECEditUIHandler";
	}
    ...
    public void setDataObject(IObjectValue dataObject)
    {
        ...
        this.editData = (com.kingdee.eas.zjlw.certificates.WkPmtUpdtECInfo)ov;
    }
    ...
    protected class ActionAudit extends ItemAction {     
        ...
        public void actionPerformed(ActionEvent e)
        {
            ...
            innerActionPerformed("eas", AbstractWkPmtUpdtECEditUI.this, "ActionAudit", "actionAudit_actionPerformed", e);
        }
    }
    ...
    protected class ActionUnAudit extends ItemAction {     
        ...
        {
        	getUIContext().put("ORG.PK", getOrgPK(this));
            innerActionPerformed("eas", AbstractWkPmtUpdtECEditUI.this, "ActionUnAudit", "actionUnAudit_actionPerformed", e);
        }
    }
    ...
    {
        return new MetaDataPK("com.kingdee.eas.zjlw.certificates.client", "WkPmtUpdtECEditUI");
    }
    /**
    ...
    {
        return com.kingdee.eas.zjlw.certificates.client.WkPmtUpdtECEditUI.class.getName();
    }
    ...
    protected IObjectValue createNewData()
    {
    	...
    	return "/bim/zjlw/certificates/WkPmtUpdtEC";
	}
