 ...
 * output class name
 */
public class PayBillEditUI extends AbstractPayBillEditUI
{
    private static final Logger logger = CoreUIObject.getLogger(PayBillEditUI.class);
    
    /**
     * output class constructor
     */
    public PayBillEditUI() throws Exception
    {
        super();
    }
    /**
