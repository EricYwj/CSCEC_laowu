 ...
 * output class name
 */
public class AlgattenceResultListUI extends AbstractAlgattenceResultListUI
{
    private static final Logger logger = CoreUIObject.getLogger(AlgattenceResultListUI.class);
    
    /**
     * output class constructor
     */
    public AlgattenceResultListUI() throws Exception
    {
        super();
    }
