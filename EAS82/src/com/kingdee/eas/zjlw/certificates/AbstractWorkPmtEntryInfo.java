...
public class AbstractWorkPmtEntryInfo extends com.kingdee.eas.framework.CoreBillEntryBaseInfo implements Serializable 
{
    public AbstractWorkPmtEntryInfo()
    {
        this("id");
    }
    protected AbstractWorkPmtEntryInfo(String pkField)
    {
        super(pkField);
    }
    /**
     ...
     */
    public com.kingdee.eas.zjlw.certificates.WorkPmtInfo getParent()
    {
        return (com.kingdee.eas.zjlw.certificates.WorkPmtInfo)get("parent");
    }
    public void setParent(com.kingdee.eas.zjlw.certificates.WorkPmtInfo item)
    {
        put("parent", item);
    }
    /**
