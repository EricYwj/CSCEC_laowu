 ...
 * output class name
 */
public abstract class AbstractAttencePersonListUI extends com.kingdee.eas.framework.client.ListUI
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractAttencePersonListUI.class);
    /**
     * output class constructor
     */
    public AbstractAttencePersonListUI() throws Exception
    {
        super();
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.zjlw.attendance.app.AttencePersonListUIHandler";
	}
    ...
    {
        return new MetaDataPK("com.kingdee.eas.zjlw.attendance.client", "AttencePersonListUI");
    }
