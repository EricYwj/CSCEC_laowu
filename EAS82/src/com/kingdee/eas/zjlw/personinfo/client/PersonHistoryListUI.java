 ...
 * output class name
 */
public class PersonHistoryListUI extends AbstractPersonHistoryListUI
{
    private static final Logger logger = CoreUIObject.getLogger(PersonHistoryListUI.class);
     ...
     */
    public PersonHistoryListUI() throws Exception
    {
        super();
    }
