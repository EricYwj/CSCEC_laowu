...
public class AbstractAntiLogoutEntryInfo extends com.kingdee.eas.framework.CoreBillEntryBaseInfo implements Serializable 
{
    public AbstractAntiLogoutEntryInfo()
    {
        this("id");
    }
    protected AbstractAntiLogoutEntryInfo(String pkField)
    {
        super(pkField);
    }
    /**
     ...
     */
    public com.kingdee.eas.zjlw.certificates.AntiLogoutInfo getParent()
    {
        return (com.kingdee.eas.zjlw.certificates.AntiLogoutInfo)get("parent");
    }
    public void setParent(com.kingdee.eas.zjlw.certificates.AntiLogoutInfo item)
    {
        put("parent", item);
    }
    /**
