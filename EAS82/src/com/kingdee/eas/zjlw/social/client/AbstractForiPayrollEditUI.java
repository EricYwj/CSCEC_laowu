 ...
 * output class name
 */
public abstract class AbstractForiPayrollEditUI extends com.kingdee.eas.framework.client.CoreBillEditUI
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractForiPayrollEditUI.class);
    ...
    protected com.kingdee.eas.zjlw.social.ForiPayrollInfo editData = null;
    /**
     * output class constructor
     */
    public AbstractForiPayrollEditUI() throws Exception
    {
        super();
    ...
    {
        this.resHelper = new ResourceBundleHelper(AbstractForiPayrollEditUI.class.getName());
        ...
        this.kdtEntrys.addKDTEditListener(new com.kingdee.bos.ctrl.kdf.table.event.KDTEditAdapter() {
            public void editStopped(com.kingdee.bos.ctrl.kdf.table.event.KDTEditEvent e) {
                ...
                this.kdtEntrys.putBindContents("editData",new String[] {"id","lastName","firstName","maritalStatus","country","enterDate","secuProf","basePay","nWorkDay","attMthWage","seniWage","nmlBsWgPerHour","normalOver","hldBsWgPerHour","festOver","totNmlBsWg","totHldBsWg","traWage","eatWage","urgeWage","oneTimeWage","bTripWage","riskWage","disasWage","langWage","thingsWage","oneWorkWage","nWorkWage","phoneWageC","itmperieTol","switchWage","areaWage","faraWage","liveWage","FamilyWage","studyWage","fireWage","retirWage","pOverAward","spendWage","grossPay","SociaLevyBase","secuDebit","vacaDebit","IRGLBase","IRGDPerson","totCharge","netPay","soLevyBaseW","IRGLBaseW","IRGDeduction","coopCode","securityNo","CCPNo","foriPersID","workProgram","cooperation","remark","persTax","posiPay","chineWage","algerWage","unSignWage","profAward","monthAward","indPay","wifeUnWage","unSCVCWage","prof","position","absence","absDebit","moreOver","profWage","extProfWage","personID","overTraWage","aftTaxPay","monthWork","abcdefg","aaa","oriPersonId"});
        ...
        this.contacountRow.setVisible(true);
        // contprojAddress		
        ...
        this.prmtprojName.setFocusCycleRoot(true);		
    ...
    public void initUIContentLayout()
    {
        ...
        kdtEntrys.setBounds(new Rectangle(20, 134, 1120, 352));
        kdtEntrys_detailPanel = (com.kingdee.eas.framework.client.multiDetail.DetailPanel)com.kingdee.eas.framework.client.multiDetail.HMDUtils.buildDetail(this,dataBinder,kdtEntrys,new com.kingdee.eas.zjlw.social.ForiPayrollEntryInfo(),null,false);
        this.add(kdtEntrys_detailPanel, new KDLayout.Constraints(20, 134, 1120, 352, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_BOTTOM | KDLayout.Constraints.ANCHOR_LEFT | KDLayout.Constraints.ANCHOR_RIGHT));
...
vo.put("maritalStatus","0");
        ...
        contprojName.setBounds(new Rectangle(23, 13, 262, 19));
        this.add(contprojName, new KDLayout.Constraints(23, 13, 262, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        ...
        contsecurityProj.setBounds(new Rectangle(22, 179, 262, 19));
        this.add(contsecurityProj, new KDLayout.Constraints(22, 179, 262, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        kDLabelContainer1.setBounds(new Rectangle(22, 108, 270, 19));
        this.add(kDLabelContainer1, new KDLayout.Constraints(22, 108, 270, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        chkisOK.setBounds(new Rectangle(19, 80, 299, 19));
        this.add(chkisOK, new KDLayout.Constraints(19, 80, 299, 19, 0));
        contacountRow.setBounds(new Rectangle(630, 78, 270, 19));
        this.add(contacountRow, new KDLayout.Constraints(630, 78, 270, 19, 0));
        contprojAddress.setBounds(new Rectangle(325, 77, 270, 19));
        this.add(contprojAddress, new KDLayout.Constraints(325, 77, 270, 19, 0));
        //contCreator
	...
	private void registerBindings(){
		...
		dataBinder.registerBinding("entrys", com.kingdee.eas.zjlw.social.ForiPayrollEntryInfo.class, this.kdtEntrys, "userObject");
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.zjlw.social.app.ForiPayrollEditUIHandler";
	}
    ...
    public void setDataObject(IObjectValue dataObject)
    {
        ...
        this.editData = (com.kingdee.eas.zjlw.social.ForiPayrollInfo)ov;
    }
    ...
    {
        return new MetaDataPK("com.kingdee.eas.zjlw.social.client", "ForiPayrollEditUI");
    }
    /**
    ...
    {
        return com.kingdee.eas.zjlw.social.client.ForiPayrollEditUI.class.getName();
    }
    ...
    protected IObjectValue createNewData()
    {
    	...
    	return "/bim/zjlw/social/ForiPayroll";
	}
    protected IMetaDataPK getTDQueryPK() {
    	return new MetaDataPK("com.kingdee.eas.zjlw.social.app.ForiPayrollQuery");
	}
