 ...
 * output class name
 */
public class PassportEditUI extends AbstractPassportEditUI
{
    private static final Logger logger = CoreUIObject.getLogger(PassportEditUI.class);
     ...
     */
    public PassportEditUI() throws Exception
    {
        super();
    }
    /**
