 ...
 * output class name
 */
public abstract class AbstractExtAccountEditUI extends com.kingdee.eas.framework.client.EditUI
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractExtAccountEditUI.class);
    ...
    protected com.kingdee.eas.zjlw.baseinfo.ExtAccountInfo editData = null;
    /**
     * output class constructor
     */
    public AbstractExtAccountEditUI() throws Exception
    {
        super();
    ...
    {
        this.resHelper = new ResourceBundleHelper(AbstractExtAccountEditUI.class.getName());
    ...
    public void initUIContentLayout()
    {
        ...
        kDLabelContainer2.setBounds(new Rectangle(545, 15, 187, 19));
        this.add(kDLabelContainer2, new KDLayout.Constraints(545, 15, 187, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT_SCALE | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        ...
        kdtEntrys_detailPanel = (com.kingdee.eas.framework.client.multiDetail.DetailPanel)com.kingdee.eas.framework.client.multiDetail.HMDUtils.buildDetail(this,dataBinder,kdtEntrys,new com.kingdee.eas.zjlw.baseinfo.ExtAccountEntryInfo(),null,false);
...
vo.put("maritalStatus","0");
        ...
        contorganizational.setBounds(new Rectangle(1052, 82, 193, 19));
        this.add(contorganizational, new KDLayout.Constraints(1052, 82, 193, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT_SCALE | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        //kDLabelContainer1
	...
	private void registerBindings(){
		...
		dataBinder.registerBinding("Entrys", com.kingdee.eas.zjlw.baseinfo.ExtAccountEntryInfo.class, this.kdtEntrys, "userObject");
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.zjlw.baseinfo.app.ExtAccountEditUIHandler";
	}
    ...
    public void setDataObject(IObjectValue dataObject)
    {
        ...
        this.editData = (com.kingdee.eas.zjlw.baseinfo.ExtAccountInfo)ov;
    }
    ...
    {
        return new MetaDataPK("com.kingdee.eas.zjlw.baseinfo.client", "ExtAccountEditUI");
    }
