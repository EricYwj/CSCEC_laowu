...
public class VabaweatherControllerBean extends AbstractVabaweatherControllerBean
{
    private static Logger logger =Logger.getLogger("com.kingdee.eas.zjlw.social.app.VabaweatherControllerBean");
    
 // 保存
	protected IObjectPK _save(Context ctx, IObjectValue model)throws BOSException, EASBizException {
		VabaweatherInfo accInfo = (VabaweatherInfo) model;
...
//    	}
    ...
    protected void _passAudit(Context ctx, IObjectPK pk, IObjectValue model)throws EASBizException, BOSException {
    	VabaweatherInfo info = (VabaweatherInfo) getValue(ctx, pk, getSelector());
