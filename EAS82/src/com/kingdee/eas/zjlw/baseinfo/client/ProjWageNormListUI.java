 ...
 * output class name
 */
public class ProjWageNormListUI extends AbstractProjWageNormListUI
{
    private static final Logger logger = CoreUIObject.getLogger(ProjWageNormListUI.class);
    
    /**
     * output class constructor
     */
    public ProjWageNormListUI() throws Exception
    {
        super();
    }
