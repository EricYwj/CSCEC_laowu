 ...
 * output class name
 */
public abstract class AbstractAntiSignedEditUI extends com.kingdee.eas.framework.client.CoreBillEditUI
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractAntiSignedEditUI.class);
    ...
    protected com.kingdee.eas.zjlw.certificates.AntiSignedInfo editData = null;
     ...
     */
    public AbstractAntiSignedEditUI() throws Exception
    {
        super();
    ...
    {
        this.resHelper = new ResourceBundleHelper(AbstractAntiSignedEditUI.class.getName());
        ...
        KDComboBox kdtEntrys_perSt_ComboBox = new KDComboBox();
        kdtEntrys_perSt_ComboBox.setName("kdtEntrys_perSt_ComboBox");
        kdtEntrys_perSt_ComboBox.setVisible(true);
        kdtEntrys_perSt_ComboBox.addItems(EnumUtils.getEnumList("com.kingdee.eas.zjlw.certificates.app.antiPerStEmun").toArray());
        KDTDefaultCellEditor kdtEntrys_perSt_CellEditor = new KDTDefaultCellEditor(kdtEntrys_perSt_ComboBox);
        this.kdtEntrys.getColumn("perSt").setEditor(kdtEntrys_perSt_CellEditor);
    ...
    public void initUIContentLayout()
    {
        ...
        kdtEntrys_detailPanel = (com.kingdee.eas.framework.client.multiDetail.DetailPanel)com.kingdee.eas.framework.client.multiDetail.HMDUtils.buildDetail(this,dataBinder,kdtEntrys,new com.kingdee.eas.zjlw.certificates.AntiSignedEntryInfo(),null,false);
...
vo.put("perSt","1");
	...
	private void registerBindings(){
		...
		dataBinder.registerBinding("entrys", com.kingdee.eas.zjlw.certificates.AntiSignedEntryInfo.class, this.kdtEntrys, "userObject");
		...
		dataBinder.registerBinding("entrys.perSt", com.kingdee.util.enums.Enum.class, this.kdtEntrys, "perSt.text");
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.zjlw.certificates.app.AntiSignedEditUIHandler";
	}
    ...
    public void setDataObject(IObjectValue dataObject)
    {
        ...
        this.editData = (com.kingdee.eas.zjlw.certificates.AntiSignedInfo)ov;
    }
	...
	protected void registerValidator() {
		...
		getValidateHelper().registerBindProperty("entrys.perSt", ValidateHelper.ON_SAVE);    
    ...
    protected class ActionAudit extends ItemAction {     
        ...
        public void actionPerformed(ActionEvent e)
        {
            ...
            innerActionPerformed("eas", AbstractAntiSignedEditUI.this, "ActionAudit", "actionAudit_actionPerformed", e);
        }
    }
    ...
    protected class ActionUnAudit extends ItemAction {     
        ...
        {
        	getUIContext().put("ORG.PK", getOrgPK(this));
            innerActionPerformed("eas", AbstractAntiSignedEditUI.this, "ActionUnAudit", "actionUnAudit_actionPerformed", e);
        }
    }
    ...
    protected class ActionLogout extends ItemAction {     
        ...
        {
        	getUIContext().put("ORG.PK", getOrgPK(this));
            innerActionPerformed("eas", AbstractAntiSignedEditUI.this, "ActionLogout", "actionLogout_actionPerformed", e);
        }
    }
    ...
    protected class ActionRollBack extends ItemAction {     
        ...
        {
        	getUIContext().put("ORG.PK", getOrgPK(this));
            innerActionPerformed("eas", AbstractAntiSignedEditUI.this, "ActionRollBack", "actionRollBack_actionPerformed", e);
        }
    }
    ...
    {
        return new MetaDataPK("com.kingdee.eas.zjlw.certificates.client", "AntiSignedEditUI");
    }
    /**
