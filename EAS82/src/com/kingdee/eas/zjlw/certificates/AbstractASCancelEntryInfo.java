...
public class AbstractASCancelEntryInfo extends com.kingdee.eas.framework.CoreBillEntryBaseInfo implements Serializable 
{
    public AbstractASCancelEntryInfo()
    {
        this("id");
    }
    protected AbstractASCancelEntryInfo(String pkField)
    {
        super(pkField);
    }
    /**
     ...
     */
    public com.kingdee.eas.zjlw.certificates.ASCancelInfo getParent()
    {
        return (com.kingdee.eas.zjlw.certificates.ASCancelInfo)get("parent");
    }
    public void setParent(com.kingdee.eas.zjlw.certificates.ASCancelInfo item)
    {
        put("parent", item);
    }
    /**
     ...
     */
    public String getPasspCrop()
    {
        return getString("passpCrop");
    }
    public void setPasspCrop(String item)
    {
        setString("passpCrop", item);
    }
    /**
    ...
    /**
     * Object:分录's 国内联系方式（手机号）property 
     */
    ...
    /**
     * Object:分录's 国内联系详细地址(省市县)property 
     */
