...
public class PayPrintControllerBean extends AbstractPayPrintControllerBean
{
    private static Logger logger =
        Logger.getLogger("com.kingdee.eas.zjlw.social.app.PayPrintControllerBean");
...
//    	PayPrintInfo info = (PayPrintInfo)model;
...
//    }
	 ...
	 */
	private PayPrintInfo initCont(Context ctx, PayPrintInfo info) throws EASBizException, BOSException {
		...
		if (info.getProjName() != null) {
			...
			if (col != null && col.size() != 0) {
				...
				info.setInsuranceAcc(pro.getInsuranceAcc());
				info.setAddressFR(pro.getAddressFR());
			}
		}
		return info;
