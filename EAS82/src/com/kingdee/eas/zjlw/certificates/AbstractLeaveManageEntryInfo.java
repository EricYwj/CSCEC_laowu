...
public class AbstractLeaveManageEntryInfo extends com.kingdee.eas.framework.CoreBillEntryBaseInfo implements Serializable 
{
    public AbstractLeaveManageEntryInfo()
    {
        this("id");
    }
    protected AbstractLeaveManageEntryInfo(String pkField)
    {
        super(pkField);
    }
    /**
     ...
     */
    public com.kingdee.eas.zjlw.certificates.LeaveManageInfo getParent()
    {
        return (com.kingdee.eas.zjlw.certificates.LeaveManageInfo)get("parent");
    }
    public void setParent(com.kingdee.eas.zjlw.certificates.LeaveManageInfo item)
    {
        put("parent", item);
    }
    /**
