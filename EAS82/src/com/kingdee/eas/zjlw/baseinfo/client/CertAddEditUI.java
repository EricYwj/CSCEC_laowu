 ...
 * output class name
 */
public class CertAddEditUI extends AbstractCertAddEditUI
{
    private static final Logger logger = CoreUIObject.getLogger(CertAddEditUI.class);
    
    /**
     * output class constructor
     */
    public CertAddEditUI() throws Exception
    {
        super();
    }
    /**
