 ...
 * output class name
 */
public class WorkOrgChangeListUI extends AbstractWorkOrgChangeListUI
{
    private static final Logger logger = CoreUIObject.getLogger(WorkOrgChangeListUI.class);
    
    /**
     * output class constructor
     */
    public WorkOrgChangeListUI() throws Exception
    {
        super();
    }
