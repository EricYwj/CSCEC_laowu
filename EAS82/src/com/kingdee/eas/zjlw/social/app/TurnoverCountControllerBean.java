...
public class TurnoverCountControllerBean extends AbstractTurnoverCountControllerBean
{
    private static Logger logger = Logger.getLogger("com.kingdee.eas.zjlw.social.app.TurnoverCountControllerBean");

    // 保存
   	protected IObjectPK _save(Context ctx, IObjectValue model)throws BOSException, EASBizException {
   		TurnoverCountInfo accInfo = (TurnoverCountInfo) model;
...
//       	}
       ...
       protected void _passAudit(Context ctx, IObjectPK pk, IObjectValue model)throws EASBizException, BOSException {
    	   TurnoverCountInfo info = (TurnoverCountInfo) getValue(ctx, pk, getSelector());
