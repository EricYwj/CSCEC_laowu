...
public class AbstractPayrollEntryInfo extends com.kingdee.eas.framework.CoreBillEntryBaseInfo implements Serializable 
{
    public AbstractPayrollEntryInfo()
    {
        this("id");
    }
    protected AbstractPayrollEntryInfo(String pkField)
    {
        super(pkField);
    }
    /**
     ...
     */
    public com.kingdee.eas.zjlw.social.PayrollInfo getParent()
    {
        return (com.kingdee.eas.zjlw.social.PayrollInfo)get("parent");
    }
    public void setParent(com.kingdee.eas.zjlw.social.PayrollInfo item)
    {
        put("parent", item);
    }
    /**
