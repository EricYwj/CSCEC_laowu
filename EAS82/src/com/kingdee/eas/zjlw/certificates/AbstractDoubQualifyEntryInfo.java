...
public class AbstractDoubQualifyEntryInfo extends com.kingdee.eas.framework.CoreBillEntryBaseInfo implements Serializable 
{
    public AbstractDoubQualifyEntryInfo()
    {
        this("id");
    }
    protected AbstractDoubQualifyEntryInfo(String pkField)
    {
        super(pkField);
    }
    /**
     ...
     */
    public com.kingdee.eas.zjlw.certificates.DoubQualifyInfo getParent()
    {
        return (com.kingdee.eas.zjlw.certificates.DoubQualifyInfo)get("parent");
    }
    public void setParent(com.kingdee.eas.zjlw.certificates.DoubQualifyInfo item)
    {
        put("parent", item);
    }
    /**
