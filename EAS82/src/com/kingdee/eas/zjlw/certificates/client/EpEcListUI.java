 ...
 * output class name
 */
public class EpEcListUI extends AbstractEpEcListUI
{
    private static final Logger logger = CoreUIObject.getLogger(EpEcListUI.class);
    
    /**
     * output class constructor
     */
    public EpEcListUI() throws Exception
    {
        super();
    }
