 ...
 * output class name
 */
public class CertAddListUI extends AbstractCertAddListUI
{
    private static final Logger logger = CoreUIObject.getLogger(CertAddListUI.class);
    
    /**
     * output class constructor
     */
    public CertAddListUI() throws Exception
    {
        super();
    }
