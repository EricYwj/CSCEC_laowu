...
public class AbstractExilivepermitEntryInfo extends com.kingdee.eas.framework.CoreBillEntryBaseInfo implements Serializable 
{
    public AbstractExilivepermitEntryInfo()
    {
        this("id");
    }
    protected AbstractExilivepermitEntryInfo(String pkField)
    {
        super(pkField);
    }
    /**
     ...
     */
    public com.kingdee.eas.zjlw.certificates.ExilivepermitInfo getParent()
    {
        return (com.kingdee.eas.zjlw.certificates.ExilivepermitInfo)get("parent");
    }
    public void setParent(com.kingdee.eas.zjlw.certificates.ExilivepermitInfo item)
    {
        put("parent", item);
    }
    /**
