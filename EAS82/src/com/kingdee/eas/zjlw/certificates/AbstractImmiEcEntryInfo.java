...
public class AbstractImmiEcEntryInfo extends com.kingdee.eas.framework.CoreBillEntryBaseInfo implements Serializable 
{
    public AbstractImmiEcEntryInfo()
    {
        this("id");
    }
    protected AbstractImmiEcEntryInfo(String pkField)
    {
        super(pkField);
    }
    /**
     ...
     */
    public com.kingdee.eas.zjlw.certificates.ImmiEcInfo getParent()
    {
        return (com.kingdee.eas.zjlw.certificates.ImmiEcInfo)get("parent");
    }
    public void setParent(com.kingdee.eas.zjlw.certificates.ImmiEcInfo item)
    {
        put("parent", item);
    }
    /**
