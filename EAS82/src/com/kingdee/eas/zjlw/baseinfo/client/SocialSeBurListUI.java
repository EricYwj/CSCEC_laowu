 ...
 * output class name
 */
public class SocialSeBurListUI extends AbstractSocialSeBurListUI {
	private static final Logger logger = CoreUIObject
			.getLogger(SocialSeBurListUI.class);

	/**
	 * output class constructor
	 */
	public SocialSeBurListUI() throws Exception {
		super();
	}
	...
	protected com.kingdee.eas.framework.ICoreBase getBizInterface()
			throws Exception {
		return com.kingdee.eas.zjlw.baseinfo.SocialSeBurFactory
				.getRemoteInstance();
	}
