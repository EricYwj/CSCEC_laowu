 ...
 * output class name
 */
public class BusinessVisaListUI extends AbstractBusinessVisaListUI
{
    private static final Logger logger = CoreUIObject.getLogger(BusinessVisaListUI.class);
    
    /**
     * output class constructor
     */
    public BusinessVisaListUI() throws Exception
    {
        super();
    }
    ...
    public void actionAudit_actionPerformed(ActionEvent e) throws Exception {
    	...
    	for (Iterator iter = pkList.iterator(); iter.hasNext();) {
			...
			BusinessVisaFactory.getRemoteInstance().passAudit(new ObjectUuidPK(id), null);
		}
    ...
    public void actionUnAudit_actionPerformed(ActionEvent e) throws Exception {
    	...
    	for (Iterator iter = pkList.iterator(); iter.hasNext();) {
			String id = (String) iter.next();
			BusinessVisaFactory.getRemoteInstance().unpassAudit(new ObjectUuidPK(id), null);
		}
    ...
    {   
    	checkBill(new String[] { "20","30" }, "actionAudit");
