...
public class AbstractExLivepermitECEntryInfo extends com.kingdee.eas.framework.CoreBillEntryBaseInfo implements Serializable 
{
    public AbstractExLivepermitECEntryInfo()
    {
        this("id");
    }
    protected AbstractExLivepermitECEntryInfo(String pkField)
    {
        super(pkField);
    }
    /**
     ...
     */
    public com.kingdee.eas.zjlw.certificates.ExLivepermitECInfo getParent()
    {
        return (com.kingdee.eas.zjlw.certificates.ExLivepermitECInfo)get("parent");
    }
    public void setParent(com.kingdee.eas.zjlw.certificates.ExLivepermitECInfo item)
    {
        put("parent", item);
    }
    /**
