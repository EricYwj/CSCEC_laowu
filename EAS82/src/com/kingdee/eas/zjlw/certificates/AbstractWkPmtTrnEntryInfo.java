...
public class AbstractWkPmtTrnEntryInfo extends com.kingdee.eas.framework.CoreBillEntryBaseInfo implements Serializable 
{
    public AbstractWkPmtTrnEntryInfo()
    {
        this("id");
    }
    protected AbstractWkPmtTrnEntryInfo(String pkField)
    {
        super(pkField);
    }
    /**
     ...
     */
    public com.kingdee.eas.zjlw.certificates.WkPmtTrnInfo getParent()
    {
        return (com.kingdee.eas.zjlw.certificates.WkPmtTrnInfo)get("parent");
    }
    public void setParent(com.kingdee.eas.zjlw.certificates.WkPmtTrnInfo item)
    {
        put("parent", item);
    }
    /**
