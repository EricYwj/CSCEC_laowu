 ...
 * output class name
 */
public abstract class AbstractAttenceResultEditUI extends com.kingdee.eas.framework.client.EditUI
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractAttenceResultEditUI.class);
    ...
    protected com.kingdee.bos.ctrl.swing.KDLabelContainer contfactprof;
    ...
    protected com.kingdee.bos.ctrl.swing.KDTextField txtfactprof;
    ...
    protected com.kingdee.eas.zjlw.attendance.AttenceResultInfo editData = null;
    /**
     * output class constructor
     */
    public AbstractAttenceResultEditUI() throws Exception
    {
        super();
    ...
    {
        this.resHelper = new ResourceBundleHelper(AbstractAttenceResultEditUI.class.getName());
        ...
        this.contfactprof = new com.kingdee.bos.ctrl.swing.KDLabelContainer();
        ...
        this.txtfactprof = new com.kingdee.bos.ctrl.swing.KDTextField();
        ...
        this.contfactprof.setName("contfactprof");
        ...
        this.txtfactprof.setName("txtfactprof");
        ...
        // contfactprof		
        this.contfactprof.setBoundLabelText(resHelper.getString("contfactprof.boundLabelText"));		
        this.contfactprof.setBoundLabelLength(100);		
        this.contfactprof.setBoundLabelUnderline(true);		
        this.contfactprof.setVisible(true);
        // contCheckNo		
        ...
        // txtfactprof		
        this.txtfactprof.setVisible(true);		
        this.txtfactprof.setHorizontalAlignment(2);		
        this.txtfactprof.setMaxLength(100);		
        this.txtfactprof.setRequired(false);
        // txtCheckNo		
        ...
        // checkResult		
        this.checkResult.setVisible(true);		
        this.checkResult.addItems(EnumUtils.getEnumList("com.kingdee.eas.zjlw.attendance.app.checkResultEnum").toArray());		
        this.checkResult.setRequired(false);
        this.setFocusTraversalPolicy(new com.kingdee.bos.ui.UIFocusTraversalPolicy(new java.awt.Component[] {txtpersonId,txtfactprof,txtCheckNo,pkcheckDate,checkResult}));
    ...
    {
        this.setBounds(new Rectangle(0, 0, 1013, 198));
        this.setLayout(null);
        kDLabelContainer1.setBounds(new Rectangle(34, 49, 270, 19));
        this.add(kDLabelContainer1, null);
        kDLabelContainer2.setBounds(new Rectangle(349, 49, 270, 19));
        this.add(kDLabelContainer2, null);
        kDLabelContainer3.setBounds(new Rectangle(579, 219, 270, 19));
        this.add(kDLabelContainer3, null);
        kDLabelContainer4.setBounds(new Rectangle(34, 123, 907, 19));
        this.add(kDLabelContainer4, null);
        contpersonId.setBounds(new Rectangle(34, 85, 270, 19));
        this.add(contpersonId, null);
        contfactprof.setBounds(new Rectangle(261, 218, 270, 19));
        this.add(contfactprof, null);
        contCheckNo.setBounds(new Rectangle(665, 49, 270, 19));
        this.add(contCheckNo, null);
        contcheckDate.setBounds(new Rectangle(665, 85, 270, 19));
        this.add(contcheckDate, null);
        contcheckResult.setBounds(new Rectangle(349, 85, 270, 19));
        this.add(contcheckResult, null);
        //kDLabelContainer1
        ...
        //contfactprof
        contfactprof.setBoundEditor(txtfactprof);
        //contCheckNo
	...
	private void registerBindings(){
		...
		dataBinder.registerBinding("factprof", String.class, this.txtfactprof, "text");
		...
		dataBinder.registerBinding("checkResult", com.kingdee.eas.zjlw.attendance.app.checkResultEnum.class, this.checkResult, "selectedItem");		
	}
	//Regiester UI State
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.zjlw.attendance.app.AttenceResultEditUIHandler";
	}
    ...
    public void setDataObject(IObjectValue dataObject)
    {
        ...
        this.editData = (com.kingdee.eas.zjlw.attendance.AttenceResultInfo)ov;
    }
	...
	protected void registerValidator() {
		...
		getValidateHelper().registerBindProperty("factprof", ValidateHelper.ON_SAVE);    
    ...
    public SelectorItemCollection getSelectors()
    {
        ...
        sic.add(new SelectorItemInfo("factprof"));
    ...
    {
        return new MetaDataPK("com.kingdee.eas.zjlw.attendance.client", "AttenceResultEditUI");
    }
    ...
    {
        return com.kingdee.eas.zjlw.attendance.client.AttenceResultEditUI.class.getName();
    }
    ...
    {
        return com.kingdee.eas.zjlw.attendance.AttenceResultFactory.getRemoteInstance();
    }
    ...
    {
        com.kingdee.eas.zjlw.attendance.AttenceResultInfo objectValue = new com.kingdee.eas.zjlw.attendance.AttenceResultInfo();
