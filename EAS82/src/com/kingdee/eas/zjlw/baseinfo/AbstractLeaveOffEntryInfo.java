...
public class AbstractLeaveOffEntryInfo extends com.kingdee.eas.framework.CoreBillEntryBaseInfo implements Serializable 
{
    public AbstractLeaveOffEntryInfo()
    {
        this("id");
    }
    protected AbstractLeaveOffEntryInfo(String pkField)
    {
        super(pkField);
    }
    /**
     ...
     */
    public com.kingdee.eas.zjlw.baseinfo.LeaveOffInfo getParent()
    {
        return (com.kingdee.eas.zjlw.baseinfo.LeaveOffInfo)get("parent");
    }
    public void setParent(com.kingdee.eas.zjlw.baseinfo.LeaveOffInfo item)
    {
        put("parent", item);
    }
    /**
