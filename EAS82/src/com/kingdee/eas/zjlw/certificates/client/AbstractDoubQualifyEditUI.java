 ...
 * output class name
 */
public abstract class AbstractDoubQualifyEditUI extends com.kingdee.eas.framework.client.CoreBillEditUI
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractDoubQualifyEditUI.class);
    ...
    protected com.kingdee.bos.ctrl.swing.KDLabelContainer contlastaudTime;
    protected com.kingdee.bos.ctrl.swing.KDLabelContainer contlsubmitor;
    ...
    protected com.kingdee.bos.ctrl.swing.KDDatePicker pklastaudTime;
    protected com.kingdee.bos.ctrl.extendcontrols.KDBizPromptBox prmtlsubmitor;
    protected com.kingdee.bos.ctrl.swing.KDTextField txtneedReson;
    protected com.kingdee.bos.ctrl.swing.KDWorkButton btnAudit;
    protected com.kingdee.bos.ctrl.swing.KDWorkButton btnUnAudit;
    protected com.kingdee.eas.zjlw.certificates.DoubQualifyInfo editData = null;
    protected ActionAudit actionAudit = null;
    protected ActionUnAudit actionUnAudit = null;
    /**
     * output class constructor
     */
    public AbstractDoubQualifyEditUI() throws Exception
    {
        super();
    ...
    {
        this.resHelper = new ResourceBundleHelper(AbstractDoubQualifyEditUI.class.getName());
        ...
        this.contlastaudTime = new com.kingdee.bos.ctrl.swing.KDLabelContainer();
        this.contlsubmitor = new com.kingdee.bos.ctrl.swing.KDLabelContainer();
        ...
        this.pklastaudTime = new com.kingdee.bos.ctrl.swing.KDDatePicker();
        this.prmtlsubmitor = new com.kingdee.bos.ctrl.extendcontrols.KDBizPromptBox();
        ...
        this.contlastaudTime.setName("contlastaudTime");
        this.contlsubmitor.setName("contlsubmitor");
        ...
        this.pklastaudTime.setName("pklastaudTime");
        this.prmtlsubmitor.setName("prmtlsubmitor");
        ...
        // contlastaudTime		
        this.contlastaudTime.setBoundLabelText(resHelper.getString("contlastaudTime.boundLabelText"));		
        this.contlastaudTime.setBoundLabelLength(100);		
        this.contlastaudTime.setBoundLabelUnderline(true);		
        this.contlastaudTime.setVisible(true);
        // contlsubmitor		
        this.contlsubmitor.setBoundLabelText(resHelper.getString("contlsubmitor.boundLabelText"));		
        this.contlsubmitor.setBoundLabelLength(100);		
        this.contlsubmitor.setBoundLabelUnderline(true);		
        this.contlsubmitor.setVisible(true);
        // chkifNeed		
        ...
        this.txtbNum.setVerifyInputWhenFocusTarget(false);		
        ...
        // pklastaudTime		
        this.pklastaudTime.setRequired(false);
        // prmtlsubmitor		
        this.prmtlsubmitor.setQueryInfo("com.kingdee.eas.base.permission.app.UserListQuery");		
        this.prmtlsubmitor.setEditable(true);		
        this.prmtlsubmitor.setDisplayFormat("$number$");		
        this.prmtlsubmitor.setEditFormat("$number$");		
        this.prmtlsubmitor.setCommitFormat("$number$");		
        this.prmtlsubmitor.setRequired(false);
        // txtneedReson		
        ...
        this.setFocusTraversalPolicy(new com.kingdee.bos.ui.UIFocusTraversalPolicy(new java.awt.Component[] {txtNumber,pkBizDate,billSate,txtDescription,chkifNeed,txtneedReson,txtbNum,pkauditDate,kDDateCreateTime,prmtCreator,prmtAuditor,pklastaudTime,kDDateLastUpdateTime,prmtLastUpdateUser,prmtlsubmitor,kdtEntrys}));
    ...
    public void initUIContentLayout()
    {
        ...
        contNumber.setBounds(new Rectangle(4, 6, 208, 19));
        this.add(contNumber, new KDLayout.Constraints(4, 6, 208, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        contBizDate.setBounds(new Rectangle(265, 6, 208, 19));
        this.add(contBizDate, new KDLayout.Constraints(265, 6, 208, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT_SCALE | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        contDescription.setBounds(new Rectangle(526, 30, 468, 19));
        this.add(contDescription, new KDLayout.Constraints(526, 30, 468, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT_SCALE | KDLayout.Constraints.ANCHOR_RIGHT));
        ...
        kdtEntrys_detailPanel = (com.kingdee.eas.framework.client.multiDetail.DetailPanel)com.kingdee.eas.framework.client.multiDetail.HMDUtils.buildDetail(this,dataBinder,kdtEntrys,new com.kingdee.eas.zjlw.certificates.DoubQualifyEntryInfo(),null,false);
...
vo.put("type","0");
        ...
        contbNum.setBounds(new Rectangle(785, 6, 208, 19));
        this.add(contbNum, new KDLayout.Constraints(785, 6, 208, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT_SCALE | KDLayout.Constraints.ANCHOR_RIGHT));
        contauditDate.setBounds(new Rectangle(771, 482, 227, 19));
        this.add(contauditDate, new KDLayout.Constraints(771, 482, 227, 19, KDLayout.Constraints.ANCHOR_BOTTOM | KDLayout.Constraints.ANCHOR_LEFT_SCALE | KDLayout.Constraints.ANCHOR_RIGHT));
        contbillSate.setBounds(new Rectangle(526, 6, 208, 19));
        this.add(contbillSate, new KDLayout.Constraints(526, 6, 208, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT_SCALE | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        contlastaudTime.setBounds(new Rectangle(265, 30, 208, 19));
        this.add(contlastaudTime, new KDLayout.Constraints(265, 30, 208, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT_SCALE | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        contlsubmitor.setBounds(new Rectangle(4, 30, 208, 19));
        this.add(contlsubmitor, new KDLayout.Constraints(4, 30, 208, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        ...
        contneedReson.setBounds(new Rectangle(265, 55, 726, 19));
        this.add(contneedReson, new KDLayout.Constraints(265, 55, 726, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT_SCALE | KDLayout.Constraints.ANCHOR_RIGHT));
        //contCreator
        ...
        //contlastaudTime
        contlastaudTime.setBoundEditor(pklastaudTime);
        //contlsubmitor
        contlsubmitor.setBoundEditor(prmtlsubmitor);
        //contneedReson
	...
	private void registerBindings(){
		...
		dataBinder.registerBinding("entrys", com.kingdee.eas.zjlw.certificates.DoubQualifyEntryInfo.class, this.kdtEntrys, "userObject");
		...
		dataBinder.registerBinding("lastaudTime", java.util.Date.class, this.pklastaudTime, "value");
		dataBinder.registerBinding("lsubmitor", com.kingdee.eas.base.permission.UserInfo.class, this.prmtlsubmitor, "data");
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.zjlw.certificates.app.DoubQualifyEditUIHandler";
	}
    ...
    public void setDataObject(IObjectValue dataObject)
    {
        ...
        this.editData = (com.kingdee.eas.zjlw.certificates.DoubQualifyInfo)ov;
    }
	...
	protected void registerValidator() {
		...
		getValidateHelper().registerBindProperty("lastaudTime", ValidateHelper.ON_SAVE);    
		getValidateHelper().registerBindProperty("lsubmitor", ValidateHelper.ON_SAVE);    
    ...
    public SelectorItemCollection getSelectors()
    {
		...
		if(selectorAll.equalsIgnoreCase("true"))
		{
			sic.add(new SelectorItemInfo("lsubmitor.*"));
		}
		else{
        	sic.add(new SelectorItemInfo("lsubmitor.id"));
        	sic.add(new SelectorItemInfo("lsubmitor.number"));
        	sic.add(new SelectorItemInfo("lsubmitor.name"));
		}
    ...
    protected class ActionAudit extends ItemAction {     
        ...
        public void actionPerformed(ActionEvent e)
        {
            ...
            innerActionPerformed("eas", AbstractDoubQualifyEditUI.this, "ActionAudit", "actionAudit_actionPerformed", e);
        }
    }
    ...
    protected class ActionUnAudit extends ItemAction {     
        ...
        {
        	getUIContext().put("ORG.PK", getOrgPK(this));
            innerActionPerformed("eas", AbstractDoubQualifyEditUI.this, "ActionUnAudit", "actionUnAudit_actionPerformed", e);
        }
    }
    ...
    {
        return new MetaDataPK("com.kingdee.eas.zjlw.certificates.client", "DoubQualifyEditUI");
    }
    /**
