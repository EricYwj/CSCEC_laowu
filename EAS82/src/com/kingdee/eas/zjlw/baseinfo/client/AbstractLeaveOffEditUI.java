 ...
 * output class name
 */
public abstract class AbstractLeaveOffEditUI extends com.kingdee.eas.framework.client.EditUI
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractLeaveOffEditUI.class);
    ...
    protected com.kingdee.eas.zjlw.baseinfo.LeaveOffInfo editData = null;
    /**
     * output class constructor
     */
    public AbstractLeaveOffEditUI() throws Exception
    {
        super();
    ...
    {
        this.resHelper = new ResourceBundleHelper(AbstractLeaveOffEditUI.class.getName());
    ...
    public void initUIContentLayout()
    {
        ...
        kDLabelContainer2.setBounds(new Rectangle(537, 15, 212, 19));
        this.add(kDLabelContainer2, new KDLayout.Constraints(537, 15, 212, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT_SCALE | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        ...
        kdtEntrys.setBounds(new Rectangle(12, 59, 1068, 464));
        kdtEntrys_detailPanel = (com.kingdee.eas.framework.client.multiDetail.DetailPanel)com.kingdee.eas.framework.client.multiDetail.HMDUtils.buildDetail(this,dataBinder,kdtEntrys,new com.kingdee.eas.zjlw.baseinfo.LeaveOffEntryInfo(),null,false);
        this.add(kdtEntrys_detailPanel, new KDLayout.Constraints(12, 59, 1068, 464, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_BOTTOM | KDLayout.Constraints.ANCHOR_LEFT | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
...
vo.put("maritalStatus","0");
        ...
        contorganizational.setBounds(new Rectangle(1055, 81, 193, 19));
        this.add(contorganizational, new KDLayout.Constraints(1055, 81, 193, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT_SCALE | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        //kDLabelContainer1
	...
	private void registerBindings(){
		...
		dataBinder.registerBinding("Entrys", com.kingdee.eas.zjlw.baseinfo.LeaveOffEntryInfo.class, this.kdtEntrys, "userObject");
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.zjlw.baseinfo.app.LeaveOffEditUIHandler";
	}
    ...
    public void setDataObject(IObjectValue dataObject)
    {
        ...
        this.editData = (com.kingdee.eas.zjlw.baseinfo.LeaveOffInfo)ov;
    }
    ...
    {
        return new MetaDataPK("com.kingdee.eas.zjlw.baseinfo.client", "LeaveOffEditUI");
    }
