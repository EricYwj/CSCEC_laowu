...
public class PersonManControllerBean extends AbstractPersonManControllerBean
{
    private static Logger logger =
        Logger.getLogger("com.kingdee.eas.zjlw.personmess.app.PersonManControllerBean");
}