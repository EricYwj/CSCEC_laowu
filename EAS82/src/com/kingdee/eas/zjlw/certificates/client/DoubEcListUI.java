 ...
 * output class name
 */
public class DoubEcListUI extends AbstractDoubEcListUI
{
    private static final Logger logger = CoreUIObject.getLogger(DoubEcListUI.class);
    
    /**
     * output class constructor
     */
    public DoubEcListUI() throws Exception
    {
        super();
    }
