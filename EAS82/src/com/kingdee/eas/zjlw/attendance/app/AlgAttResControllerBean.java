...
public class AlgAttResControllerBean extends AbstractAlgAttResControllerBean
{
    private static Logger logger = Logger.getLogger("com.kingdee.eas.zjlw.attendance.app.AlgAttResControllerBean");
    
    // 保存
	protected IObjectPK _save(Context ctx, IObjectValue model)throws BOSException, EASBizException {
		AlgAttResInfo accInfo = (AlgAttResInfo) model;
...
//    	}
    ...
    protected void _passAudit(Context ctx, IObjectPK pk, IObjectValue model)throws EASBizException, BOSException {
    	AlgAttResInfo info = (AlgAttResInfo) getValue(ctx, pk, getSelector());
