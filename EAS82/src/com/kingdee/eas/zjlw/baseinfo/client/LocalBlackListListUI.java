 ...
 * output class name
 */
public class LocalBlackListListUI extends AbstractLocalBlackListListUI
{
    private static final Logger logger = CoreUIObject.getLogger(LocalBlackListListUI.class);
    
    /**
     * output class constructor
     */
    public LocalBlackListListUI() throws Exception
    {
        super();
    }
    ...
    public void actionCancel_actionPerformed(ActionEvent e) throws Exception
    {
    	...
    	for (Iterator iter = pkList.iterator(); iter.hasNext();) {
			...
			LocalBlackListFactory.getRemoteInstance().cancelCancel(new ObjectUuidPK(id), null);
    	}
    	refreshList();
    }
    ...
    public void actionCancelCancel_actionPerformed(ActionEvent e) throws Exception
    {
        ...
        if (MsgBox.showConfirm2(this, "您确认要启用吗？") != 0)
			return;
    	List pkList = getSelectedIdValues(tblMain,getKeyFieldName());
    	for (Iterator iter = pkList.iterator(); iter.hasNext();) {
			String id = (String) iter.next();
			LocalBlackListFactory.getRemoteInstance().cancel(new ObjectUuidPK(id), null);
    	}
    	refreshList();
    }
