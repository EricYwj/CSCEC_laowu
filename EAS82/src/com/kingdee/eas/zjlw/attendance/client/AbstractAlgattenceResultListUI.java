 ...
 * output class name
 */
public abstract class AbstractAlgattenceResultListUI extends com.kingdee.eas.framework.client.ListUI
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractAlgattenceResultListUI.class);
    /**
     * output class constructor
     */
    public AbstractAlgattenceResultListUI() throws Exception
    {
        super();
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.zjlw.attendance.app.AlgattenceResultListUIHandler";
	}
    ...
    {
        return new MetaDataPK("com.kingdee.eas.zjlw.attendance.client", "AlgattenceResultListUI");
    }
