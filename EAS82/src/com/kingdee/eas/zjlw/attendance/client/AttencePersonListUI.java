 ...
 * output class name
 */
public class AttencePersonListUI extends AbstractAttencePersonListUI
{
    private static final Logger logger = CoreUIObject.getLogger(AttencePersonListUI.class);
    
    /**
     * output class constructor
     */
    public AttencePersonListUI() throws Exception
    {
        super();
    }
