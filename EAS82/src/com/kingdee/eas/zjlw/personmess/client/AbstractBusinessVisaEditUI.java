 ...
 * output class name
 */
public abstract class AbstractBusinessVisaEditUI extends com.kingdee.eas.framework.client.CoreBillEditUI
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractBusinessVisaEditUI.class);
    ...
    protected com.kingdee.eas.zjlw.personmess.BusinessVisaInfo editData = null;
    protected ActionAudit actionAudit = null;
    protected ActionUnAudit actionUnAudit = null;
    /**
     * output class constructor
     */
    public AbstractBusinessVisaEditUI() throws Exception
    {
        super();
    ...
    {
        this.resHelper = new ResourceBundleHelper(AbstractBusinessVisaEditUI.class.getName());
        ...
        this.kdtEntrys.addKDTEditListener(new com.kingdee.bos.ctrl.kdf.table.event.KDTEditAdapter() {
            public void editStopped(com.kingdee.bos.ctrl.kdf.table.event.KDTEditEvent e) {
                ...
                this.kdtEntrys.putBindContents("editData",new String[] {"id","name","lastName","firstName","sex","birthdate","national","idNum","birthPlaceCn","birthPlaceFr","passportNo","passportIssueDate","passportExpireDate","passportAgence","fatherName","motherName","coupleName","cooperation","handleProject","contacts","workProgram","contactway","arrivalTime","residenceTime"});
        ...
        final KDBizPromptBox kdtEntrys_handleProject_PromptBox = new KDBizPromptBox();
        kdtEntrys_handleProject_PromptBox.setQueryInfo("com.kingdee.eas.basedata.org.app.AdminItemQuery");
        kdtEntrys_handleProject_PromptBox.setVisible(true);
        kdtEntrys_handleProject_PromptBox.setEditable(true);
        kdtEntrys_handleProject_PromptBox.setDisplayFormat("$number$");
        kdtEntrys_handleProject_PromptBox.setEditFormat("$number$");
        kdtEntrys_handleProject_PromptBox.setCommitFormat("$number$");
        KDTDefaultCellEditor kdtEntrys_handleProject_CellEditor = new KDTDefaultCellEditor(kdtEntrys_handleProject_PromptBox);
        this.kdtEntrys.getColumn("handleProject").setEditor(kdtEntrys_handleProject_CellEditor);
        ObjectValueRender kdtEntrys_handleProject_OVR = new ObjectValueRender();
        kdtEntrys_handleProject_OVR.setFormat(new BizDataFormat("$name$"));
        this.kdtEntrys.getColumn("handleProject").setRenderer(kdtEntrys_handleProject_OVR);
        KDTextField kdtEntrys_contacts_TextField = new KDTextField();
        kdtEntrys_contacts_TextField.setName("kdtEntrys_contacts_TextField");
        kdtEntrys_contacts_TextField.setMaxLength(100);
        KDTDefaultCellEditor kdtEntrys_contacts_CellEditor = new KDTDefaultCellEditor(kdtEntrys_contacts_TextField);
        this.kdtEntrys.getColumn("contacts").setEditor(kdtEntrys_contacts_CellEditor);
        ...
        KDDatePicker kdtEntrys_arrivalTime_DatePicker = new KDDatePicker();
        kdtEntrys_arrivalTime_DatePicker.setName("kdtEntrys_arrivalTime_DatePicker");
        kdtEntrys_arrivalTime_DatePicker.setVisible(true);
        kdtEntrys_arrivalTime_DatePicker.setEditable(true);
        KDTDefaultCellEditor kdtEntrys_arrivalTime_CellEditor = new KDTDefaultCellEditor(kdtEntrys_arrivalTime_DatePicker);
        this.kdtEntrys.getColumn("arrivalTime").setEditor(kdtEntrys_arrivalTime_CellEditor);
        KDDatePicker kdtEntrys_residenceTime_DatePicker = new KDDatePicker();
        kdtEntrys_residenceTime_DatePicker.setName("kdtEntrys_residenceTime_DatePicker");
        kdtEntrys_residenceTime_DatePicker.setVisible(true);
        kdtEntrys_residenceTime_DatePicker.setEditable(true);
        KDTDefaultCellEditor kdtEntrys_residenceTime_CellEditor = new KDTDefaultCellEditor(kdtEntrys_residenceTime_DatePicker);
        this.kdtEntrys.getColumn("residenceTime").setEditor(kdtEntrys_residenceTime_CellEditor);
        // contbNum		
    ...
    {
        this.setBounds(new Rectangle(0, 0, 1013, 666));
        this.setLayout(new KDLayout());
        this.putClientProperty("OriginalBounds", new Rectangle(0, 0, 1013, 666));
        contCreator.setBounds(new Rectangle(9, 591, 211, 19));
        this.add(contCreator, new KDLayout.Constraints(9, 591, 211, 19, KDLayout.Constraints.ANCHOR_BOTTOM | KDLayout.Constraints.ANCHOR_LEFT | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        contCreateTime.setBounds(new Rectangle(240, 591, 211, 19));
        this.add(contCreateTime, new KDLayout.Constraints(240, 591, 211, 19, KDLayout.Constraints.ANCHOR_BOTTOM | KDLayout.Constraints.ANCHOR_LEFT_SCALE | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        contLastUpdateUser.setBounds(new Rectangle(9, 629, 211, 19));
        this.add(contLastUpdateUser, new KDLayout.Constraints(9, 629, 211, 19, KDLayout.Constraints.ANCHOR_BOTTOM | KDLayout.Constraints.ANCHOR_LEFT | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        contLastUpdateTime.setBounds(new Rectangle(241, 629, 211, 19));
        this.add(contLastUpdateTime, new KDLayout.Constraints(241, 629, 211, 19, KDLayout.Constraints.ANCHOR_BOTTOM | KDLayout.Constraints.ANCHOR_LEFT_SCALE | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        contNumber.setBounds(new Rectangle(15, 23, 204, 18));
        this.add(contNumber, new KDLayout.Constraints(15, 23, 204, 18, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        contBizDate.setBounds(new Rectangle(240, 23, 239, 19));
        this.add(contBizDate, new KDLayout.Constraints(240, 23, 239, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT_SCALE | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        contDescription.setBounds(new Rectangle(793, 23, 204, 19));
        this.add(contDescription, new KDLayout.Constraints(793, 23, 204, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT_SCALE | KDLayout.Constraints.ANCHOR_RIGHT));
        contAuditor.setBounds(new Rectangle(471, 592, 228, 19));
        this.add(contAuditor, new KDLayout.Constraints(471, 592, 228, 19, KDLayout.Constraints.ANCHOR_BOTTOM | KDLayout.Constraints.ANCHOR_LEFT_SCALE | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        kdtEntrys.setBounds(new Rectangle(6, 67, 998, 493));
        kdtEntrys_detailPanel = (com.kingdee.eas.framework.client.multiDetail.DetailPanel)com.kingdee.eas.framework.client.multiDetail.HMDUtils.buildDetail(this,dataBinder,kdtEntrys,new com.kingdee.eas.zjlw.personmess.BusinessVisaEntryInfo(),null,false);
        this.add(kdtEntrys_detailPanel, new KDLayout.Constraints(6, 67, 998, 493, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_BOTTOM | KDLayout.Constraints.ANCHOR_LEFT | KDLayout.Constraints.ANCHOR_RIGHT));
...
vo.put("passportAgence","10");
        ...
        contbNum.setBounds(new Rectangle(395, -6, 242, 19));
        this.add(contbNum, new KDLayout.Constraints(395, -6, 242, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        contauditDate.setBounds(new Rectangle(721, 591, 243, 19));
        this.add(contauditDate, new KDLayout.Constraints(721, 591, 243, 19, KDLayout.Constraints.ANCHOR_BOTTOM | KDLayout.Constraints.ANCHOR_LEFT_SCALE | KDLayout.Constraints.ANCHOR_RIGHT));
        contbillSate.setBounds(new Rectangle(500, 23, 270, 19));
        this.add(contbillSate, new KDLayout.Constraints(500, 23, 270, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT_SCALE | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        //contCreator
	...
	private void registerBindings(){
		...
		dataBinder.registerBinding("entrys", com.kingdee.eas.zjlw.personmess.BusinessVisaEntryInfo.class, this.kdtEntrys, "userObject");
		...
		dataBinder.registerBinding("entrys.contacts", String.class, this.kdtEntrys, "contacts.text");
		dataBinder.registerBinding("entrys.contactway", String.class, this.kdtEntrys, "contactway.text");
		dataBinder.registerBinding("entrys.arrivalTime", java.util.Date.class, this.kdtEntrys, "arrivalTime.text");
		dataBinder.registerBinding("entrys.residenceTime", java.util.Date.class, this.kdtEntrys, "residenceTime.text");
		dataBinder.registerBinding("entrys.cooperation", java.lang.Object.class, this.kdtEntrys, "cooperation.text");
		dataBinder.registerBinding("entrys.handleProject", java.lang.Object.class, this.kdtEntrys, "handleProject.text");
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.zjlw.personmess.app.BusinessVisaEditUIHandler";
	}
    ...
    public void setDataObject(IObjectValue dataObject)
    {
        ...
        this.editData = (com.kingdee.eas.zjlw.personmess.BusinessVisaInfo)ov;
    }
	...
	protected void registerValidator() {
		...
		getValidateHelper().registerBindProperty("entrys.contacts", ValidateHelper.ON_SAVE);    
		getValidateHelper().registerBindProperty("entrys.contactway", ValidateHelper.ON_SAVE);    
		getValidateHelper().registerBindProperty("entrys.arrivalTime", ValidateHelper.ON_SAVE);    
		getValidateHelper().registerBindProperty("entrys.residenceTime", ValidateHelper.ON_SAVE);    
		getValidateHelper().registerBindProperty("entrys.cooperation", ValidateHelper.ON_SAVE);    
		getValidateHelper().registerBindProperty("entrys.handleProject", ValidateHelper.ON_SAVE);    
    ...
    public SelectorItemCollection getSelectors()
    {
    	...
    	sic.add(new SelectorItemInfo("entrys.contacts"));
    	sic.add(new SelectorItemInfo("entrys.contactway"));
    	sic.add(new SelectorItemInfo("entrys.arrivalTime"));
    	sic.add(new SelectorItemInfo("entrys.residenceTime"));
		if(selectorAll.equalsIgnoreCase("true"))
		{
		...
		if(selectorAll.equalsIgnoreCase("true"))
		{
			sic.add(new SelectorItemInfo("entrys.handleProject.*"));
		}
		else{
	    	sic.add(new SelectorItemInfo("entrys.handleProject.id"));
			sic.add(new SelectorItemInfo("entrys.handleProject.name"));
        	sic.add(new SelectorItemInfo("entrys.handleProject.number"));
		}
    ...
    protected class ActionAudit extends ItemAction {     
        ...
        public void actionPerformed(ActionEvent e)
        {
            ...
            innerActionPerformed("eas", AbstractBusinessVisaEditUI.this, "ActionAudit", "actionAudit_actionPerformed", e);
        }
    }
    ...
    protected class ActionUnAudit extends ItemAction {     
        ...
        {
        	getUIContext().put("ORG.PK", getOrgPK(this));
            innerActionPerformed("eas", AbstractBusinessVisaEditUI.this, "ActionUnAudit", "actionUnAudit_actionPerformed", e);
        }
    }
    ...
    {
        return new MetaDataPK("com.kingdee.eas.zjlw.personmess.client", "BusinessVisaEditUI");
    }
    /**
    ...
    {
        return com.kingdee.eas.zjlw.personmess.client.BusinessVisaEditUI.class.getName();
    }
    ...
    protected IObjectValue createNewData()
    {
    	...
    	return "/bim/zjlw/personmess/BusinessVisa";
	}
    protected IMetaDataPK getTDQueryPK() {
    	return new MetaDataPK("com.kingdee.eas.zjlw.personmess.app.BusinessVisaQuery");
	}
