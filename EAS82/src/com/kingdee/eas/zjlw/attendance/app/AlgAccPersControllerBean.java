...
public class AlgAccPersControllerBean extends AbstractAlgAccPersControllerBean
{
    private static Logger logger =
        Logger.getLogger("com.kingdee.eas.zjlw.attendance.app.AlgAccPersControllerBean");
}