...
public class AbstractSocialSeBurEntryInfo extends com.kingdee.eas.framework.CoreBillEntryBaseInfo implements Serializable 
{
    public AbstractSocialSeBurEntryInfo()
    {
        this("id");
    }
    protected AbstractSocialSeBurEntryInfo(String pkField)
    {
        super(pkField);
    }
    /**
     ...
     */
    public com.kingdee.eas.zjlw.baseinfo.SocialSeBurInfo getParent()
    {
        return (com.kingdee.eas.zjlw.baseinfo.SocialSeBurInfo)get("parent");
    }
    public void setParent(com.kingdee.eas.zjlw.baseinfo.SocialSeBurInfo item)
    {
        put("parent", item);
    }
    /**
    ...
    {
        return new BOSObjectType("B4D38CE0");
    }
}