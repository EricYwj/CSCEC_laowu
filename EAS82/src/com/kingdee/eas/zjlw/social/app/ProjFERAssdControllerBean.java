...
public class ProjFERAssdControllerBean extends AbstractProjFERAssdControllerBean
{
    private static Logger logger =
        Logger.getLogger("com.kingdee.eas.zjlw.social.app.ProjFERAssdControllerBean");
  //提交 
    protected IObjectPK _submit(Context ctx, IObjectValue model)
    throws BOSException, EASBizException {
    	ProjFERAssdInfo accInfo = (ProjFERAssdInfo) model;
...
//    	}
    ...
    protected void _passAudit(Context ctx, IObjectPK pk, IObjectValue model)throws EASBizException, BOSException {
    	ProjFERAssdInfo info = (ProjFERAssdInfo) getValue(ctx, pk, getSelector());
