 ...
 * output class name
 */
public abstract class AbstractProjSecuProfListUI extends com.kingdee.eas.framework.client.ListUI
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractProjSecuProfListUI.class);
     ...
     */
    public AbstractProjSecuProfListUI() throws Exception
    {
        super();
    ...
    {
        this.resHelper = new ResourceBundleHelper(AbstractProjSecuProfListUI.class.getName());
        this.setUITitle(resHelper.getString("this.title"));
        mainQueryPK = new MetaDataPK("com.kingdee.eas.zjlw.baseinfo.app", "ProjSecuProfQuery");
        ...
        this.btnImport.setIcon(com.kingdee.eas.util.client.EASResource.getIcon("imgTree_import"));		
        this.btnImport.setDoubleBuffered(true);
...
kDContainer2.getContentPane().setLayout(new BorderLayout(0, 0));        kDContainer2.getContentPane().add(kDTreeView1, BorderLayout.CENTER);
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.zjlw.baseinfo.app.ProjSecuProfListUIHandler";
	}
    ...
    {
        return new MetaDataPK("com.kingdee.eas.zjlw.baseinfo.client", "ProjSecuProfListUI");
    }
