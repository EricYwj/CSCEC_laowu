 ...
 * output class name
 */
public class AttenceListUI extends AbstractAttenceListUI
{
    private static final Logger logger = CoreUIObject.getLogger(AttenceListUI.class);
    
    /**
     * output class constructor
     */
    public AttenceListUI() throws Exception
    {
        super();
    }
