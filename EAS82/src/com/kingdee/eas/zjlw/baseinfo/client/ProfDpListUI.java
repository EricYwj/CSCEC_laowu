 ...
 * output class name
 */
public class ProfDpListUI extends AbstractProfDpListUI
{
    private static final Logger logger = CoreUIObject.getLogger(ProfDpListUI.class);
    
    /**
     * output class constructor
     */
    public ProfDpListUI() throws Exception
    {
        super();
    }
    ...
    {
        return com.kingdee.eas.zjlw.baseinfo.client.ProfDpTreeEditUI.class.getName();
    }
