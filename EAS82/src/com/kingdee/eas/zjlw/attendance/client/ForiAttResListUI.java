 ...
 * output class name
 */
public class ForiAttResListUI extends AbstractForiAttResListUI
{
    private static final Logger logger = CoreUIObject.getLogger(ForiAttResListUI.class);
...
//     	}
     ...
     */
    public ForiAttResListUI() throws Exception
    {
        super();
    }
