...
public class AbstractPayrollInfo extends com.kingdee.eas.framework.CoreBillBaseInfo implements Serializable 
{
    public AbstractPayrollInfo()
    {
        this("id");
    }
    protected AbstractPayrollInfo(String pkField)
    {
        super(pkField);
        put("entrys", new com.kingdee.eas.zjlw.social.PayrollEntryCollection());
    }
    /**
     * Object: 阿工工资数据 's 分录 property 
     */
    public com.kingdee.eas.zjlw.social.PayrollEntryCollection getEntrys()
    {
        return (com.kingdee.eas.zjlw.social.PayrollEntryCollection)get("entrys");
    }
    /**
     * Object:阿工工资数据's 是否生成凭证property 
     */
    ...
    /**
     * Object:阿工工资数据's 是否已对照外会提供数据进行校验，数据不再修改property 
     */
