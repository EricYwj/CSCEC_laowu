 ...
 * output class name
 */
public class LocalPayPrintListUI extends AbstractLocalPayPrintListUI
{
    private static final Logger logger = CoreUIObject.getLogger(LocalPayPrintListUI.class);
    
    /**
     * output class constructor
     */
    public LocalPayPrintListUI() throws Exception
    {
        super();
    }
