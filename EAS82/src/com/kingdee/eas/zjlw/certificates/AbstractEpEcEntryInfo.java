...
public class AbstractEpEcEntryInfo extends com.kingdee.eas.framework.CoreBillEntryBaseInfo implements Serializable 
{
    public AbstractEpEcEntryInfo()
    {
        this("id");
    }
    protected AbstractEpEcEntryInfo(String pkField)
    {
        super(pkField);
    }
    /**
     ...
     */
    public com.kingdee.eas.zjlw.certificates.EpEcInfo getParent()
    {
        return (com.kingdee.eas.zjlw.certificates.EpEcInfo)get("parent");
    }
    public void setParent(com.kingdee.eas.zjlw.certificates.EpEcInfo item)
    {
        put("parent", item);
    }
    /**
