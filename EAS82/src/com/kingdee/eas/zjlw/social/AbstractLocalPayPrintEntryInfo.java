...
public class AbstractLocalPayPrintEntryInfo extends com.kingdee.eas.framework.CoreBillEntryBaseInfo implements Serializable 
{
    public AbstractLocalPayPrintEntryInfo()
    {
        this("id");
    }
    protected AbstractLocalPayPrintEntryInfo(String pkField)
    {
        super(pkField);
    }
    /**
     ...
     */
    public com.kingdee.eas.zjlw.social.LocalPayPrintInfo getParent()
    {
        return (com.kingdee.eas.zjlw.social.LocalPayPrintInfo)get("parent");
    }
    public void setParent(com.kingdee.eas.zjlw.social.LocalPayPrintInfo item)
    {
        put("parent", item);
    }
    /**
     ...
     */
    public String getCfbirthplace()
    {
        return getString("cfbirthplace");
    }
    public void setCfbirthplace(String item)
    {
        setString("cfbirthplace", item);
    }
    /**
    ...
    {
        return getString("fadd");
    }
    public void setFadd(String item)
    {
        setString("fadd", item);
    }
