 ...
 * output class name
 */
public abstract class AbstractAntiOutEcEditUI extends com.kingdee.eas.framework.client.CoreBillEditUI
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractAntiOutEcEditUI.class);
    ...
    protected com.kingdee.eas.zjlw.certificates.AntiOutEcInfo editData = null;
    /**
     * output class constructor
     */
    public AbstractAntiOutEcEditUI() throws Exception
    {
        super();
    ...
    {
        this.resHelper = new ResourceBundleHelper(AbstractAntiOutEcEditUI.class.getName());
    ...
    public void initUIContentLayout()
    {
        ...
        kdtEntrys_detailPanel = (com.kingdee.eas.framework.client.multiDetail.DetailPanel)com.kingdee.eas.framework.client.multiDetail.HMDUtils.buildDetail(this,dataBinder,kdtEntrys,new com.kingdee.eas.zjlw.certificates.AntiOutEcEntryInfo(),null,false);
...
vo.put("personState","10");
	...
	private void registerBindings(){
		...
		dataBinder.registerBinding("entrys", com.kingdee.eas.zjlw.certificates.AntiOutEcEntryInfo.class, this.kdtEntrys, "userObject");
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.zjlw.certificates.app.AntiOutEcEditUIHandler";
	}
    ...
    public void setDataObject(IObjectValue dataObject)
    {
        ...
        this.editData = (com.kingdee.eas.zjlw.certificates.AntiOutEcInfo)ov;
    }
    ...
    {
        return new MetaDataPK("com.kingdee.eas.zjlw.certificates.client", "AntiOutEcEditUI");
    }
    /**
