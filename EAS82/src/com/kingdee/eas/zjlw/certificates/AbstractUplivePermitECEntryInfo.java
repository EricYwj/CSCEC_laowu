...
public class AbstractUplivePermitECEntryInfo extends com.kingdee.eas.framework.CoreBillEntryBaseInfo implements Serializable 
{
    public AbstractUplivePermitECEntryInfo()
    {
        this("id");
    }
    protected AbstractUplivePermitECEntryInfo(String pkField)
    {
        super(pkField);
    }
    /**
     ...
     */
    public com.kingdee.eas.zjlw.certificates.UplivePermitECInfo getParent()
    {
        return (com.kingdee.eas.zjlw.certificates.UplivePermitECInfo)get("parent");
    }
    public void setParent(com.kingdee.eas.zjlw.certificates.UplivePermitECInfo item)
    {
        put("parent", item);
    }
    /**
