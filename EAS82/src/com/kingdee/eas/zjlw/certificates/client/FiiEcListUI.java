 ...
 * output class name
 */
public class FiiEcListUI extends AbstractFiiEcListUI
{
    private static final Logger logger = CoreUIObject.getLogger(FiiEcListUI.class);
    
    /**
     * output class constructor
     */
    public FiiEcListUI() throws Exception
    {
        super();
    }
