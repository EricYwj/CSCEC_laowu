 ...
 * output class name
 */
public class AlgattenceResultEditUI extends AbstractAlgattenceResultEditUI
{
    private static final Logger logger = CoreUIObject.getLogger(AlgattenceResultEditUI.class);
    
    /**
     * output class constructor
     */
    public AlgattenceResultEditUI() throws Exception
    {
        super();
    }
    /**
