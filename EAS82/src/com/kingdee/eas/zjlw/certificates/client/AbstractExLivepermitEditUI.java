 ...
 * output class name
 */
public abstract class AbstractExLivepermitEditUI extends com.kingdee.eas.framework.client.CoreBillEditUI
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractExLivepermitEditUI.class);
    ...
    protected com.kingdee.eas.zjlw.certificates.ExLivepermitInfo editData = null;
    protected ActionAudit actionAudit = null;
    protected ActionUnAudit actionUnAudit = null;
    /**
     * output class constructor
     */
    public AbstractExLivepermitEditUI() throws Exception
    {
        super();
    ...
    {
        this.resHelper = new ResourceBundleHelper(AbstractExLivepermitEditUI.class.getName());
        ...
        // kdtEntrys
		String kdtEntrysStrXML = "<?xml version=\"1.0\" encoding=\"UTF-8\"?><DocRoot xmlns:c=\"http://www.kingdee.com/Common\" xmlns:f=\"http://www.kingdee.com/Form\" xmlns:t=\"http://www.kingdee.com/Table\" xmlns:xsi=\"http://www.w3.org/2001/XMLSchema-instance\" xsi:schemaLocation=\"http://www.kingdee.com/KDF KDFSchema.xsd\" version=\"0.0\"><Styles><c:Style id=\"sCol0\"><c:Protection hidden=\"true\" /></c:Style><c:Style id=\"sCol1\"><c:Protection locked=\"true\" /></c:Style><c:Style id=\"sCol2\"><c:Protection locked=\"true\" /></c:Style><c:Style id=\"sCol3\"><c:Protection locked=\"true\" /></c:Style><c:Style id=\"sCol4\"><c:Protection locked=\"true\" /></c:Style><c:Style id=\"sCol5\"><c:Protection locked=\"true\" /><c:NumberFormat>&amp;date</c:NumberFormat></c:Style><c:Style id=\"sCol6\"><c:Protection locked=\"true\" /></c:Style><c:Style id=\"sCol7\"><c:Protection locked=\"true\" /></c:Style><c:Style id=\"sCol8\"><c:Protection locked=\"true\" /></c:Style><c:Style id=\"sCol9\"><c:Protection locked=\"true\" /></c:Style><c:Style id=\"sCol10\"><c:Protection locked=\"true\" /></c:Style><c:Style id=\"sCol11\"><c:Protection locked=\"true\" /></c:Style><c:Style id=\"sCol12\"><c:Protection locked=\"true\" /></c:Style><c:Style id=\"sCol13\"><c:Protection locked=\"true\" /><c:NumberFormat>&amp;date</c:NumberFormat></c:Style><c:Style id=\"sCol14\"><c:Protection locked=\"true\" /><c:NumberFormat>&amp;date</c:NumberFormat></c:Style><c:Style id=\"sCol15\"><c:Protection locked=\"true\" /></c:Style><c:Style id=\"sCol16\"><c:Protection locked=\"true\" /></c:Style><c:Style id=\"sCol17\"><c:Protection locked=\"true\" /><c:NumberFormat>&amp;date</c:NumberFormat></c:Style><c:Style id=\"sCol18\"><c:Protection locked=\"true\" /></c:Style><c:Style id=\"sCol19\"><c:Protection locked=\"true\" /><c:NumberFormat>&amp;date</c:NumberFormat></c:Style><c:Style id=\"sCol20\"><c:NumberFormat>&amp;date</c:NumberFormat></c:Style><c:Style id=\"sCol21\"><c:NumberFormat>&amp;date</c:NumberFormat></c:Style><c:Style id=\"sCol22\"><c:Protection locked=\"true\" /></c:Style><c:Style id=\"sCol23\"><c:Protection locked=\"true\" /></c:Style><c:Style id=\"sCol25\"><c:Protection locked=\"true\" /></c:Style><c:Style id=\"sCol26\"><c:Protection locked=\"true\" /></c:Style><c:Style id=\"sCol27\"><c:Protection locked=\"true\" /></c:Style><c:Style id=\"sCol29\"><c:Protection hidden=\"true\" /></c:Style><c:Style id=\"sCol30\"><c:Protection hidden=\"true\" /></c:Style><c:Style id=\"sCol31\"><c:Protection hidden=\"true\" /><c:NumberFormat>&amp;date</c:NumberFormat></c:Style><c:Style id=\"sCol32\"><c:Protection hidden=\"true\" /><c:NumberFormat>&amp;date</c:NumberFormat></c:Style><c:Style id=\"sCol33\"><c:Protection hidden=\"true\" /><c:NumberFormat>&amp;date</c:NumberFormat></c:Style><c:Style id=\"sCol34\"><c:Protection hidden=\"true\" /><c:NumberFormat>&amp;date</c:NumberFormat></c:Style><c:Style id=\"sCol35\"><c:Protection hidden=\"true\" /></c:Style><c:Style id=\"sCol36\"><c:Protection hidden=\"true\" /></c:Style><c:Style id=\"sCol37\"><c:Protection hidden=\"true\" /></c:Style><c:Style id=\"sCol38\"><c:Protection hidden=\"true\" /></c:Style><c:Style id=\"sCol39\"><c:Protection hidden=\"true\" /></c:Style><c:Style id=\"sCol40\"><c:Protection hidden=\"true\" /><c:NumberFormat>&amp;date</c:NumberFormat></c:Style><c:Style id=\"sCol41\"><c:Protection hidden=\"true\" /><c:NumberFormat>&amp;date</c:NumberFormat></c:Style></Styles><Table id=\"KDTable\"><t:Sheet name=\"sheet1\"><t:Table t:selectMode=\"15\" t:mergeMode=\"0\" t:dataRequestMode=\"0\" t:pageRowCount=\"100\"><t:ColumnGroup><t:Column t:key=\"id\" t:width=\"-1\" t:mergeable=\"true\" t:resizeable=\"true\" t:moveable=\"true\" t:group=\"false\" t:required=\"false\" t:index=\"-1\" t:styleID=\"sCol0\" /><t:Column t:key=\"name\" t:width=\"-1\" t:mergeable=\"true\" t:resizeable=\"true\" t:moveable=\"true\" t:group=\"false\" t:required=\"false\" t:index=\"-1\" t:styleID=\"sCol1\" /><t:Column t:key=\"lastName\" t:width=\"-1\" t:mergeable=\"true\" t:resizeable=\"true\" t:moveable=\"true\" t:group=\"false\" t:required=\"false\" t:index=\"-1\" t:styleID=\"sCol2\" /><t:Column t:key=\"firstName\" t:width=\"-1\" t:mergeable=\"true\" t:resizeable=\"true\" t:moveable=\"true\" t:group=\"false\" t:required=\"false\" t:index=\"-1\" t:styleID=\"sCol3\" /><t:Column t:key=\"sex\" t:width=\"-1\" t:mergeable=\"true\" t:resizeable=\"true\" t:moveable=\"true\" t:group=\"false\" t:required=\"false\" t:index=\"-1\" t:styleID=\"sCol4\" /><t:Column t:key=\"birth\" t:width=\"-1\" t:mergeable=\"true\" t:resizeable=\"true\" t:moveable=\"true\" t:group=\"false\" t:required=\"false\" t:index=\"-1\" t:styleID=\"sCol5\" /><t:Column t:key=\"birthPlace\" t:width=\"-1\" t:mergeable=\"true\" t:resizeable=\"true\" t:moveable=\"true\" t:group=\"false\" t:required=\"false\" t:index=\"-1\" t:styleID=\"sCol6\" /><t:Column t:key=\"birthPlaceFr\" t:width=\"-1\" t:mergeable=\"true\" t:resizeable=\"true\" t:moveable=\"true\" t:group=\"false\" t:required=\"false\" t:index=\"-1\" t:styleID=\"sCol7\" /><t:Column t:key=\"nation\" t:width=\"-1\" t:mergeable=\"true\" t:resizeable=\"true\" t:moveable=\"true\" t:group=\"false\" t:required=\"false\" t:index=\"-1\" t:styleID=\"sCol8\" /><t:Column t:key=\"passpNum\" t:width=\"-1\" t:mergeable=\"true\" t:resizeable=\"true\" t:moveable=\"true\" t:group=\"false\" t:required=\"false\" t:index=\"-1\" t:styleID=\"sCol9\" /><t:Column t:key=\"HquProf\" t:width=\"-1\" t:mergeable=\"true\" t:resizeable=\"true\" t:moveable=\"true\" t:group=\"false\" t:required=\"false\" t:index=\"-1\" t:styleID=\"sCol10\" /><t:Column t:key=\"HprmtProf\" t:width=\"-1\" t:mergeable=\"true\" t:resizeable=\"true\" t:moveable=\"true\" t:group=\"false\" t:required=\"false\" t:index=\"-1\" t:styleID=\"sCol11\" /><t:Column t:key=\"wPmtNum\" t:width=\"-1\" t:mergeable=\"true\" t:resizeable=\"true\" t:moveable=\"true\" t:group=\"false\" t:required=\"false\" t:index=\"-1\" t:styleID=\"sCol12\" /><t:Column t:key=\"laboreffDate\" t:width=\"-1\" t:mergeable=\"true\" t:resizeable=\"true\" t:moveable=\"true\" t:group=\"false\" t:required=\"false\" t:index=\"-1\" t:styleID=\"sCol13\" /><t:Column t:key=\"wPmtSTime\" t:width=\"-1\" t:mergeable=\"true\" t:resizeable=\"true\" t:moveable=\"true\" t:group=\"false\" t:required=\"false\" t:index=\"-1\" t:styleID=\"sCol14\" /><t:Column t:key=\"docType\" t:width=\"-1\" t:mergeable=\"true\" t:resizeable=\"true\" t:moveable=\"true\" t:group=\"false\" t:required=\"false\" t:index=\"-1\" t:styleID=\"sCol15\" /><t:Column t:key=\"rePmtNum\" t:width=\"-1\" t:mergeable=\"true\" t:resizeable=\"true\" t:moveable=\"true\" t:group=\"false\" t:required=\"false\" t:index=\"-1\" t:styleID=\"sCol16\" /><t:Column t:key=\"rePmtETime\" t:width=\"-1\" t:mergeable=\"true\" t:resizeable=\"true\" t:moveable=\"true\" t:group=\"false\" t:required=\"false\" t:index=\"-1\" t:styleID=\"sCol17\" /><t:Column t:key=\"pmtNum\" t:width=\"-1\" t:mergeable=\"true\" t:resizeable=\"true\" t:moveable=\"true\" t:group=\"false\" t:required=\"false\" t:index=\"-1\" t:styleID=\"sCol18\" /><t:Column t:key=\"pmtETime\" t:width=\"-1\" t:mergeable=\"true\" t:resizeable=\"true\" t:moveable=\"true\" t:group=\"false\" t:required=\"false\" t:index=\"-1\" t:styleID=\"sCol19\" /><t:Column t:key=\"rePmtTrnDate\" t:width=\"-1\" t:mergeable=\"true\" t:resizeable=\"true\" t:moveable=\"true\" t:group=\"false\" t:required=\"false\" t:index=\"-1\" t:styleID=\"sCol20\" /><t:Column t:key=\"pmtTrnDate\" t:width=\"-1\" t:mergeable=\"true\" t:resizeable=\"true\" t:moveable=\"true\" t:group=\"false\" t:required=\"false\" t:index=\"-1\" t:styleID=\"sCol21\" /><t:Column t:key=\"HpmtProj\" t:width=\"-1\" t:mergeable=\"true\" t:resizeable=\"true\" t:moveable=\"true\" t:group=\"false\" t:required=\"false\" t:index=\"-1\" t:styleID=\"sCol22\" /><t:Column t:key=\"pmtProj\" t:width=\"-1\" t:mergeable=\"true\" t:resizeable=\"true\" t:moveable=\"true\" t:group=\"false\" t:required=\"false\" t:index=\"-1\" t:styleID=\"sCol23\" /><t:Column t:key=\"HworkOrg\" t:width=\"-1\" t:mergeable=\"true\" t:resizeable=\"true\" t:moveable=\"true\" t:group=\"false\" t:required=\"false\" t:index=\"-1\" /><t:Column t:key=\"cooperation\" t:width=\"-1\" t:mergeable=\"true\" t:resizeable=\"true\" t:moveable=\"true\" t:group=\"false\" t:required=\"false\" t:index=\"-1\" t:styleID=\"sCol25\" /><t:Column t:key=\"isEmbassyReg\" t:width=\"-1\" t:mergeable=\"true\" t:resizeable=\"true\" t:moveable=\"true\" t:group=\"false\" t:required=\"false\" t:index=\"-1\" t:styleID=\"sCol26\" /><t:Column t:key=\"IdNum\" t:width=\"150\" t:mergeable=\"true\" t:resizeable=\"true\" t:moveable=\"true\" t:group=\"false\" t:required=\"false\" t:index=\"-1\" t:styleID=\"sCol27\" /><t:Column t:key=\"remark\" t:width=\"-1\" t:mergeable=\"true\" t:resizeable=\"true\" t:moveable=\"true\" t:group=\"false\" t:required=\"false\" t:index=\"-1\" /><t:Column t:key=\"quProf\" t:width=\"-1\" t:mergeable=\"true\" t:resizeable=\"true\" t:moveable=\"true\" t:group=\"false\" t:required=\"false\" t:index=\"-1\" t:styleID=\"sCol29\" /><t:Column t:key=\"prmtProf\" t:width=\"-1\" t:mergeable=\"true\" t:resizeable=\"true\" t:moveable=\"true\" t:group=\"false\" t:required=\"false\" t:index=\"-1\" t:styleID=\"sCol30\" /><t:Column t:key=\"wPmtGTime\" t:width=\"-1\" t:mergeable=\"true\" t:resizeable=\"true\" t:moveable=\"true\" t:group=\"false\" t:required=\"false\" t:index=\"-1\" t:styleID=\"sCol31\" /><t:Column t:key=\"papSTime\" t:width=\"-1\" t:mergeable=\"true\" t:resizeable=\"true\" t:moveable=\"true\" t:group=\"false\" t:required=\"false\" t:index=\"-1\" t:styleID=\"sCol32\" /><t:Column t:key=\"sRePmtSTime\" t:width=\"-1\" t:mergeable=\"true\" t:resizeable=\"true\" t:moveable=\"true\" t:group=\"false\" t:required=\"false\" t:index=\"-1\" t:styleID=\"sCol33\" /><t:Column t:key=\"pmtSTime\" t:width=\"-1\" t:mergeable=\"true\" t:resizeable=\"true\" t:moveable=\"true\" t:group=\"false\" t:required=\"false\" t:index=\"-1\" t:styleID=\"sCol34\" /><t:Column t:key=\"dlyChkFrc\" t:width=\"-1\" t:mergeable=\"true\" t:resizeable=\"true\" t:moveable=\"true\" t:group=\"false\" t:required=\"false\" t:index=\"-1\" t:styleID=\"sCol35\" /><t:Column t:key=\"actProf\" t:width=\"-1\" t:mergeable=\"true\" t:resizeable=\"true\" t:moveable=\"true\" t:group=\"false\" t:required=\"false\" t:index=\"-1\" t:styleID=\"sCol36\" /><t:Column t:key=\"workOrg\" t:width=\"-1\" t:mergeable=\"true\" t:resizeable=\"true\" t:moveable=\"true\" t:group=\"false\" t:required=\"false\" t:index=\"-1\" t:styleID=\"sCol37\" /><t:Column t:key=\"personID\" t:width=\"-1\" t:mergeable=\"true\" t:resizeable=\"true\" t:moveable=\"true\" t:group=\"false\" t:required=\"false\" t:index=\"-1\" t:styleID=\"sCol38\" /><t:Column t:key=\"sourceEntryID\" t:width=\"-1\" t:mergeable=\"true\" t:resizeable=\"true\" t:moveable=\"true\" t:group=\"false\" t:required=\"false\" t:index=\"-1\" t:styleID=\"sCol39\" /><t:Column t:key=\"passpExDate\" t:width=\"-1\" t:mergeable=\"true\" t:resizeable=\"true\" t:moveable=\"true\" t:group=\"false\" t:required=\"false\" t:index=\"-1\" t:styleID=\"sCol40\" /><t:Column t:key=\"immiTime\" t:width=\"-1\" t:mergeable=\"true\" t:resizeable=\"true\" t:moveable=\"true\" t:group=\"false\" t:required=\"false\" t:index=\"-1\" t:styleID=\"sCol41\" /></t:ColumnGroup><t:Head><t:Row t:name=\"header\" t:height=\"-1\" t:mergeable=\"true\" t:resizeable=\"true\"><t:Cell>$Resource{id}</t:Cell><t:Cell>$Resource{name}</t:Cell><t:Cell>$Resource{lastName}</t:Cell><t:Cell>$Resource{firstName}</t:Cell><t:Cell>$Resource{sex}</t:Cell><t:Cell>$Resource{birth}</t:Cell><t:Cell>$Resource{birthPlace}</t:Cell><t:Cell>$Resource{birthPlaceFr}</t:Cell><t:Cell>$Resource{nation}</t:Cell><t:Cell>$Resource{passpNum}</t:Cell><t:Cell>$Resource{HquProf}</t:Cell><t:Cell>$Resource{HprmtProf}</t:Cell><t:Cell>$Resource{wPmtNum}</t:Cell><t:Cell>$Resource{laboreffDate}</t:Cell><t:Cell>$Resource{wPmtSTime}</t:Cell><t:Cell>$Resource{docType}</t:Cell><t:Cell>$Resource{rePmtNum}</t:Cell><t:Cell>$Resource{rePmtETime}</t:Cell><t:Cell>$Resource{pmtNum}</t:Cell><t:Cell>$Resource{pmtETime}</t:Cell><t:Cell>$Resource{rePmtTrnDate}</t:Cell><t:Cell>$Resource{pmtTrnDate}</t:Cell><t:Cell>$Resource{HpmtProj}</t:Cell><t:Cell>$Resource{pmtProj}</t:Cell><t:Cell>$Resource{HworkOrg}</t:Cell><t:Cell>$Resource{cooperation}</t:Cell><t:Cell>$Resource{isEmbassyReg}</t:Cell><t:Cell>$Resource{IdNum}</t:Cell><t:Cell>$Resource{remark}</t:Cell><t:Cell>$Resource{quProf}</t:Cell><t:Cell>$Resource{prmtProf}</t:Cell><t:Cell>$Resource{wPmtGTime}</t:Cell><t:Cell>$Resource{papSTime}</t:Cell><t:Cell>$Resource{sRePmtSTime}</t:Cell><t:Cell>$Resource{pmtSTime}</t:Cell><t:Cell>$Resource{dlyChkFrc}</t:Cell><t:Cell>$Resource{actProf}</t:Cell><t:Cell>$Resource{workOrg}</t:Cell><t:Cell>$Resource{personID}</t:Cell><t:Cell>$Resource{sourceEntryID}</t:Cell><t:Cell>$Resource{passpExDate}</t:Cell><t:Cell>$Resource{immiTime}</t:Cell></t:Row></t:Head></t:Table><t:SheetOptions><t:MergeBlocks><t:Head /></t:MergeBlocks></t:SheetOptions></t:Sheet></Table></DocRoot>";
        ...
        this.kdtEntrys.addKDTEditListener(new com.kingdee.bos.ctrl.kdf.table.event.KDTEditAdapter() {
            public void editStopped(com.kingdee.bos.ctrl.kdf.table.event.KDTEditEvent e) {
                ...
                this.kdtEntrys.putBindContents("editData",new String[] {"id","name","lastName","firstName","sex","birth","birthPlace","birthPlaceFr","nation","passpNum","HquProf","HprmtProf","wPmtNum","laboreffDate","wPmtSTime","docType","rePmtNum","rePmtETime","pmtNum","pmtETime","rePmtTrnDate","pmtTrnDate","HpmtProj","pmtProj","HworkOrg","cooperation","isEmbassyReg","IdNum","remark","quProf","prmtProf","wPmtGTime","papSTime","sRePmtSTime","pmtSTime","dlyChkFrc","actProf","workOrg","personID","sourceEntryID","passpExDate","immiTime"});
        ...
        KDTextField kdtEntrys_HprmtProf_TextField = new KDTextField();
        kdtEntrys_HprmtProf_TextField.setName("kdtEntrys_HprmtProf_TextField");
        kdtEntrys_HprmtProf_TextField.setMaxLength(100);
        KDTDefaultCellEditor kdtEntrys_HprmtProf_CellEditor = new KDTDefaultCellEditor(kdtEntrys_HprmtProf_TextField);
        this.kdtEntrys.getColumn("HprmtProf").setEditor(kdtEntrys_HprmtProf_CellEditor);
        ...
        KDDatePicker kdtEntrys_rePmtTrnDate_DatePicker = new KDDatePicker();
        kdtEntrys_rePmtTrnDate_DatePicker.setName("kdtEntrys_rePmtTrnDate_DatePicker");
        kdtEntrys_rePmtTrnDate_DatePicker.setVisible(true);
        kdtEntrys_rePmtTrnDate_DatePicker.setEditable(true);
        KDTDefaultCellEditor kdtEntrys_rePmtTrnDate_CellEditor = new KDTDefaultCellEditor(kdtEntrys_rePmtTrnDate_DatePicker);
        this.kdtEntrys.getColumn("rePmtTrnDate").setEditor(kdtEntrys_rePmtTrnDate_CellEditor);
        KDDatePicker kdtEntrys_pmtTrnDate_DatePicker = new KDDatePicker();
        kdtEntrys_pmtTrnDate_DatePicker.setName("kdtEntrys_pmtTrnDate_DatePicker");
        kdtEntrys_pmtTrnDate_DatePicker.setVisible(true);
        kdtEntrys_pmtTrnDate_DatePicker.setEditable(true);
        KDTDefaultCellEditor kdtEntrys_pmtTrnDate_CellEditor = new KDTDefaultCellEditor(kdtEntrys_pmtTrnDate_DatePicker);
        this.kdtEntrys.getColumn("pmtTrnDate").setEditor(kdtEntrys_pmtTrnDate_CellEditor);
        ...
        final KDBizPromptBox kdtEntrys_HworkOrg_PromptBox = new KDBizPromptBox();
        kdtEntrys_HworkOrg_PromptBox.setQueryInfo("com.kingdee.eas.basedata.org.app.AdminItemQuery");
        kdtEntrys_HworkOrg_PromptBox.setVisible(true);
        kdtEntrys_HworkOrg_PromptBox.setEditable(true);
        kdtEntrys_HworkOrg_PromptBox.setDisplayFormat("$number$");
        kdtEntrys_HworkOrg_PromptBox.setEditFormat("$number$");
        kdtEntrys_HworkOrg_PromptBox.setCommitFormat("$number$");
        KDTDefaultCellEditor kdtEntrys_HworkOrg_CellEditor = new KDTDefaultCellEditor(kdtEntrys_HworkOrg_PromptBox);
        this.kdtEntrys.getColumn("HworkOrg").setEditor(kdtEntrys_HworkOrg_CellEditor);
        ObjectValueRender kdtEntrys_HworkOrg_OVR = new ObjectValueRender();
        kdtEntrys_HworkOrg_OVR.setFormat(new BizDataFormat("$name$"));
        this.kdtEntrys.getColumn("HworkOrg").setRenderer(kdtEntrys_HworkOrg_OVR);
    ...
    public void initUIContentLayout()
    {
        ...
        contCreator.setBounds(new Rectangle(9, 501, 241, 21));
        this.add(contCreator, new KDLayout.Constraints(9, 501, 241, 21, KDLayout.Constraints.ANCHOR_BOTTOM | KDLayout.Constraints.ANCHOR_LEFT | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        contCreateTime.setBounds(new Rectangle(284, 503, 222, 19));
        this.add(contCreateTime, new KDLayout.Constraints(284, 503, 222, 19, KDLayout.Constraints.ANCHOR_BOTTOM | KDLayout.Constraints.ANCHOR_LEFT_SCALE | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        contLastUpdateUser.setBounds(new Rectangle(9, 531, 241, 19));
        this.add(contLastUpdateUser, new KDLayout.Constraints(9, 531, 241, 19, KDLayout.Constraints.ANCHOR_BOTTOM | KDLayout.Constraints.ANCHOR_LEFT | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        contLastUpdateTime.setBounds(new Rectangle(284, 531, 222, 19));
        this.add(contLastUpdateTime, new KDLayout.Constraints(284, 531, 222, 19, KDLayout.Constraints.ANCHOR_BOTTOM | KDLayout.Constraints.ANCHOR_LEFT_SCALE | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        contNumber.setBounds(new Rectangle(10, 7, 213, 21));
        this.add(contNumber, new KDLayout.Constraints(10, 7, 213, 21, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        contBizDate.setBounds(new Rectangle(234, 7, 175, 21));
        this.add(contBizDate, new KDLayout.Constraints(234, 7, 175, 21, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT_SCALE | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        contDescription.setBounds(new Rectangle(698, 7, 295, 21));
        this.add(contDescription, new KDLayout.Constraints(698, 7, 295, 21, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT_SCALE | KDLayout.Constraints.ANCHOR_RIGHT));
        contAuditor.setBounds(new Rectangle(540, 503, 206, 19));
        this.add(contAuditor, new KDLayout.Constraints(540, 503, 206, 19, KDLayout.Constraints.ANCHOR_BOTTOM | KDLayout.Constraints.ANCHOR_LEFT_SCALE | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        kdtEntrys.setBounds(new Rectangle(10, 58, 991, 413));
        kdtEntrys_detailPanel = (com.kingdee.eas.framework.client.multiDetail.DetailPanel)com.kingdee.eas.framework.client.multiDetail.HMDUtils.buildDetail(this,dataBinder,kdtEntrys,new com.kingdee.eas.zjlw.certificates.ExLivepermitEntryInfo(),null,false);
...
vo.put("docType","0");
        ...
        contbNum.setBounds(new Rectangle(237, 149, 228, 19));
        this.add(contbNum, new KDLayout.Constraints(237, 149, 228, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT_SCALE | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        contauditDate.setBounds(new Rectangle(780, 503, 208, 19));
        this.add(contauditDate, new KDLayout.Constraints(780, 503, 208, 19, KDLayout.Constraints.ANCHOR_BOTTOM | KDLayout.Constraints.ANCHOR_LEFT_SCALE | KDLayout.Constraints.ANCHOR_RIGHT));
        contbillSate.setBounds(new Rectangle(420, 7, 267, 21));
        this.add(contbillSate, new KDLayout.Constraints(420, 7, 267, 21, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT_SCALE | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        kDLabelContainer1.setBounds(new Rectangle(10, 35, 476, 19));
        this.add(kDLabelContainer1, new KDLayout.Constraints(10, 35, 476, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        //contCreator
	...
	private void registerBindings(){
		...
		dataBinder.registerBinding("entrys", com.kingdee.eas.zjlw.certificates.ExLivepermitEntryInfo.class, this.kdtEntrys, "userObject");
		...
		dataBinder.registerBinding("entrys.HworkOrg", java.lang.Object.class, this.kdtEntrys, "HworkOrg.text");
		dataBinder.registerBinding("entrys.pmtSTime", java.util.Date.class, this.kdtEntrys, "pmtSTime.text");
		dataBinder.registerBinding("entrys.HprmtProf", String.class, this.kdtEntrys, "HprmtProf.text");
		...
		dataBinder.registerBinding("entrys.rePmtTrnDate", java.util.Date.class, this.kdtEntrys, "rePmtTrnDate.text");
		dataBinder.registerBinding("entrys.pmtTrnDate", java.util.Date.class, this.kdtEntrys, "pmtTrnDate.text");
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.zjlw.certificates.app.ExLivepermitEditUIHandler";
	}
    ...
    public void setDataObject(IObjectValue dataObject)
    {
        ...
        this.editData = (com.kingdee.eas.zjlw.certificates.ExLivepermitInfo)ov;
    }
	...
	protected void registerValidator() {
		...
		getValidateHelper().registerBindProperty("entrys.HworkOrg", ValidateHelper.ON_SAVE);    
		getValidateHelper().registerBindProperty("entrys.pmtSTime", ValidateHelper.ON_SAVE);    
		getValidateHelper().registerBindProperty("entrys.HprmtProf", ValidateHelper.ON_SAVE);    
		...
		getValidateHelper().registerBindProperty("entrys.rePmtTrnDate", ValidateHelper.ON_SAVE);    
		getValidateHelper().registerBindProperty("entrys.pmtTrnDate", ValidateHelper.ON_SAVE);    
    ...
    public SelectorItemCollection getSelectors()
    {
		...
		if(selectorAll.equalsIgnoreCase("true"))
		{
			sic.add(new SelectorItemInfo("entrys.HworkOrg.*"));
		}
		else{
	    	sic.add(new SelectorItemInfo("entrys.HworkOrg.id"));
			sic.add(new SelectorItemInfo("entrys.HworkOrg.name"));
        	sic.add(new SelectorItemInfo("entrys.HworkOrg.number"));
		}
    	sic.add(new SelectorItemInfo("entrys.pmtSTime"));
    	sic.add(new SelectorItemInfo("entrys.HprmtProf"));
    	...
    	sic.add(new SelectorItemInfo("entrys.rePmtTrnDate"));
    	sic.add(new SelectorItemInfo("entrys.pmtTrnDate"));
		if(selectorAll.equalsIgnoreCase("true"))
		{
    ...
    protected class ActionAudit extends ItemAction {     
        ...
        public void actionPerformed(ActionEvent e)
        {
            ...
            innerActionPerformed("eas", AbstractExLivepermitEditUI.this, "ActionAudit", "actionAudit_actionPerformed", e);
        }
    }
    ...
    protected class ActionUnAudit extends ItemAction {     
        ...
        {
        	getUIContext().put("ORG.PK", getOrgPK(this));
            innerActionPerformed("eas", AbstractExLivepermitEditUI.this, "ActionUnAudit", "actionUnAudit_actionPerformed", e);
        }
    }
    ...
    {
        return new MetaDataPK("com.kingdee.eas.zjlw.certificates.client", "ExLivepermitEditUI");
    }
    /**
    ...
    {
        return com.kingdee.eas.zjlw.certificates.client.ExLivepermitEditUI.class.getName();
    }
    ...
    {
        return com.kingdee.eas.zjlw.certificates.ExLivepermitFactory.getRemoteInstance();
    }
    ...
    {
        com.kingdee.eas.zjlw.certificates.ExLivepermitInfo objectValue = new com.kingdee.eas.zjlw.certificates.ExLivepermitInfo();
    	...
    	return "/bim/zjlw/certificates/ExLivepermit";
	}
    protected IMetaDataPK getTDQueryPK() {
    	return new MetaDataPK("com.kingdee.eas.zjlw.certificates.app.ExLivepermitQuery");
	}
