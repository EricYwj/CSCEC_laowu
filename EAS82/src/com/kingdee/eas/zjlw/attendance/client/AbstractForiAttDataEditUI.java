 ...
 * output class name
 */
public abstract class AbstractForiAttDataEditUI extends com.kingdee.eas.framework.client.CoreBillEditUI
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractForiAttDataEditUI.class);
    ...
    protected com.kingdee.eas.zjlw.attendance.ForiAttDataInfo editData = null;
    /**
     * output class constructor
     */
    public AbstractForiAttDataEditUI() throws Exception
    {
        super();
    ...
    {
        this.resHelper = new ResourceBundleHelper(AbstractForiAttDataEditUI.class.getName());
        ...
        this.setFocusTraversalPolicy(new com.kingdee.bos.ui.UIFocusTraversalPolicy(new java.awt.Component[] {txtCheckSysDepNo,prmtproCom,kDDateLastUpdateTime,prmtLastUpdateUser,kDDateCreateTime,prmtCreator,prmtAuditor,txtDescription,pkBizDate,txtNumber,kdtEntrys}));
    ...
    public void initUIContentLayout()
    {
        ...
        contDescription.setBounds(new Rectangle(253, 38, 464, 19));
        this.add(contDescription, null);
        contAuditor.setBounds(new Rectangle(17, 547, 270, 19));
        this.add(contAuditor, null);
        kdtEntrys.setBounds(new Rectangle(11, 68, 703, 413));
        kdtEntrys_detailPanel = (com.kingdee.eas.framework.client.multiDetail.DetailPanel)com.kingdee.eas.framework.client.multiDetail.HMDUtils.buildDetail(this,dataBinder,kdtEntrys,new com.kingdee.eas.zjlw.attendance.ForiAttDataEntryInfo(),null,false);
        this.add(kdtEntrys_detailPanel, null);
        contCheckSysDepNo.setBounds(new Rectangle(493, 9, 222, 19));
	...
	private void registerBindings(){
		...
		dataBinder.registerBinding("entrys", com.kingdee.eas.zjlw.attendance.ForiAttDataEntryInfo.class, this.kdtEntrys, "userObject");
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.zjlw.attendance.app.ForiAttDataEditUIHandler";
	}
    ...
    public void setDataObject(IObjectValue dataObject)
    {
        ...
        this.editData = (com.kingdee.eas.zjlw.attendance.ForiAttDataInfo)ov;
    }
    ...
    {
        return new MetaDataPK("com.kingdee.eas.zjlw.attendance.client", "ForiAttDataEditUI");
    }
    /**
