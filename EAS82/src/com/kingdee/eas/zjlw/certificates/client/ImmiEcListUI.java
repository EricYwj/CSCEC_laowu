 ...
 * output class name
 */
public class ImmiEcListUI extends AbstractImmiEcListUI
{
    private static final Logger logger = CoreUIObject.getLogger(ImmiEcListUI.class);
    
    /**
     * output class constructor
     */
    public ImmiEcListUI() throws Exception
    {
        super();
    }
