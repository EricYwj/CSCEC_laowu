 ...
 * output class name
 */
public class CheckInOutTableEditUI extends AbstractCheckInOutTableEditUI
{
    private static final Logger logger = CoreUIObject.getLogger(CheckInOutTableEditUI.class);
    
    /**
     * output class constructor
     */
    public CheckInOutTableEditUI() throws Exception
    {
        super();
    }
    /**
