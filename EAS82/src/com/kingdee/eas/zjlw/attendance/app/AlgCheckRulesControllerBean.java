...
public class AlgCheckRulesControllerBean extends AbstractAlgCheckRulesControllerBean
{
    private static Logger logger = Logger.getLogger("com.kingdee.eas.zjlw.attendance.app.AlgCheckRulesControllerBean");
    // 保存
	protected IObjectPK _save(Context ctx, IObjectValue model)throws BOSException, EASBizException {
		AlgCheckRulesInfo accInfo = (AlgCheckRulesInfo) model;
		accInfo.setBillSatee(BillStateEnum.DRAFT);
		//设置编码
...
//    	}
    ...
    throws BOSException, EASBizException {
    	AlgCheckRulesInfo accInfo = (AlgCheckRulesInfo) model;
    	accInfo.setBillSatee(BillStateEnum.SUBMIT);
    	//设置编码
//    	if(accInfo.getNumber()==null ||"".equals(accInfo.getNumber())){
//    		CompanyOrgUnitInfo currentCompany = ContextHelperFactory.getLocalInstance(ctx).getCurrentCompany();
//    		String orgId = currentCompany.getId().toString();
...
//    	}
    ...
    protected void _passAudit(Context ctx, IObjectPK pk, IObjectValue model)throws EASBizException, BOSException {
    	AlgCheckRulesInfo info = (AlgCheckRulesInfo) getValue(ctx, pk, getSelector());
		IObjectPK logPK = LogUtil.beginLog(ctx, "_audit", info.getBOSType(),pk, info.getNumber());
		SelectorItemCollection sic = new SelectorItemCollection();
		sic.add("billSatee");
		sic.add("auditor");
		sic.add("AuditDate");
		info.setBillSatee(BillStateEnum.CHECKED);
	...
	protected void _unpassAudit(Context ctx, IObjectPK pk, IObjectValue model)throws EASBizException, BOSException {
		...
		sic.add("auditor");
		sic.add("AuditDate");
		info.setBillSatee(BillStateEnum.SUBMIT);
