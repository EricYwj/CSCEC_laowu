 ...
 * output class name
 */
public class ProjSecuProfEditUI extends AbstractProjSecuProfEditUI {
	private static final Logger logger = CoreUIObject
			.getLogger(ProjSecuProfEditUI.class);

	/**
	 * output class constructor
	 */
	public ProjSecuProfEditUI() throws Exception {
		super();
	}
...
//		setUITitle("项目社保工种库");
	...
	private void checkPrice() {
		SecuProfInfo secuProf = (SecuProfInfo) this.prmtprofType.getValue();
		if (secuProf != null) {
			this.txtnBasePay.setValue(secuProf.getBasePay());
	...
	protected com.kingdee.eas.framework.ICoreBase getBizInterface()
			throws Exception {
		return com.kingdee.eas.zjlw.baseinfo.ProjSecuProfFactory
				.getRemoteInstance();
	}
	...
	protected com.kingdee.bos.dao.IObjectValue createNewData() {
		...
		FullOrgUnitInfo fullInfo = (FullOrgUnitInfo) getUIContext().get(
				"projectOrgInfo");
		...
		try {
			AdminOrgUnitInfo adminInfo = AdminOrgUnitFactory
					.getRemoteInstance().getAdminOrgUnitInfo(
							new ObjectUuidPK(fullInfo.getId()), sic);
