 ...
 * output class name
 */
public class VisaEcListUI extends AbstractVisaEcListUI
{
    private static final Logger logger = CoreUIObject.getLogger(VisaEcListUI.class);
    
    /**
     * output class constructor
     */
    public VisaEcListUI() throws Exception
    {
        super();
    }
