 ...
 * output class name
 */
public class SecuProfListUI extends AbstractSecuProfListUI
{
    private static final Logger logger = CoreUIObject.getLogger(SecuProfListUI.class);
    
    /**
     * output class constructor
     */
    public SecuProfListUI() throws Exception
    {
        super();
    }
    ...
    public void onLoad() throws Exception {
		...
		if ("L2".equals(strLanguage) || "l2".equals(strLanguage)) {
			...
			setUITitle("Liste des fonctions SS(standard)");
		}
