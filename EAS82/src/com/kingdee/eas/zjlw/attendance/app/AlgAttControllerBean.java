...
public class AlgAttControllerBean extends AbstractAlgAttControllerBean
{
    private static Logger logger = Logger.getLogger("com.kingdee.eas.zjlw.attendance.app.AlgAttControllerBean");
    
 // 保存
	protected IObjectPK _save(Context ctx, IObjectValue model)throws BOSException, EASBizException {
		AlgAttInfo accInfo = (AlgAttInfo) model;
...
//    	}
    ...
    protected void _passAudit(Context ctx, IObjectPK pk, IObjectValue model)throws EASBizException, BOSException {
    	AlgAttInfo info = (AlgAttInfo) getValue(ctx, pk, getSelector());
