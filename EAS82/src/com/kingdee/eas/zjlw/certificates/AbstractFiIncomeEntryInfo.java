...
public class AbstractFiIncomeEntryInfo extends com.kingdee.eas.framework.CoreBillEntryBaseInfo implements Serializable 
{
    public AbstractFiIncomeEntryInfo()
    {
        this("id");
    }
    protected AbstractFiIncomeEntryInfo(String pkField)
    {
        super(pkField);
    }
    /**
     ...
     */
    public com.kingdee.eas.zjlw.certificates.FiIncomeInfo getParent()
    {
        return (com.kingdee.eas.zjlw.certificates.FiIncomeInfo)get("parent");
    }
    public void setParent(com.kingdee.eas.zjlw.certificates.FiIncomeInfo item)
    {
        put("parent", item);
    }
    /**
     ...
     */
    public java.math.BigDecimal getWkExperice()
    {
        return getBigDecimal("wkExperice");
    }
    public void setWkExperice(java.math.BigDecimal item)
    {
        setBigDecimal("wkExperice", item);
    }
    /**
