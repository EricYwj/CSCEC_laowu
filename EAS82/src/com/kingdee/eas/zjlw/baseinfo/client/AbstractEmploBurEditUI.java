 ...
 * output class name
 */
public abstract class AbstractEmploBurEditUI extends com.kingdee.eas.framework.client.EditUI
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractEmploBurEditUI.class);
    ...
    protected com.kingdee.eas.zjlw.baseinfo.EmploBurInfo editData = null;
    /**
     * output class constructor
     */
    public AbstractEmploBurEditUI() throws Exception
    {
        super();
    ...
    {
        this.resHelper = new ResourceBundleHelper(AbstractEmploBurEditUI.class.getName());
    ...
    public void initUIContentLayout()
    {
        ...
        kDLabelContainer2.setBounds(new Rectangle(547, 14, 194, 19));
        this.add(kDLabelContainer2, new KDLayout.Constraints(547, 14, 194, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT_SCALE | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        ...
        kdtEntrys_detailPanel = (com.kingdee.eas.framework.client.multiDetail.DetailPanel)com.kingdee.eas.framework.client.multiDetail.HMDUtils.buildDetail(this,dataBinder,kdtEntrys,new com.kingdee.eas.zjlw.baseinfo.EmploBurEntryInfo(),null,false);
...
vo.put("maritalStatus","0");
        ...
        contorganizational.setBounds(new Rectangle(1063, 84, 193, 19));
        this.add(contorganizational, new KDLayout.Constraints(1063, 84, 193, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT_SCALE | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        //kDLabelContainer1
	...
	private void registerBindings(){
		...
		dataBinder.registerBinding("Entrys", com.kingdee.eas.zjlw.baseinfo.EmploBurEntryInfo.class, this.kdtEntrys, "userObject");
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.zjlw.baseinfo.app.EmploBurEditUIHandler";
	}
    ...
    public void setDataObject(IObjectValue dataObject)
    {
        ...
        this.editData = (com.kingdee.eas.zjlw.baseinfo.EmploBurInfo)ov;
    }
    ...
    {
        return new MetaDataPK("com.kingdee.eas.zjlw.baseinfo.client", "EmploBurEditUI");
    }
