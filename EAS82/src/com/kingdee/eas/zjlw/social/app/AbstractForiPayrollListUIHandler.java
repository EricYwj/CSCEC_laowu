 ...
 * output class name
 */
public abstract class AbstractForiPayrollListUIHandler extends com.kingdee.eas.framework.app.CoreBillListUIHandler

{
	...
	public void handleActionUpdateErrData(RequestContext request,ResponseContext response, Context context) throws Exception {
		_handleActionUpdateErrData(request,response,context);
	}
	protected void _handleActionUpdateErrData(RequestContext request,ResponseContext response, Context context) throws Exception {
	}
}