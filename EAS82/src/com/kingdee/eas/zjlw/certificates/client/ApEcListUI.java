 ...
 * output class name
 */
public class ApEcListUI extends AbstractApEcListUI
{
    private static final Logger logger = CoreUIObject.getLogger(ApEcListUI.class);
    
    /**
     * output class constructor
     */
    public ApEcListUI() throws Exception
    {
        super();
    }
