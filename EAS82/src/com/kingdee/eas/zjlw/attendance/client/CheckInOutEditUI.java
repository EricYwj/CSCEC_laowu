 ...
 * output class name
 */
public class CheckInOutEditUI extends AbstractCheckInOutEditUI
{
    private static final Logger logger = CoreUIObject.getLogger(CheckInOutEditUI.class);
    
    /**
     * output class constructor
     */
    public CheckInOutEditUI() throws Exception
    {
        super();
    }
    /**
