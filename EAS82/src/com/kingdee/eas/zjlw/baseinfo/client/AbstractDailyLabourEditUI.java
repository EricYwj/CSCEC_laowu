 ...
 * output class name
 */
public abstract class AbstractDailyLabourEditUI extends com.kingdee.eas.framework.client.EditUI
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractDailyLabourEditUI.class);
    ...
    protected com.kingdee.bos.ctrl.swing.KDLabelContainer contsexn;
    ...
    protected com.kingdee.bos.ctrl.swing.KDComboBox sexn;
    ...
    protected com.kingdee.eas.zjlw.baseinfo.DailyLabourInfo editData = null;
    /**
     * output class constructor
     */
    public AbstractDailyLabourEditUI() throws Exception
    {
        super();
    ...
    {
        this.resHelper = new ResourceBundleHelper(AbstractDailyLabourEditUI.class.getName());
        ...
        this.contsexn = new com.kingdee.bos.ctrl.swing.KDLabelContainer();
        ...
        this.sexn = new com.kingdee.bos.ctrl.swing.KDComboBox();
        ...
        this.contsexn.setName("contsexn");
        ...
        // contsexn		
        this.contsexn.setBoundLabelText(resHelper.getString("contsexn.boundLabelText"));		
        this.contsexn.setBoundLabelLength(100);		
        this.contsexn.setBoundLabelUnderline(true);		
        this.contsexn.setVisible(true);
        // contworkProj		
        ...
        // sexn		
        this.sexn.addItems(EnumUtils.getEnumList("com.kingdee.eas.basedata.person.Genders").toArray());		
        this.sexn.setRequired(false);
        // prmtworkProj		
        ...
        this.respContent.setEnabled(false);
        this.setFocusTraversalPolicy(new com.kingdee.bos.ui.UIFocusTraversalPolicy(new java.awt.Component[] {txtfullName,sexn,prmtworkProj,belongArea,prmtproProvince,respContent,txtphotoNum,txtqqNum,txtmailbox,txtwechatNum,txtremark,txtNumber,txtName,txtDescription,txtSimpleName}));
    ...
    {
        this.setBounds(new Rectangle(0, 0, 700, 240));
        this.setLayout(null);
        kDLabelContainer1.setBounds(new Rectangle(671, 244, 270, 19));
        this.add(kDLabelContainer1, null);
        kDLabelContainer2.setBounds(new Rectangle(671, 281, 270, 19));
        this.add(kDLabelContainer2, null);
        kDLabelContainer3.setBounds(new Rectangle(671, 318, 270, 19));
        this.add(kDLabelContainer3, null);
        kDLabelContainer4.setBounds(new Rectangle(671, 355, 270, 19));
        this.add(kDLabelContainer4, null);
        contfullName.setBounds(new Rectangle(44, 17, 270, 19));
        this.add(contfullName, null);
        contproProvince.setBounds(new Rectangle(44, 83, 270, 19));
        this.add(contproProvince, null);
        contphotoNum.setBounds(new Rectangle(44, 116, 270, 19));
        this.add(contphotoNum, null);
        contmailbox.setBounds(new Rectangle(44, 149, 270, 19));
        this.add(contmailbox, null);
        contqqNum.setBounds(new Rectangle(377, 116, 270, 19));
        this.add(contqqNum, null);
        contwechatNum.setBounds(new Rectangle(377, 149, 270, 19));
        this.add(contwechatNum, null);
        contremark.setBounds(new Rectangle(41, 189, 611, 32));
        this.add(contremark, null);
        contsexn.setBounds(new Rectangle(377, 17, 270, 19));
        this.add(contsexn, null);
        contworkProj.setBounds(new Rectangle(44, 50, 270, 19));
        this.add(contworkProj, null);
        contbelongArea.setBounds(new Rectangle(377, 50, 270, 19));
        this.add(contbelongArea, null);
        contrespContent.setBounds(new Rectangle(377, 83, 270, 19));
	...
	private void registerBindings(){
		...
		dataBinder.registerBinding("sexn", com.kingdee.eas.basedata.person.Genders.class, this.sexn, "selectedItem");
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.zjlw.baseinfo.app.DailyLabourEditUIHandler";
	}
    ...
    public void setDataObject(IObjectValue dataObject)
    {
        ...
        this.editData = (com.kingdee.eas.zjlw.baseinfo.DailyLabourInfo)ov;
    }
	...
	protected void registerValidator() {
		...
		getValidateHelper().registerBindProperty("sexn", ValidateHelper.ON_SAVE);    
    ...
    {
        return new MetaDataPK("com.kingdee.eas.zjlw.baseinfo.client", "DailyLabourEditUI");
    }
