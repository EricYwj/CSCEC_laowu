 ...
 * output class name
 */
public class ForiAttRuleEditUI extends AbstractForiAttRuleEditUI
{
    private static final Logger logger = CoreUIObject.getLogger(ForiAttRuleEditUI.class);
     ...
     * 打卡间隔值改变事件
     */
    protected void txttimeInterval_dataChanged(DataChangeEvent e) throws Exception {
    	super.txttimeInterval_dataChanged(e);
    	int count = this.kdtEntrys.getRowCount();
		for (int i = 0; i < count; i++) {
			IRow row = this.kdtEntrys.getRow(i);
			row.getCell("timeInterval").setValue(this.txttimeInterval.getText());
		}
    }
	...
	protected void setButtonStatus() {
		ForiAttRuleInfo bill;
		if ("VIEW".equals(getOprtState())) {
			bill = (ForiAttRuleInfo) this.editData;
     ...
     */
    public ForiAttRuleEditUI() throws Exception
    {
        super();
    }
    /**
