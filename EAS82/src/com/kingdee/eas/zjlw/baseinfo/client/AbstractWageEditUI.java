 ...
 * output class name
 */
public abstract class AbstractWageEditUI extends com.kingdee.eas.framework.client.EditUI
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractWageEditUI.class);
    ...
    protected com.kingdee.eas.zjlw.baseinfo.WageInfo editData = null;
    /**
     * output class constructor
     */
    public AbstractWageEditUI() throws Exception
    {
        super();
    ...
    {
        this.resHelper = new ResourceBundleHelper(AbstractWageEditUI.class.getName());
        ...
        this.contmoney.setBoundLabelLength(60);		
        ...
        this.setFocusTraversalPolicy(new com.kingdee.bos.ui.UIFocusTraversalPolicy(new java.awt.Component[] {txtName,txtNumber,txtDescription,txtSimpleName,txtmoney,prmtcooperation,txtunit}));
    ...
    public void initUIContentLayout()
    {
        ...
        this.putClientProperty("OriginalBounds", new Rectangle(0, 0, 400, 250));
        kDLabelContainer1.setBounds(new Rectangle(445, 94, 270, 19));
        this.add(kDLabelContainer1, new KDLayout.Constraints(445, 94, 270, 19, 0));
        kDLabelContainer2.setBounds(new Rectangle(57, 17, 270, 19));
        this.add(kDLabelContainer2, new KDLayout.Constraints(57, 17, 270, 19, 0));
        kDLabelContainer3.setBounds(new Rectangle(57, 56, 270, 19));
        this.add(kDLabelContainer3, new KDLayout.Constraints(57, 56, 270, 19, 0));
        kDLabelContainer4.setBounds(new Rectangle(56, 176, 270, 19));
        this.add(kDLabelContainer4, new KDLayout.Constraints(56, 176, 270, 19, 0));
        contmoney.setBounds(new Rectangle(56, 134, 270, 19));
        this.add(contmoney, new KDLayout.Constraints(56, 134, 270, 19, 0));
        contcooperation.setBounds(new Rectangle(53, 220, 270, 19));
        this.add(contcooperation, new KDLayout.Constraints(53, 220, 270, 19, 0));
        contunit.setBounds(new Rectangle(58, 98, 270, 19));
        this.add(contunit, new KDLayout.Constraints(58, 98, 270, 19, 0));
        //kDLabelContainer1
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.zjlw.baseinfo.app.WageEditUIHandler";
	}
    ...
    public void setDataObject(IObjectValue dataObject)
    {
        ...
        this.editData = (com.kingdee.eas.zjlw.baseinfo.WageInfo)ov;
    }
    ...
    {
        return new MetaDataPK("com.kingdee.eas.zjlw.baseinfo.client", "WageEditUI");
    }
    ...
    {
        return com.kingdee.eas.zjlw.baseinfo.client.WageEditUI.class.getName();
    }
    ...
    {
        return com.kingdee.eas.zjlw.baseinfo.WageFactory.getRemoteInstance();
    }
    ...
    {
        com.kingdee.eas.zjlw.baseinfo.WageInfo objectValue = new com.kingdee.eas.zjlw.baseinfo.WageInfo();
