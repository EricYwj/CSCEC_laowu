 ...
 * output class name
 */
public class ASCancelEditUI extends AbstractASCancelEditUI
{
    private static final Logger logger = CoreUIObject.getLogger(ASCancelEditUI.class);
     ...
     */
    public ASCancelEditUI() throws Exception
    {
        super();
    }
    /**
    ...
    public void actionSave_actionPerformed(ActionEvent e) throws Exception
    {
		...
		if(this.editData!=null && this.editData.getId()!=null){
			...
			sic.add("id");
			sic.add("billSate");
			ASCancelInfo fiInfo = ASCancelFactory.getRemoteInstance().getASCancelInfo(new ObjectUuidPK(this.editData.getId()),sic);
