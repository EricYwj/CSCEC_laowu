 ...
 * output class name
 */
public class AttencePersonEditUI extends AbstractAttencePersonEditUI
{
    private static final Logger logger = CoreUIObject.getLogger(AttencePersonEditUI.class);
    
    /**
     * output class constructor
     */
    public AttencePersonEditUI() throws Exception
    {
        super();
    }
    /**
