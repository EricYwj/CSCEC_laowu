 ...
 * output class name
 */
public class PassportListUI extends AbstractPassportListUI
{
    private static final Logger logger = CoreUIObject.getLogger(PassportListUI.class);
     ...
     */
    public PassportListUI() throws Exception
    {
        super();
    }
