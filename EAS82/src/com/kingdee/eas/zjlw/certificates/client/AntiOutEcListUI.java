 ...
 * output class name
 */
public class AntiOutEcListUI extends AbstractAntiOutEcListUI
{
    private static final Logger logger = CoreUIObject.getLogger(AntiOutEcListUI.class);
    
    /**
     * output class constructor
     */
    public AntiOutEcListUI() throws Exception
    {
        super();
    }
