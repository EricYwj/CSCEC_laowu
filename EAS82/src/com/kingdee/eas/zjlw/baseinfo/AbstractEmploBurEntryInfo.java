...
public class AbstractEmploBurEntryInfo extends com.kingdee.eas.framework.CoreBillEntryBaseInfo implements Serializable 
{
    public AbstractEmploBurEntryInfo()
    {
        this("id");
    }
    protected AbstractEmploBurEntryInfo(String pkField)
    {
        super(pkField);
    }
    /**
     ...
     */
    public com.kingdee.eas.zjlw.baseinfo.EmploBurInfo getParent()
    {
        return (com.kingdee.eas.zjlw.baseinfo.EmploBurInfo)get("parent");
    }
    public void setParent(com.kingdee.eas.zjlw.baseinfo.EmploBurInfo item)
    {
        put("parent", item);
    }
    /**
