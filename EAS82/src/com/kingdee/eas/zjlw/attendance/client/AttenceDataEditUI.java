 ...
 * output class name
 */
public class AttenceDataEditUI extends AbstractAttenceDataEditUI
{
    private static final Logger logger = CoreUIObject.getLogger(AttenceDataEditUI.class);
    
    /**
     * output class constructor
     */
    public AttenceDataEditUI() throws Exception
    {
        super();
    }
    /**
