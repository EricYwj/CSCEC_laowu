...
public class AbstractDistrGovernmentEntryInfo extends com.kingdee.eas.framework.CoreBillEntryBaseInfo implements Serializable 
{
    public AbstractDistrGovernmentEntryInfo()
    {
        this("id");
    }
    protected AbstractDistrGovernmentEntryInfo(String pkField)
    {
        super(pkField);
    }
    /**
     ...
     */
    public com.kingdee.eas.zjlw.baseinfo.DistrGovernmentInfo getParent()
    {
        return (com.kingdee.eas.zjlw.baseinfo.DistrGovernmentInfo)get("parent");
    }
    public void setParent(com.kingdee.eas.zjlw.baseinfo.DistrGovernmentInfo item)
    {
        put("parent", item);
    }
    /**
