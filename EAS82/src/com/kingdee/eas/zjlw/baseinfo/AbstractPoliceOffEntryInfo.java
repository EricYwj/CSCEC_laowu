...
public class AbstractPoliceOffEntryInfo extends com.kingdee.eas.framework.CoreBillEntryBaseInfo implements Serializable 
{
    public AbstractPoliceOffEntryInfo()
    {
        this("id");
    }
    protected AbstractPoliceOffEntryInfo(String pkField)
    {
        super(pkField);
    }
    /**
     ...
     */
    public com.kingdee.eas.zjlw.baseinfo.PoliceOffInfo getParent()
    {
        return (com.kingdee.eas.zjlw.baseinfo.PoliceOffInfo)get("parent");
    }
    public void setParent(com.kingdee.eas.zjlw.baseinfo.PoliceOffInfo item)
    {
        put("parent", item);
    }
    /**
