 ...
 * output class name
 */
public class AlgPersListUI extends AbstractAlgPersListUI
{
    private static final Logger logger = CoreUIObject.getLogger(AlgPersListUI.class);
     ...
     */
    public AlgPersListUI() throws Exception
    {
        super();
    }
