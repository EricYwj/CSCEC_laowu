 ...
 * output class name
 */
public abstract class AbstractSocialAddEditUI extends com.kingdee.eas.framework.client.EditUI
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractSocialAddEditUI.class);
    ...
    protected com.kingdee.eas.zjlw.baseinfo.SocialAddInfo editData = null;
    /**
     * output class constructor
     */
    public AbstractSocialAddEditUI() throws Exception
    {
        super();
    ...
    {
        this.resHelper = new ResourceBundleHelper(AbstractSocialAddEditUI.class.getName());
        ...
        this.setFocusTraversalPolicy(new com.kingdee.bos.ui.UIFocusTraversalPolicy(new java.awt.Component[] {txtfullName,sex,prmtworkPro,belongArea,prmtproProvince,respContent,txtphotoNum,txtqqNum,txtmailbox,txtwechatNum,txtremark,txtSimpleName,txtDescription,txtNumber,txtName}));
    ...
    public void initUIContentLayout()
    {
        ...
        this.setLayout(null);
        kDLabelContainer1.setBounds(new Rectangle(686, 337, 270, 19));
        this.add(kDLabelContainer1, null);
        kDLabelContainer2.setBounds(new Rectangle(686, 374, 270, 19));
        this.add(kDLabelContainer2, null);
        kDLabelContainer3.setBounds(new Rectangle(686, 411, 270, 19));
        this.add(kDLabelContainer3, null);
        kDLabelContainer4.setBounds(new Rectangle(686, 448, 270, 19));
        this.add(kDLabelContainer4, null);
        contfullName.setBounds(new Rectangle(35, 10, 270, 19));
        this.add(contfullName, null);
        contsex.setBounds(new Rectangle(360, 10, 270, 19));
        this.add(contsex, null);
        contworkPro.setBounds(new Rectangle(35, 42, 270, 19));
        this.add(contworkPro, null);
        contproProvince.setBounds(new Rectangle(35, 74, 270, 19));
        this.add(contproProvince, null);
        contphotoNum.setBounds(new Rectangle(35, 106, 270, 19));
        this.add(contphotoNum, null);
        contmailbox.setBounds(new Rectangle(35, 141, 270, 19));
        this.add(contmailbox, null);
        contqqNum.setBounds(new Rectangle(360, 106, 270, 19));
        this.add(contqqNum, null);
        contwechatNum.setBounds(new Rectangle(360, 141, 270, 19));
        this.add(contwechatNum, null);
        contremark.setBounds(new Rectangle(35, 185, 596, 37));
        this.add(contremark, null);
        contbelongArea.setBounds(new Rectangle(360, 42, 270, 19));
        this.add(contbelongArea, null);
        contrespContent.setBounds(new Rectangle(360, 74, 270, 19));
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.zjlw.baseinfo.app.SocialAddEditUIHandler";
	}
    ...
    public void setDataObject(IObjectValue dataObject)
    {
        ...
        this.editData = (com.kingdee.eas.zjlw.baseinfo.SocialAddInfo)ov;
    }
    ...
    {
        return new MetaDataPK("com.kingdee.eas.zjlw.baseinfo.client", "SocialAddEditUI");
    }
