 ...
 * output class name
 */
public abstract class AbstractLeaveManageEditUI extends com.kingdee.eas.framework.client.CoreBillEditUI
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractLeaveManageEditUI.class);
    ...
    protected com.kingdee.eas.zjlw.certificates.LeaveManageInfo editData = null;
    protected AcitonAudit actionAudit = null;
    protected ActionUnAudit actionUnAudit = null;
    /**
     * output class constructor
     */
    public AbstractLeaveManageEditUI() throws Exception
    {
        super();
    ...
    {
        this.resHelper = new ResourceBundleHelper(AbstractLeaveManageEditUI.class.getName());
    ...
    public void initUIContentLayout()
    {
        ...
        kdtEntrys_detailPanel = (com.kingdee.eas.framework.client.multiDetail.DetailPanel)com.kingdee.eas.framework.client.multiDetail.HMDUtils.buildDetail(this,dataBinder,kdtEntrys,new com.kingdee.eas.zjlw.certificates.LeaveManageEntryInfo(),null,false);
...
vo.put("leaveType","0");
        ...
        kDLabel1.setBounds(new Rectangle(10, 63, 990, 19));
        this.add(kDLabel1, new KDLayout.Constraints(10, 63, 990, 19, 0));
        //contCreator
	...
	private void registerBindings(){
		...
		dataBinder.registerBinding("entrys", com.kingdee.eas.zjlw.certificates.LeaveManageEntryInfo.class, this.kdtEntrys, "userObject");
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.zjlw.certificates.app.LeaveManageEditUIHandler";
	}
    ...
    public void setDataObject(IObjectValue dataObject)
    {
        ...
        this.editData = (com.kingdee.eas.zjlw.certificates.LeaveManageInfo)ov;
    }
    ...
    protected class AcitonAudit extends ItemAction {     
        ...
        public void actionPerformed(ActionEvent e)
        {
            ...
            innerActionPerformed("eas", AbstractLeaveManageEditUI.this, "AcitonAudit", "acitonAudit_actionPerformed", e);
        }
    }
    ...
    protected class ActionUnAudit extends ItemAction {     
        ...
        {
        	getUIContext().put("ORG.PK", getOrgPK(this));
            innerActionPerformed("eas", AbstractLeaveManageEditUI.this, "ActionUnAudit", "actionUnAudit_actionPerformed", e);
        }
    }
    ...
    {
        return new MetaDataPK("com.kingdee.eas.zjlw.certificates.client", "LeaveManageEditUI");
    }
    /**
    ...
    {
        return com.kingdee.eas.zjlw.certificates.client.LeaveManageEditUI.class.getName();
    }
    ...
    protected IObjectValue createNewData()
    {
    	...
    	return "/bim/zjlw/certificates/LeaveManage";
	}
    protected IMetaDataPK getTDQueryPK() {
    	return new MetaDataPK("com.kingdee.eas.zjlw.certificates.app.LeaveManageQuery");
	}
