 ...
 * output class name
 */
public abstract class AbstractWorkPmtECEditUI extends com.kingdee.eas.framework.client.CoreBillEditUI
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractWorkPmtECEditUI.class);
    ...
    protected com.kingdee.eas.zjlw.certificates.WorkPmtECInfo editData = null;
    /**
     * output class constructor
     */
    public AbstractWorkPmtECEditUI() throws Exception
    {
        super();
    ...
    {
        this.resHelper = new ResourceBundleHelper(AbstractWorkPmtECEditUI.class.getName());
    ...
    public void initUIContentLayout()
    {
        ...
        kdtEntrys_detailPanel = (com.kingdee.eas.framework.client.multiDetail.DetailPanel)com.kingdee.eas.framework.client.multiDetail.HMDUtils.buildDetail(this,dataBinder,kdtEntrys,new com.kingdee.eas.zjlw.certificates.WorkPmtECEntryInfo(),null,false);
...
vo.put("personState","10");
	...
	private void registerBindings(){
		...
		dataBinder.registerBinding("entrys", com.kingdee.eas.zjlw.certificates.WorkPmtECEntryInfo.class, this.kdtEntrys, "userObject");
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.zjlw.certificates.app.WorkPmtECEditUIHandler";
	}
    ...
    public void setDataObject(IObjectValue dataObject)
    {
        ...
        this.editData = (com.kingdee.eas.zjlw.certificates.WorkPmtECInfo)ov;
    }
    ...
    {
        return new MetaDataPK("com.kingdee.eas.zjlw.certificates.client", "WorkPmtECEditUI");
    }
    /**
    ...
    {
        return com.kingdee.eas.zjlw.certificates.client.WorkPmtECEditUI.class.getName();
    }
    ...
    protected IObjectValue createNewData()
    {
    	...
    	return "/bim/zjlw/certificates/WorkPmtEC";
	}
