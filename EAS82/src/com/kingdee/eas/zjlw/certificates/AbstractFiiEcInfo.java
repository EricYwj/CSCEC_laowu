...
public class AbstractFiiEcInfo extends com.kingdee.eas.framework.CoreBillBaseInfo implements Serializable 
{
    public AbstractFiiEcInfo()
    {
        this("id");
    }
    protected AbstractFiiEcInfo(String pkField)
    {
        super(pkField);
        put("entrys", new com.kingdee.eas.zjlw.certificates.FiiEcEntryCollection());
    }
    /**
     * Object: 分配工种-编辑界面 's 分录 property 
     */
    public com.kingdee.eas.zjlw.certificates.FiiEcEntryCollection getEntrys()
    {
        return (com.kingdee.eas.zjlw.certificates.FiiEcEntryCollection)get("entrys");
    }
    /**
     * Object:分配工种-编辑界面's 返签批次号property 
     */
    ...
    /**
     * Object:分配工种-编辑界面's 审核日期property 
     */
    ...
    /**
     * Object:分配工种-编辑界面's 单据状态property 
     */
    ...
    /**
     * Object:分配工种-编辑界面's 国内工作部审核时间property 
     */
    ...
    /**
     * Object:分配工种-编辑界面's 指标项目经理审核时间property 
     */
    ...
    /**
     * Object:分配工种-编辑界面's 指标项目业务人员审核时间property 
     */
    ...
    /**
     * Object: 分配工种-编辑界面 's 国内工作部信息审核人 property 
     */
    ...
    /**
     * Object: 分配工种-编辑界面 's 指标项目业务人员审核人 property 
     */
    ...
    /**
     * Object: 分配工种-编辑界面 's 指标项目经理审核人 property 
     */
