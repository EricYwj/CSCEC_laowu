 ...
 * output class name
 */
public class AlgAttDataListUI extends AbstractAlgAttDataListUI
{
    private static final Logger logger = CoreUIObject.getLogger(AlgAttDataListUI.class);
     ...
     */
    public AlgAttDataListUI() throws Exception
    {
        super();
    }
