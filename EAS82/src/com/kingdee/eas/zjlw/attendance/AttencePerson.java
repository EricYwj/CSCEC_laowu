...
public class AttencePerson extends DataBase implements IAttencePerson
{
    public AttencePerson()
    {
        super();
        registerInterface(IAttencePerson.class, this);
    }
    public AttencePerson(Context ctx)
    {
        super(ctx);
        registerInterface(IAttencePerson.class, this);
    }
    ...
    private AttencePersonController getController() throws BOSException
    {
        return (AttencePersonController)getBizController();
    }
    /**
    ...
    {
        try {
            return getController().getAttencePersonInfo(getContext(), pk);
        }
    ...
    {
        try {
            return getController().getAttencePersonInfo(getContext(), pk, selector);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getAttencePersonInfo(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getAttencePersonCollection(getContext());
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getAttencePersonCollection(getContext(), view);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getAttencePersonCollection(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
