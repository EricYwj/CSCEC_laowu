 ...
 * output class name
 */
public class AntiECListUI extends AbstractAntiECListUI
{
    private static final Logger logger = CoreUIObject.getLogger(AntiECListUI.class);
    
    /**
     * output class constructor
     */
    public AntiECListUI() throws Exception
    {
        super();
    }
