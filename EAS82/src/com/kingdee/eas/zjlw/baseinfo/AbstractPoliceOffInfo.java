...
public class AbstractPoliceOffInfo extends com.kingdee.eas.framework.DataBaseInfo implements Serializable 
{
    public AbstractPoliceOffInfo()
    {
        this("id");
    }
    protected AbstractPoliceOffInfo(String pkField)
    {
        super(pkField);
        put("Entrys", new com.kingdee.eas.zjlw.baseinfo.PoliceOffEntryCollection());
    }
    /**
     * Object: 警察局 's 项目名称 property 
     */
    ...
    /**
     * Object: 警察局 's 分录 property 
     */
    public com.kingdee.eas.zjlw.baseinfo.PoliceOffEntryCollection getEntrys()
    {
        return (com.kingdee.eas.zjlw.baseinfo.PoliceOffEntryCollection)get("Entrys");
    }
    /**
     * Object:警察局's 机构名称property 
     */
