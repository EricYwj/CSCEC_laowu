 ...
 * output class name
 */
public abstract class AbstractAttenceListUI extends com.kingdee.eas.framework.client.CoreBillListUI
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractAttenceListUI.class);
     ...
     */
    public AbstractAttenceListUI() throws Exception
    {
        super();
    ...
    {
        this.resHelper = new ResourceBundleHelper(AbstractAttenceListUI.class.getName());
        this.setUITitle(resHelper.getString("this.title"));
        mainQueryPK = new MetaDataPK("com.kingdee.eas.zjlw.attendance.app", "AttenceQuery");
        //actionRemove
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.zjlw.attendance.app.AttenceListUIHandler";
	}
    ...
    public SelectorItemCollection getSelectors()
    {
        ...
        sic.add(new SelectorItemInfo("entrys.CheckSysDepNo"));
        sic.add(new SelectorItemInfo("entrys.CheckNo"));
        sic.add(new SelectorItemInfo("entrys.name"));
        sic.add(new SelectorItemInfo("entrys.date"));
        sic.add(new SelectorItemInfo("entrys.checkTime"));
        sic.add(new SelectorItemInfo("entrys.checkMachineNo"));
        ...
        sic.add(new SelectorItemInfo("entrys.workOrgId.name"));
    ...
    protected class ActionTDPrint extends ItemAction {     
        ...
        public void actionPerformed(ActionEvent e)
        {
            ...
            innerActionPerformed("eas", AbstractAttenceListUI.this, "ActionTDPrint", "actionTDPrint_actionPerformed", e);
        }
    }
    ...
    protected class ActionTDPrintPreview extends ItemAction {     
        ...
        {
        	getUIContext().put("ORG.PK", getOrgPK(this));
            innerActionPerformed("eas", AbstractAttenceListUI.this, "ActionTDPrintPreview", "actionTDPrintPreview_actionPerformed", e);
        }
    }
    ...
    protected class ActionAudit extends ItemAction {     
        ...
        {
        	getUIContext().put("ORG.PK", getOrgPK(this));
            innerActionPerformed("eas", AbstractAttenceListUI.this, "ActionAudit", "actionAudit_actionPerformed", e);
        }
    }
    ...
    protected class ActionUnAudit extends ItemAction {     
        ...
        {
        	getUIContext().put("ORG.PK", getOrgPK(this));
            innerActionPerformed("eas", AbstractAttenceListUI.this, "ActionUnAudit", "actionUnAudit_actionPerformed", e);
        }
    }
    ...
    {
        return new MetaDataPK("com.kingdee.eas.zjlw.attendance.client", "AttenceListUI");
    }
    /**
    ...
    {
        return com.kingdee.eas.zjlw.attendance.client.AttenceEditUI.class.getName();
    }
    ...
    {
        return com.kingdee.eas.zjlw.attendance.AttenceFactory.getRemoteInstance();
    }
    ...
    {
        com.kingdee.eas.zjlw.attendance.AttenceInfo objectValue = new com.kingdee.eas.zjlw.attendance.AttenceInfo();		
        return objectValue;
    }
    ...
    {
        return new String[] {"id","number","bizDate","description","createTime","lastUpdateTime","auditor.number","auditor.name","creator.number","creator.name","lastUpdateUser.number","lastUpdateUser.name","handler.number","handler.name","entrys.cooperationid.name","entrys.workOrgId.name","proCom.name","auditDate","billSate"};
    }



	protected String getTDFileName() {
    	return "/bim/zjlw/attendance/Attence";
	}
    protected IMetaDataPK getTDQueryPK() {
    	return new MetaDataPK("com.kingdee.eas.zjlw.attendance.app.AttenceQuery");
	}
