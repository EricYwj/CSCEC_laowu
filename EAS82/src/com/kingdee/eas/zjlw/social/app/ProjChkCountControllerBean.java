...
public class ProjChkCountControllerBean extends AbstractProjChkCountControllerBean
{
    private static Logger logger = Logger.getLogger("com.kingdee.eas.zjlw.social.app.ProjChkCountControllerBean");
    
    // 保存
   	protected IObjectPK _save(Context ctx, IObjectValue model)throws BOSException, EASBizException {
   		ProjChkCountInfo accInfo = (ProjChkCountInfo) model;
...
//       	}
       ...
       protected void _passAudit(Context ctx, IObjectPK pk, IObjectValue model)throws EASBizException, BOSException {
    	   ProjChkCountInfo info = (ProjChkCountInfo) getValue(ctx, pk, getSelector());
