 ...
 * output class name
 */
public abstract class AbstractForiAttDataListUI extends com.kingdee.eas.framework.client.CoreBillListUI
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractForiAttDataListUI.class);
     ...
     */
    public AbstractForiAttDataListUI() throws Exception
    {
        super();
    ...
    {
        this.resHelper = new ResourceBundleHelper(AbstractForiAttDataListUI.class.getName());
        this.setUITitle(resHelper.getString("this.title"));
        mainQueryPK = new MetaDataPK("com.kingdee.eas.zjlw.attendance.app", "ForiAttDataQuery");
        //actionRemove
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.zjlw.attendance.app.ForiAttDataListUIHandler";
	}
    ...
    protected class ActionTDPrint extends ItemAction {     
        ...
        public void actionPerformed(ActionEvent e)
        {
            ...
            innerActionPerformed("eas", AbstractForiAttDataListUI.this, "ActionTDPrint", "actionTDPrint_actionPerformed", e);
        }
    }
    ...
    protected class ActionTDPrintPreview extends ItemAction {     
        ...
        {
        	getUIContext().put("ORG.PK", getOrgPK(this));
            innerActionPerformed("eas", AbstractForiAttDataListUI.this, "ActionTDPrintPreview", "actionTDPrintPreview_actionPerformed", e);
        }
    }
    ...
    {
        return new MetaDataPK("com.kingdee.eas.zjlw.attendance.client", "ForiAttDataListUI");
    }
    /**
    ...
    {
        return com.kingdee.eas.zjlw.attendance.client.ForiAttDataEditUI.class.getName();
    }
    ...
    {
        return com.kingdee.eas.zjlw.attendance.ForiAttDataFactory.getRemoteInstance();
    }
    ...
    {
        com.kingdee.eas.zjlw.attendance.ForiAttDataInfo objectValue = new com.kingdee.eas.zjlw.attendance.ForiAttDataInfo();		
        return objectValue;
    }
    ...
    {
        return new String[] {"id","number","bizDate","description","createTime","lastUpdateTime","auditor.number","auditor.name","creator.number","creator.name","lastUpdateUser.number","lastUpdateUser.name","handler.number","handler.name","CheckSysDepNo","proCom.name"};
    }



	protected String getTDFileName() {
    	return "/bim/zjlw/attendance/ForiAttData";
	}
    protected IMetaDataPK getTDQueryPK() {
    	return new MetaDataPK("com.kingdee.eas.zjlw.attendance.app.ForiAttDataQuery");
	}
