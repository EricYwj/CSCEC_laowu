 ...
 * output class name
 */
public abstract class AbstractPoliceOffEditUI extends com.kingdee.eas.framework.client.EditUI
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractPoliceOffEditUI.class);
    ...
    protected com.kingdee.eas.zjlw.baseinfo.PoliceOffInfo editData = null;
    /**
     * output class constructor
     */
    public AbstractPoliceOffEditUI() throws Exception
    {
        super();
    ...
    {
        this.resHelper = new ResourceBundleHelper(AbstractPoliceOffEditUI.class.getName());
        ...
        this.contorganizational.setVisible(true);
        // txtNumber		
    ...
    public void initUIContentLayout()
    {
        ...
        kDLabelContainer1.setBounds(new Rectangle(542, 535, 270, 19));
        this.add(kDLabelContainer1, new KDLayout.Constraints(542, 535, 270, 19, 0));
        kDLabelContainer2.setBounds(new Rectangle(540, 15, 205, 19));
        this.add(kDLabelContainer2, new KDLayout.Constraints(540, 15, 205, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT_SCALE | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        kDLabelContainer3.setBounds(new Rectangle(784, 572, 270, 19));
        this.add(kDLabelContainer3, new KDLayout.Constraints(784, 572, 270, 19, 0));
        ...
        contprovince.setBounds(new Rectangle(307, 14, 217, 19));
        this.add(contprovince, new KDLayout.Constraints(307, 14, 217, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT_SCALE | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        kdtEntrys.setBounds(new Rectangle(12, 47, 1068, 476));
        kdtEntrys_detailPanel = (com.kingdee.eas.framework.client.multiDetail.DetailPanel)com.kingdee.eas.framework.client.multiDetail.HMDUtils.buildDetail(this,dataBinder,kdtEntrys,new com.kingdee.eas.zjlw.baseinfo.PoliceOffEntryInfo(),null,false);
        this.add(kdtEntrys_detailPanel, new KDLayout.Constraints(12, 47, 1068, 476, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_BOTTOM | KDLayout.Constraints.ANCHOR_LEFT | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
...
vo.put("maritalStatus","0");
        ...
        contorganizational.setBounds(new Rectangle(839, 533, 193, 19));
        this.add(contorganizational, new KDLayout.Constraints(839, 533, 193, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT_SCALE | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        //kDLabelContainer1
	...
	private void registerBindings(){
		...
		dataBinder.registerBinding("Entrys", com.kingdee.eas.zjlw.baseinfo.PoliceOffEntryInfo.class, this.kdtEntrys, "userObject");
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.zjlw.baseinfo.app.PoliceOffEditUIHandler";
	}
    ...
    public void setDataObject(IObjectValue dataObject)
    {
        ...
        this.editData = (com.kingdee.eas.zjlw.baseinfo.PoliceOffInfo)ov;
    }
    ...
    {
        return new MetaDataPK("com.kingdee.eas.zjlw.baseinfo.client", "PoliceOffEditUI");
    }
