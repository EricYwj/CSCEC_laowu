...
public class AlgAttDataControllerBean extends AbstractAlgAttDataControllerBean
{
    private static Logger logger =
        Logger.getLogger("com.kingdee.eas.zjlw.attendance.app.AlgAttDataControllerBean");
}