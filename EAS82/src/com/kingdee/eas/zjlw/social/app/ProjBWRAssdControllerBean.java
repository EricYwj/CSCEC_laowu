...
public class ProjBWRAssdControllerBean extends AbstractProjBWRAssdControllerBean
{
    private static Logger logger =
        Logger.getLogger("com.kingdee.eas.zjlw.social.app.ProjBWRAssdControllerBean");
  //提交 
    protected IObjectPK _submit(Context ctx, IObjectValue model)
    throws BOSException, EASBizException {
    	ProjBWRAssdInfo accInfo = (ProjBWRAssdInfo) model;
...
//    	}
    ...
    protected void _passAudit(Context ctx, IObjectPK pk, IObjectValue model)throws EASBizException, BOSException {
    	ProjBWRAssdInfo info = (ProjBWRAssdInfo) getValue(ctx, pk, getSelector());
