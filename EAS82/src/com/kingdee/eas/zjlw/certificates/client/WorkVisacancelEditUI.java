 ...
 * output class name
 */
public class WorkVisacancelEditUI extends AbstractWorkVisacancelEditUI
{
    private static final Logger logger = CoreUIObject.getLogger(WorkVisacancelEditUI.class);
     ...
     */
    public WorkVisacancelEditUI() throws Exception
    {
        super();
    }
    /**
    ...
    public void actionSave_actionPerformed(ActionEvent e) throws Exception
    {
		...
		if(this.editData!=null && this.editData.getId()!=null){
			...
			sic.add("id");
			sic.add("billSate");
			WorkVisacancelInfo fiInfo = WorkVisacancelFactory.getRemoteInstance().getWorkVisacancelInfo(new ObjectUuidPK(this.editData.getId()),sic);
