 ...
 * output class name
 */
public abstract class AbstractCheckInOutTableEditUI extends com.kingdee.eas.framework.client.EditUI
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractCheckInOutTableEditUI.class);
    ...
    protected com.kingdee.bos.ctrl.swing.KDLabelContainer contcheckAera;
    ...
    protected com.kingdee.bos.ctrl.swing.KDLabelContainer contchkTime;
    ...
    protected com.kingdee.bos.ctrl.swing.KDTextField txtcheckAera;
    ...
    protected com.kingdee.bos.ctrl.swing.KDDatePicker pkchkTime;
    protected com.kingdee.eas.zjlw.attendance.CheckInOutTableInfo editData = null;
    /**
     * output class constructor
     */
    public AbstractCheckInOutTableEditUI() throws Exception
    {
        super();
    ...
    {
        this.resHelper = new ResourceBundleHelper(AbstractCheckInOutTableEditUI.class.getName());
        ...
        this.contcheckAera = new com.kingdee.bos.ctrl.swing.KDLabelContainer();
        ...
        this.contchkTime = new com.kingdee.bos.ctrl.swing.KDLabelContainer();
        ...
        // contcheckAera		
        this.contcheckAera.setBoundLabelText(resHelper.getString("contcheckAera.boundLabelText"));		
        this.contcheckAera.setBoundLabelLength(100);		
        this.contcheckAera.setBoundLabelUnderline(true);		
        this.contcheckAera.setVisible(true);
        // contmachineId		
        ...
        // contchkTime		
        this.contchkTime.setBoundLabelText(resHelper.getString("contchkTime.boundLabelText"));		
        this.contchkTime.setBoundLabelLength(100);		
        this.contchkTime.setBoundLabelUnderline(true);		
        this.contchkTime.setVisible(true);
        // txtNumber		
        ...
        // txtcheckAera		
        this.txtcheckAera.setHorizontalAlignment(2);		
        this.txtcheckAera.setMaxLength(100);		
        this.txtcheckAera.setRequired(false);
        // txtmachineId		
        ...
        this.txtcheckTime.setVisible(false);
        // pkchkTime		
        this.pkchkTime.setRequired(false);
        this.setFocusTraversalPolicy(new com.kingdee.bos.ui.UIFocusTraversalPolicy(new java.awt.Component[] {txtperId,txtperName,txtperProj,pkchkTime,txtcheckTime,txtcheckType,txtSimpleName,txtDescription,txtNumber,txtName,txtcheckAera,txtmachineId}));
    ...
    {
        this.setBounds(new Rectangle(0, 0, 1013, 215));
        this.setLayout(null);
        kDLabelContainer1.setBounds(new Rectangle(26, 398, 270, 19));
        this.add(kDLabelContainer1, null);
        kDLabelContainer2.setBounds(new Rectangle(582, 409, 270, 19));
        this.add(kDLabelContainer2, null);
        kDLabelContainer3.setBounds(new Rectangle(310, 418, 270, 19));
        this.add(kDLabelContainer3, null);
        kDLabelContainer4.setBounds(new Rectangle(26, 420, 270, 19));
        this.add(kDLabelContainer4, null);
        contperId.setBounds(new Rectangle(43, 28, 270, 19));
        this.add(contperId, null);
        contperName.setBounds(new Rectangle(359, 28, 270, 19));
        this.add(contperName, null);
        contperProj.setBounds(new Rectangle(675, 28, 270, 19));
        this.add(contperProj, null);
        contcheckType.setBounds(new Rectangle(359, 82, 270, 19));
        this.add(contcheckType, null);
        contcheckAera.setBounds(new Rectangle(675, 82, 270, 19));
        this.add(contcheckAera, null);
        contmachineId.setBounds(new Rectangle(43, 137, 270, 19));
        this.add(contmachineId, null);
        contcheckTime.setBounds(new Rectangle(363, 129, 270, 19));
        this.add(contcheckTime, null);
        contchkTime.setBounds(new Rectangle(43, 82, 270, 19));
        this.add(contchkTime, null);
        //kDLabelContainer1
	...
	private void registerBindings(){
		...
		dataBinder.registerBinding("checkAera", String.class, this.txtcheckAera, "text");
		...
		dataBinder.registerBinding("chkTime", java.util.Date.class, this.pkchkTime, "value");		
	}
	//Regiester UI State
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.zjlw.attendance.app.CheckInOutTableEditUIHandler";
	}
    ...
    {
        super.onShow();
        this.txtperId.requestFocusInWindow();
    }
    ...
    public void setDataObject(IObjectValue dataObject)
    {
        ...
        this.editData = (com.kingdee.eas.zjlw.attendance.CheckInOutTableInfo)ov;
    }
	...
	protected void registerValidator() {
		...
		getValidateHelper().registerBindProperty("checkAera", ValidateHelper.ON_SAVE);    
		...
		getValidateHelper().registerBindProperty("chkTime", ValidateHelper.ON_SAVE);    		
	}
    ...
    {
        return new MetaDataPK("com.kingdee.eas.zjlw.attendance.client", "CheckInOutTableEditUI");
    }
    ...
    {
        return com.kingdee.eas.zjlw.attendance.client.CheckInOutTableEditUI.class.getName();
    }
