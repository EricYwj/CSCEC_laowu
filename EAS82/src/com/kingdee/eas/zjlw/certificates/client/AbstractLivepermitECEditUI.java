 ...
 * output class name
 */
public abstract class AbstractLivepermitECEditUI extends com.kingdee.eas.framework.client.CoreBillEditUI
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractLivepermitECEditUI.class);
    ...
    protected com.kingdee.eas.zjlw.certificates.LivepermitECInfo editData = null;
    protected ActionAudit actionAudit = null;
    protected ActionUnAudit actionUnAudit = null;
    /**
     * output class constructor
     */
    public AbstractLivepermitECEditUI() throws Exception
    {
        super();
    ...
    {
        this.resHelper = new ResourceBundleHelper(AbstractLivepermitECEditUI.class.getName());
        ...
        KDDatePicker kdtEntrys_liveTime_DatePicker = new KDDatePicker();
        kdtEntrys_liveTime_DatePicker.setName("kdtEntrys_liveTime_DatePicker");
        kdtEntrys_liveTime_DatePicker.setVisible(true);
        kdtEntrys_liveTime_DatePicker.setEditable(true);
        KDTDefaultCellEditor kdtEntrys_liveTime_CellEditor = new KDTDefaultCellEditor(kdtEntrys_liveTime_DatePicker);
        this.kdtEntrys.getColumn("liveTime").setEditor(kdtEntrys_liveTime_CellEditor);
    ...
    public void initUIContentLayout()
    {
        ...
        kdtEntrys_detailPanel = (com.kingdee.eas.framework.client.multiDetail.DetailPanel)com.kingdee.eas.framework.client.multiDetail.HMDUtils.buildDetail(this,dataBinder,kdtEntrys,new com.kingdee.eas.zjlw.certificates.LivepermitECEntryInfo(),null,false);
...
vo.put("docType","0");
	...
	private void registerBindings(){
		...
		dataBinder.registerBinding("entrys", com.kingdee.eas.zjlw.certificates.LivepermitECEntryInfo.class, this.kdtEntrys, "userObject");
		...
		dataBinder.registerBinding("entrys.liveTime", java.util.Date.class, this.kdtEntrys, "liveTime.text");
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.zjlw.certificates.app.LivepermitECEditUIHandler";
	}
    ...
    public void setDataObject(IObjectValue dataObject)
    {
        ...
        this.editData = (com.kingdee.eas.zjlw.certificates.LivepermitECInfo)ov;
    }
	...
	protected void registerValidator() {
		...
		getValidateHelper().registerBindProperty("entrys.liveTime", ValidateHelper.ON_SAVE);    
    ...
    public SelectorItemCollection getSelectors()
    {
    	...
    	sic.add(new SelectorItemInfo("entrys.liveTime"));
		if(selectorAll.equalsIgnoreCase("true"))
		{
    ...
    protected class ActionAudit extends ItemAction {     
        ...
        public void actionPerformed(ActionEvent e)
        {
            ...
            innerActionPerformed("eas", AbstractLivepermitECEditUI.this, "ActionAudit", "actionAudit_actionPerformed", e);
        }
    }
    ...
    protected class ActionUnAudit extends ItemAction {     
        ...
        {
        	getUIContext().put("ORG.PK", getOrgPK(this));
            innerActionPerformed("eas", AbstractLivepermitECEditUI.this, "ActionUnAudit", "actionUnAudit_actionPerformed", e);
        }
    }
    ...
    {
        return new MetaDataPK("com.kingdee.eas.zjlw.certificates.client", "LivepermitECEditUI");
    }
    /**
    ...
    {
        return com.kingdee.eas.zjlw.certificates.client.LivepermitECEditUI.class.getName();
    }
    ...
    protected IObjectValue createNewData()
    {
    	...
    	return "/bim/zjlw/certificates/LivepermitEC";
	}
