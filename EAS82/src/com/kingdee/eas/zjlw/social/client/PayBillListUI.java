 ...
 * output class name
 */
public class PayBillListUI extends AbstractPayBillListUI
{
    private static final Logger logger = CoreUIObject.getLogger(PayBillListUI.class);
     ...
     */
    public PayBillListUI() throws Exception
    {
        super();
    }
