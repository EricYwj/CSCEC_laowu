 ...
 * output class name
 */
public class CheckInOutListUI extends AbstractCheckInOutListUI {
	private static final Logger logger = CoreUIObject
			.getLogger(CheckInOutListUI.class);

	private static ChkIOFilterUI filterUI = null;
	...
	protected CommonQueryDialog initCommonQueryDialog() {
		...
		try {
			SCMPromptBoxFactory scmF7Factory = new SCMPromptBoxFactory(
					getFilterUI(), getMainBizOrgType());
	...
	public void actionInit_actionPerformed(ActionEvent e) throws Exception {
		CheckInOutFactory.getRemoteInstance().init();
	}
	 ...
	 */
	public CheckInOutListUI() throws Exception {
		super();
	}
	...
	protected com.kingdee.eas.framework.ICoreBase getBizInterface()
			throws Exception {
		return com.kingdee.eas.zjlw.attendance.CheckInOutFactory
				.getRemoteInstance();
	}
