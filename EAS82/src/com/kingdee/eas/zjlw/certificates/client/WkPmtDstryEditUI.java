 ...
 * output class name
 */
public class WkPmtDstryEditUI extends AbstractWkPmtDstryEditUI
{
    private static final Logger logger = CoreUIObject.getLogger(WkPmtDstryEditUI.class);
    
    /**
     * output class constructor
     */
    public WkPmtDstryEditUI() throws Exception
    {
        super();
    }
    /**
...
//    	kdtEntrys.getColumn("cooperation").getStyleAttributes().setLocked(true);//合作单位
    ...
    protected void setButtonStatus() {
		...
		if ("VIEW".equals(getOprtState())) {
			...
			bill = (WkPmtDstryInfo) this.editData;
    ...
    public void actionSave_actionPerformed(ActionEvent e) throws Exception
    {
		...
		if(this.editData!=null && this.editData.getId()!=null){
			...
			sic.add("id");
			sic.add("billSate");
			WkPmtDstryInfo fiInfo = WkPmtDstryFactory.getRemoteInstance().getWkPmtDstryInfo(new ObjectUuidPK(this.editData.getId()),sic);
