...
public class PoliceOffEntry extends CoreBillEntryBase implements IPoliceOffEntry
{
    public PoliceOffEntry()
    {
        super();
        registerInterface(IPoliceOffEntry.class, this);
    }
    public PoliceOffEntry(Context ctx)
    {
        super(ctx);
        registerInterface(IPoliceOffEntry.class, this);
    }
    ...
    private PoliceOffEntryController getController() throws BOSException
    {
        return (PoliceOffEntryController)getBizController();
    }
    /**
    ...
    {
        try {
            return getController().getPoliceOffEntryInfo(getContext(), pk);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getPoliceOffEntryInfo(getContext(), pk, selector);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getPoliceOffEntryInfo(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getPoliceOffEntryCollection(getContext());
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getPoliceOffEntryCollection(getContext(), view);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getPoliceOffEntryCollection(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
