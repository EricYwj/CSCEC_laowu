 ...
 * output class name
 */
public class ForiAttDataListUI extends AbstractForiAttDataListUI
{
    private static final Logger logger = CoreUIObject.getLogger(ForiAttDataListUI.class);
     ...
     */
    public ForiAttDataListUI() throws Exception
    {
        super();
    }
