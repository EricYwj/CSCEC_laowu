 ...
 * output class name
 */
public class AttenceDataListUI extends AbstractAttenceDataListUI
{
    private static final Logger logger = CoreUIObject.getLogger(AttenceDataListUI.class);
    
    /**
     * output class constructor
     */
    public AttenceDataListUI() throws Exception
    {
        super();
    }
