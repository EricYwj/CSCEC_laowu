...
public class SocialSeBur extends DataBase implements ISocialSeBur
{
    public SocialSeBur()
    {
        super();
        registerInterface(ISocialSeBur.class, this);
    }
    public SocialSeBur(Context ctx)
    {
        super(ctx);
        registerInterface(ISocialSeBur.class, this);
    }
    ...
    private SocialSeBurController getController() throws BOSException
    {
        return (SocialSeBurController)getBizController();
    }
    /**
    ...
    {
        try {
            return getController().getSocialSeBurInfo(getContext(), pk);
        }
    ...
    {
        try {
            return getController().getSocialSeBurInfo(getContext(), pk, selector);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getSocialSeBurInfo(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getSocialSeBurCollection(getContext());
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getSocialSeBurCollection(getContext(), view);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getSocialSeBurCollection(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
