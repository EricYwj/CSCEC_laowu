 ...
 * output class name
 */
public class PayPrintListUI extends AbstractPayPrintListUI
{
    private static final Logger logger = CoreUIObject.getLogger(PayPrintListUI.class);
    
    /**
     * output class constructor
     */
    public PayPrintListUI() throws Exception
    {
        super();
    }
