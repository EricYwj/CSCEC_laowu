...
public class AbstractLabSupBurEntryInfo extends com.kingdee.eas.framework.CoreBillEntryBaseInfo implements Serializable 
{
    public AbstractLabSupBurEntryInfo()
    {
        this("id");
    }
    protected AbstractLabSupBurEntryInfo(String pkField)
    {
        super(pkField);
    }
    /**
     ...
     */
    public com.kingdee.eas.zjlw.baseinfo.LabSupBurInfo getParent()
    {
        return (com.kingdee.eas.zjlw.baseinfo.LabSupBurInfo)get("parent");
    }
    public void setParent(com.kingdee.eas.zjlw.baseinfo.LabSupBurInfo item)
    {
        put("parent", item);
    }
    /**
