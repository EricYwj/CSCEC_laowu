...
public class AbstractApEcEntryInfo extends com.kingdee.eas.framework.CoreBillEntryBaseInfo implements Serializable 
{
    public AbstractApEcEntryInfo()
    {
        this("id");
    }
    protected AbstractApEcEntryInfo(String pkField)
    {
        super(pkField);
    }
    /**
     ...
     */
    public com.kingdee.eas.zjlw.certificates.ApEcInfo getParent()
    {
        return (com.kingdee.eas.zjlw.certificates.ApEcInfo)get("parent");
    }
    public void setParent(com.kingdee.eas.zjlw.certificates.ApEcInfo item)
    {
        put("parent", item);
    }
    /**
