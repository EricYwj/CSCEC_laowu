 ...
 * output class name
 */
public abstract class AbstractCheckInOutListUI extends com.kingdee.eas.framework.client.ListUI
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractCheckInOutListUI.class);
    protected com.kingdee.bos.ctrl.swing.KDWorkButton btnInit;
    protected ActionInit actionInit = null;
    /**
     * output class constructor
     */
    public AbstractCheckInOutListUI() throws Exception
    {
        super();
    ...
    {
        this.resHelper = new ResourceBundleHelper(AbstractCheckInOutListUI.class.getName());
        this.setUITitle(resHelper.getString("this.title"));
        mainQueryPK = new MetaDataPK("com.kingdee.eas.zjlw.attendance.app", "CheckInOutQuery");
        //actionInit
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.zjlw.attendance.app.CheckInOutListUIHandler";
	}
    ...
    protected class ActionInit extends ItemAction {     
        ...
        public void actionPerformed(ActionEvent e)
        {
            ...
            innerActionPerformed("eas", AbstractCheckInOutListUI.this, "ActionInit", "actionInit_actionPerformed", e);
        }
    }
    ...
    {
        return new MetaDataPK("com.kingdee.eas.zjlw.attendance.client", "CheckInOutListUI");
    }
