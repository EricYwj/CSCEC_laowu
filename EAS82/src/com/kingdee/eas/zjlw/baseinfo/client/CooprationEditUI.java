 ...
 * output class name
 */
public class CooprationEditUI extends AbstractCooprationEditUI
{
    private static final Logger logger = CoreUIObject.getLogger(CooprationEditUI.class);
     ...
     */
    public CooprationEditUI() throws Exception
    {
        super();
    }
    /**
