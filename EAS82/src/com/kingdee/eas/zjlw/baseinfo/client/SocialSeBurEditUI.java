 ...
 * output class name
 */
public class SocialSeBurEditUI extends AbstractSocialSeBurEditUI
{
    private static final Logger logger = CoreUIObject.getLogger(SocialSeBurEditUI.class);
    
    /**
     * output class constructor
     */
    public SocialSeBurEditUI() throws Exception
    {
        super();
    }
    /**
