 ...
 * output class name
 */
public abstract class AbstractAttenceDataListUI extends com.kingdee.eas.framework.client.ListUI
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractAttenceDataListUI.class);
    /**
     * output class constructor
     */
    public AbstractAttenceDataListUI() throws Exception
    {
        super();
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.zjlw.attendance.app.AttenceDataListUIHandler";
	}
    ...
    {
        return new MetaDataPK("com.kingdee.eas.zjlw.attendance.client", "AttenceDataListUI");
    }
