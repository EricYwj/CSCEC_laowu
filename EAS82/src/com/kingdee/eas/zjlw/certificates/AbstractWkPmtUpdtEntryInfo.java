...
public class AbstractWkPmtUpdtEntryInfo extends com.kingdee.eas.framework.CoreBillEntryBaseInfo implements Serializable 
{
    public AbstractWkPmtUpdtEntryInfo()
    {
        this("id");
    }
    protected AbstractWkPmtUpdtEntryInfo(String pkField)
    {
        super(pkField);
    }
    /**
     ...
     */
    public com.kingdee.eas.zjlw.certificates.WkPmtUpdtInfo getParent()
    {
        return (com.kingdee.eas.zjlw.certificates.WkPmtUpdtInfo)get("parent");
    }
    public void setParent(com.kingdee.eas.zjlw.certificates.WkPmtUpdtInfo item)
    {
        put("parent", item);
    }
    /**
