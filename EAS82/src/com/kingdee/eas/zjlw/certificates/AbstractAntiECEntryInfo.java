...
public class AbstractAntiECEntryInfo extends com.kingdee.eas.framework.CoreBillEntryBaseInfo implements Serializable 
{
    public AbstractAntiECEntryInfo()
    {
        this("id");
    }
    protected AbstractAntiECEntryInfo(String pkField)
    {
        super(pkField);
    }
    /**
     ...
     */
    public com.kingdee.eas.zjlw.certificates.AntiECInfo getParent()
    {
        return (com.kingdee.eas.zjlw.certificates.AntiECInfo)get("parent");
    }
    public void setParent(com.kingdee.eas.zjlw.certificates.AntiECInfo item)
    {
        put("parent", item);
    }
    /**
