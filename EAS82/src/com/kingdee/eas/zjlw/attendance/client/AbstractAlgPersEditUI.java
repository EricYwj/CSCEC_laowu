 ...
 * output class name
 */
public abstract class AbstractAlgPersEditUI extends com.kingdee.eas.framework.client.CoreBillEditUI
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractAlgPersEditUI.class);
    ...
    protected com.kingdee.eas.zjlw.attendance.AlgPersInfo editData = null;
    /**
     * output class constructor
     */
    public AbstractAlgPersEditUI() throws Exception
    {
        super();
    ...
    {
        this.resHelper = new ResourceBundleHelper(AbstractAlgPersEditUI.class.getName());
        ...
        final KDBizPromptBox kdtEntrys_checkRuleId_PromptBox = new KDBizPromptBox();
        kdtEntrys_checkRuleId_PromptBox.setQueryInfo("com.kingdee.eas.zjlw.attendance.app.AlgCheckRulesQuery");
        kdtEntrys_checkRuleId_PromptBox.setVisible(true);
        kdtEntrys_checkRuleId_PromptBox.setEditable(true);
        kdtEntrys_checkRuleId_PromptBox.setDisplayFormat("$number$");
        kdtEntrys_checkRuleId_PromptBox.setEditFormat("$number$");
        kdtEntrys_checkRuleId_PromptBox.setCommitFormat("$number$");
        KDTDefaultCellEditor kdtEntrys_checkRuleId_CellEditor = new KDTDefaultCellEditor(kdtEntrys_checkRuleId_PromptBox);
        this.kdtEntrys.getColumn("checkRuleId").setEditor(kdtEntrys_checkRuleId_CellEditor);
        ObjectValueRender kdtEntrys_checkRuleId_OVR = new ObjectValueRender();
        kdtEntrys_checkRuleId_OVR.setFormat(new BizDataFormat("$name$"));
        this.kdtEntrys.getColumn("checkRuleId").setRenderer(kdtEntrys_checkRuleId_OVR);
        ...
        this.setFocusTraversalPolicy(new com.kingdee.bos.ui.UIFocusTraversalPolicy(new java.awt.Component[] {txtNumber,pkBizDate,txtDescription,prmtAuditor,prmtCreator,kDDateCreateTime,prmtLastUpdateUser,kDDateLastUpdateTime,billSate,pkAuditDate,kdtEntrys,prmtproCom}));
    ...
    {
        this.setBounds(new Rectangle(0, 0, 1013, 486));
        this.setLayout(new KDLayout());
        this.putClientProperty("OriginalBounds", new Rectangle(0, 0, 1013, 486));
        contCreator.setBounds(new Rectangle(13, 455, 210, 19));
        this.add(contCreator, new KDLayout.Constraints(13, 455, 210, 19, KDLayout.Constraints.ANCHOR_BOTTOM | KDLayout.Constraints.ANCHOR_LEFT | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        contCreateTime.setBounds(new Rectangle(273, 455, 210, 19));
        this.add(contCreateTime, new KDLayout.Constraints(273, 455, 210, 19, KDLayout.Constraints.ANCHOR_BOTTOM | KDLayout.Constraints.ANCHOR_LEFT_SCALE | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        contLastUpdateUser.setBounds(new Rectangle(441, 487, 270, 19));
        this.add(contLastUpdateUser, new KDLayout.Constraints(441, 487, 270, 19, 0));
        contLastUpdateTime.setBounds(new Rectangle(731, 487, 270, 19));
        this.add(contLastUpdateTime, new KDLayout.Constraints(731, 487, 270, 19, 0));
        ...
        contBizDate.setBounds(new Rectangle(371, 13, 285, 19));
        this.add(contBizDate, new KDLayout.Constraints(371, 13, 285, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT_SCALE | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        contDescription.setBounds(new Rectangle(12, 39, 989, 19));
        this.add(contDescription, new KDLayout.Constraints(12, 39, 989, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT | KDLayout.Constraints.ANCHOR_RIGHT));
        contAuditor.setBounds(new Rectangle(533, 455, 210, 19));
        this.add(contAuditor, new KDLayout.Constraints(533, 455, 210, 19, KDLayout.Constraints.ANCHOR_BOTTOM | KDLayout.Constraints.ANCHOR_LEFT_SCALE | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        kdtEntrys.setBounds(new Rectangle(11, 69, 991, 380));
        kdtEntrys_detailPanel = (com.kingdee.eas.framework.client.multiDetail.DetailPanel)com.kingdee.eas.framework.client.multiDetail.HMDUtils.buildDetail(this,dataBinder,kdtEntrys,new com.kingdee.eas.zjlw.attendance.AlgPersEntryInfo(),null,false);
        this.add(kdtEntrys_detailPanel, new KDLayout.Constraints(11, 69, 991, 380, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_BOTTOM | KDLayout.Constraints.ANCHOR_LEFT | KDLayout.Constraints.ANCHOR_RIGHT));
...
vo.put("sex",new Integer(1));
        ...
        contbillSate.setBounds(new Rectangle(675, 53, 270, 19));
        this.add(contbillSate, new KDLayout.Constraints(675, 53, 270, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT_SCALE | KDLayout.Constraints.ANCHOR_RIGHT));
        contAuditDate.setBounds(new Rectangle(793, 455, 210, 19));
        this.add(contAuditDate, new KDLayout.Constraints(793, 455, 210, 19, KDLayout.Constraints.ANCHOR_BOTTOM | KDLayout.Constraints.ANCHOR_LEFT_SCALE | KDLayout.Constraints.ANCHOR_RIGHT));
        contproCom.setBounds(new Rectangle(731, 13, 270, 19));
        this.add(contproCom, new KDLayout.Constraints(731, 13, 270, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT_SCALE | KDLayout.Constraints.ANCHOR_RIGHT));
        //contCreator
	...
	private void registerBindings(){
		...
		dataBinder.registerBinding("entrys", com.kingdee.eas.zjlw.attendance.AlgPersEntryInfo.class, this.kdtEntrys, "userObject");
		...
		dataBinder.registerBinding("entrys.checkRuleId", java.lang.Object.class, this.kdtEntrys, "checkRuleId.text");
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.zjlw.attendance.app.AlgPersEditUIHandler";
	}
    ...
    public void setDataObject(IObjectValue dataObject)
    {
        ...
        this.editData = (com.kingdee.eas.zjlw.attendance.AlgPersInfo)ov;
    }
	...
	protected void registerValidator() {
		...
		getValidateHelper().registerBindProperty("entrys.checkRuleId", ValidateHelper.ON_SAVE);    
    ...
    public SelectorItemCollection getSelectors()
    {
		...
		if(selectorAll.equalsIgnoreCase("true"))
		{
			sic.add(new SelectorItemInfo("entrys.checkRuleId.*"));
		}
		else{
	    	sic.add(new SelectorItemInfo("entrys.checkRuleId.id"));
			sic.add(new SelectorItemInfo("entrys.checkRuleId.name"));
        	sic.add(new SelectorItemInfo("entrys.checkRuleId.number"));
		}
		if(selectorAll.equalsIgnoreCase("true"))
		{
    ...
    {
        return new MetaDataPK("com.kingdee.eas.zjlw.attendance.client", "AlgPersEditUI");
    }
    /**
    ...
    {
        return com.kingdee.eas.zjlw.attendance.client.AlgPersEditUI.class.getName();
    }
    ...
    protected IObjectValue createNewData()
    {
    	...
    	return "/bim/zjlw/attendance/AlgPers";
	}
    protected IMetaDataPK getTDQueryPK() {
    	return new MetaDataPK("com.kingdee.eas.zjlw.attendance.app.AlgPersQuery");
	}
