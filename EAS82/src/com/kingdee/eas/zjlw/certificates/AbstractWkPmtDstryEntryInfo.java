...
public class AbstractWkPmtDstryEntryInfo extends com.kingdee.eas.framework.CoreBillEntryBaseInfo implements Serializable 
{
    public AbstractWkPmtDstryEntryInfo()
    {
        this("id");
    }
    protected AbstractWkPmtDstryEntryInfo(String pkField)
    {
        super(pkField);
    }
    /**
     ...
     */
    public com.kingdee.eas.zjlw.certificates.WkPmtDstryInfo getParent()
    {
        return (com.kingdee.eas.zjlw.certificates.WkPmtDstryInfo)get("parent");
    }
    public void setParent(com.kingdee.eas.zjlw.certificates.WkPmtDstryInfo item)
    {
        put("parent", item);
    }
    /**
