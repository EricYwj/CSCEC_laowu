 ...
 * output class name
 */
public class ProjChkCountEditUI extends AbstractProjChkCountEditUI
{
    private static final Logger logger = CoreUIObject.getLogger(ProjChkCountEditUI.class);
    
    /**
     * output class constructor
     */
    public ProjChkCountEditUI() throws Exception
    {
        super();
    }
    /**
    ...
    protected void afterEditStopped(KDTable table, Object oldValue,Object newValue, int colIndex, int rowIndex) throws Exception {
		...
		if("projName".equals(key)){
			...
			if (proj != null) {
				...
				if(projInfo!=null){
					ProvinceInfo provice=ProvinceFactory.getRemoteInstance().getProvinceInfo(new ObjectUuidPK(projInfo.getProvince().getId()));
					if (provice == null) {
						MsgBox.showInfo("所选项目未建立基础信息，请重新选择！");
						abort();
					}
					row.getCell("province").setValue(provice.getName());
				}else{
					row.getCell("province").setValue(null);
				}
