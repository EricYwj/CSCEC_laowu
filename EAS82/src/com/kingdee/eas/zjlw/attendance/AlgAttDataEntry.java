...
public class AlgAttDataEntry extends CoreBillEntryBase implements IAlgAttDataEntry
{
    public AlgAttDataEntry()
    {
        super();
        registerInterface(IAlgAttDataEntry.class, this);
    }
    public AlgAttDataEntry(Context ctx)
    {
        super(ctx);
        registerInterface(IAlgAttDataEntry.class, this);
    }
    ...
    private AlgAttDataEntryController getController() throws BOSException
    {
        return (AlgAttDataEntryController)getBizController();
    }
    /**
    ...
    {
        try {
            return getController().getAlgAttDataEntryInfo(getContext(), pk);
        }
    ...
    {
        try {
            return getController().getAlgAttDataEntryInfo(getContext(), pk, selector);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getAlgAttDataEntryInfo(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getAlgAttDataEntryCollection(getContext());
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getAlgAttDataEntryCollection(getContext(), view);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getAlgAttDataEntryCollection(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
