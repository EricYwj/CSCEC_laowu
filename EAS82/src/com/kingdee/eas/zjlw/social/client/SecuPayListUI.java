 ...
 * output class name
 */
public class SecuPayListUI extends AbstractSecuPayListUI
{
    private static final Logger logger = CoreUIObject.getLogger(SecuPayListUI.class);
     ...
     */
    public SecuPayListUI() throws Exception
    {
        super();
    }
