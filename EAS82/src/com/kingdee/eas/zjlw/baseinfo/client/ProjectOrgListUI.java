 ...
 * output class name
 */
public class ProjectOrgListUI extends AbstractProjectOrgListUI
{
    private static final Logger logger = CoreUIObject.getLogger(ProjectOrgListUI.class);
     ...
     */
    public ProjectOrgListUI() throws Exception
    {
        super();
    }
    ...
    public void actionAddNew_actionPerformed(ActionEvent e) throws Exception
    {
    	...
    	if(poCol!=null && poCol.size()>0){
    		MsgBox.showInfo("所选组织已维护基本信息，不允许重复添加");
    		this.abort();
    	}
