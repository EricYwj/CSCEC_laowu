...
public class AbstractImmigrationEntryInfo extends com.kingdee.eas.framework.CoreBillEntryBaseInfo implements Serializable 
{
    public AbstractImmigrationEntryInfo()
    {
        this("id");
    }
    protected AbstractImmigrationEntryInfo(String pkField)
    {
        super(pkField);
    }
    /**
     ...
     */
    public com.kingdee.eas.zjlw.certificates.ImmigrationInfo getParent()
    {
        return (com.kingdee.eas.zjlw.certificates.ImmigrationInfo)get("parent");
    }
    public void setParent(com.kingdee.eas.zjlw.certificates.ImmigrationInfo item)
    {
        put("parent", item);
    }
    /**
