...
public class AbstractWkPmtTrnECEntryInfo extends com.kingdee.eas.framework.CoreBillEntryBaseInfo implements Serializable 
{
    public AbstractWkPmtTrnECEntryInfo()
    {
        this("id");
    }
    protected AbstractWkPmtTrnECEntryInfo(String pkField)
    {
        super(pkField);
    }
    /**
     ...
     */
    public com.kingdee.eas.zjlw.certificates.WkPmtTrnECInfo getParent()
    {
        return (com.kingdee.eas.zjlw.certificates.WkPmtTrnECInfo)get("parent");
    }
    public void setParent(com.kingdee.eas.zjlw.certificates.WkPmtTrnECInfo item)
    {
        put("parent", item);
    }
    /**
     ...
     */
    public com.kingdee.eas.basedata.org.AdminOrgUnitInfo getHworkOrj()
    {
        return (com.kingdee.eas.basedata.org.AdminOrgUnitInfo)get("HworkOrj");
    }
    public void setHworkOrj(com.kingdee.eas.basedata.org.AdminOrgUnitInfo item)
    {
        put("HworkOrj", item);
    }
    /**
     * Object:分录's 原劳动证号property 
     */
    ...
    /**
     * Object:分录's 原指标工种法文property 
     */
    public String getHquProff()
    {
        return getString("HquProff");
    }
    public void setHquProff(String item)
    {
        setString("HquProff", item);
    }
    /**
    ...
    /**
     * Object:分录's 收到劳动证调转表时间property 
     */
    public java.util.Date getLaborTrnDate()
    {
        return getDate("laborTrnDate");
    }
    public void setLaborTrnDate(java.util.Date item)
    {
        setDate("laborTrnDate", item);
    }
    /**
     ...
     */
    public boolean isSPAffPerson()
    {
        return getBoolean("sPAffPerson");
    }
    public void setSPAffPerson(boolean item)
    {
        setBoolean("sPAffPerson", item);
    }
    /**
