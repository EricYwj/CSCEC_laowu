...
public abstract class AbstractForiPersListUI extends com.kingdee.eas.framework.client.CoreBillListUI
{
    ...
    private void jbInit() throws Exception
    {
        ...
        mainQueryPK = new MetaDataPK("com.kingdee.eas.zjlw.attendance.app", "ForiPersQuery");
        //actionRemove
...
kDContainer2.getContentPane().setLayout(new BorderLayout(0, 0));        kDContainer2.getContentPane().add(tblMain, BorderLayout.CENTER);
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.zjlw.attendance.app.ForiPersListUIHandler";
	}
    ...
    {
        return new MetaDataPK("com.kingdee.eas.zjlw.attendance.client", "ForiPersListUI");
    }
    /**
    ...
    {
        return com.kingdee.eas.zjlw.attendance.client.ForiPersEditUI.class.getName();
    }
    ...
    {
        return new String[] {"bizDate","creator.name","number","billSate","entrys.country.name","entrys.prof.name","permitOrg.name","entrys.cooperation.name","entrys.checkRuleId.name","AuditDate","description","id","createTime","lastUpdateTime","auditor.number","auditor.name","creator.number","lastUpdateUser.number","lastUpdateUser.name","handler.number","handler.name"};
    }



	protected String getTDFileName() {
    	return "/bim/zjlw/attendance/ForiPers";
	}
    protected IMetaDataPK getTDQueryPK() {
    	return new MetaDataPK("com.kingdee.eas.zjlw.attendance.app.ForiPersQuery");
	}
